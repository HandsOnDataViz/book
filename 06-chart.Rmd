...
Bar charts use *length* to represent value, therefore their value axis *must start at zero*. This ensures that a bar twice the length of another bar represents twice its value. Figure \@ref(fig:design-principles-start-at-zero) contrasts a good and a bad example. Starting the baseline at a number other than zero is a trick commonly used to exaggerate differences in opinion polls and election results, as we describe later in [Chapter 14: Detect Lies and Reduce Bias](detect.html)
...
The zero baseline rule also applies to column charts and area charts, which represent values using *height*. But this rule does not necessarily apply to line charts, which represent values through the *position* and *angle* of the line, rather than the area underneath them. Visualization expert Alberto Cairo demonstrates that starting a line chart at a number other than zero does not, by itself, distort its encoded information because we do not rely on its height.^[@cairoHowChartsLie2019, p. 61.]

TODO: Add visual here of line chart baseline at zero versus higher number to illustrate the argument?
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://docs.google.com/spreadsheets/d/e/2PACX-1vRyg09UZgGWVHPk3oOKAZ-zlqtDF_RpvOLdAsM-k-ZW5NavcxAyHbErgr-7dt7U_AFSVZONSTZ9sVII/pubchart?oid=509234663&amp;format=interactive") else knitr::include_graphics("images/06-chart/histogram.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://datawrapper.dwcdn.net/vHuob/1/") else knitr::include_graphics("images/06-chart/datawrapper-annotated.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://datawrapper.dwcdn.net/v8D2z/1/") else knitr::include_graphics("images/06-chart/datawrapper-range.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://datawrapper.dwcdn.net/8OQz7/1/") else knitr::include_graphics("images/06-chart/scatter.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://datawrapper.dwcdn.net/ZX9QR/2/") else knitr::include_graphics("images/06-chart/bubble.png")
```
