...
| Range chart<br> ![](images/05-chart/chart-range.png) | Best to show gaps between data points, such as inequalities.<br>Easy tools: [Range Chart in Datawrapper tutorial](annotated-datawrapper.html)<br>Power tool: [Chart.js and Highcharts templates](chartcode.html) |
