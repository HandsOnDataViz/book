...
In this chapter, we'll help you navigate your way through the decision-making process. We'll begin with the most important step---[sketching out your data story](sketch.html)---to help identify the types of tools you need to tell it effectively. Next, we'll review [ten factors to consider when choosing digital tools and the tradeoffs involved](tools-tradeoffs.html). Finally, we'll present our [list of recommended data visualization tools](recommended-tools.html), plus one extra to help you get organized: [a password manager](password-manager.html). All of these tools are free to use, and the book introduces them gradually, from easy-to-learn beginner tools to more advanced and powerful ones.
