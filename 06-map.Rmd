...
Beginners may start with easy-to-learn tools such as [Google My Maps](mymaps.html), then move up to more powerful tools, such as [Leaflet](leaflet.html), which require you to [Modify and Host Code Templates with GitHub](github.html) or other web servers.  
