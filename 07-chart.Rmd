...
Note: Another name for the three-dot menu symbol is the "kebab menu" because it resembles Middle Eastern
...
See the [Get the Embed Code](embed-code.html) section in Chapter 10 to insert the interactive version of your chart on a web page that you control.
...
See the [Get the Embed Code](embed-code.html) section of Chapter 10 to insert the interactive version of your chart on a web page that you control.
