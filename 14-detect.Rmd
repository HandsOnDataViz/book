...
6. *Lie by adding data with a dual vertical axis.* In the *temp+GDP* tab of the Google Sheet, select all three columns and *Insert > Chart* to produce a default line chart with two data series: temperature (in blue) and US GDP (in red).
...
For example, Google Sheets designates the first data series to be blue, but this color also sends "cool" signals to our brain, which is the opposite of rising temperatures.
