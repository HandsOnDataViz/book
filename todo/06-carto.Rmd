...
![Image: Carto Builder dashboard: Begin with Datasets](images/07-map/carto-dashboard-maps-datasets.png)
...
![Image: Style points by value](images/07-map/carto-point-style-value.png)
...
![Image: Click to rename or publish your map](images/07-map/carto-publish-map.png)
