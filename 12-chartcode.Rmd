...
| Line Chart<br> ![](images/12-chartcode/chartjs-line.png) | Best to show continuous data, such as change over time.<br>Power tool: [Line Chart with CSV data in Chart.js code template and tutorial](chartjs-line.html). See also note to modify into stacked area chart. |
