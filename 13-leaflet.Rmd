...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://handsondataviz.github.io/leaflet-storymaps-with-google-sheets/", height = "600px") else knitr::include_graphics("images/13-leaflet/storymap-demo.png")
```
...
TODO: DECIDE if we should add links to gallery of examples, such as: https://jhsgh.github.io/storymap/ and https://www.mappingtheuppermissouri.com/ and https://ericayhayes.github.io/leaflet-storymaps-with-google-sheets/
