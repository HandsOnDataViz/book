...
Our subtitle, "Interactive Storytelling from Spreadsheets to Code," reflects how the scope of the book progresses from basic skills to more advanced visualization methods, while continually maintaining our focus on telling true and meaningful stories with data. We explain both the *why* and the *how* of data visualization. Unlike other computer books that focus on one software tool, this book covers over twenty different tools, all of them free and easy-to-learn, along with our guidance on how to choose among competing tools. By working through the sample datasets and tutorials, readers will create more than a dozen different interactive charts, maps, and tables, and share these data stories with other readers on the public web.

While we cover several chapters in this introductory book, we do not attempt to address more advanced topics such as statistical data analysis, nor do we include command-line software tools such as the R statistics package.
