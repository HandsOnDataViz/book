...
https://github.com/HandsOnDataViz/census-divisions-hartford
...
See also [Bulk Geocode with the US Census Geocoder](bulk-geocode.html) and find GeoIDs (such as the census tract) for each address.
