...
Check *Error bars*, and customize its value as either percent or a constant value, as shown in Figure \@ref(fig:images/05-chart/chart-error-bar.png).
...
```{r chart-error-bar, out.width=150, fig.cap="(ref:chart-error-bar)"}
 knitr::include_graphics("images/05-chart/chart-error-bar.png")
```
