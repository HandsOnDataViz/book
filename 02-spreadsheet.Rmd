...
Before we begin to design data visualizations, let's bring our spreadsheet skills up to speed. The interactive charts and maps that we'll construct later this book are built on data tables. We normally open up data tables with spreadsheet tools, such as Google Sheets or Microsoft Excel, that display numbers or text in rows and columns, where each box in the grid called a "cell".

In this chapter, you'll learn (or refresh) your skills in using spreadsheet tools for basic tasks, such as sharing, sorting, and making calculations with your data.

normally see as rows and columns of numbers or text. First, you need to learn or refresh your skills in using spreadsheet tools to sort, pivot, and match up tables


While teaching data visualization over the past decade, we noticed that many of our students would benefit from learning some specific spreadsheet skills, since these have not been regularly taught in most schools or colleges or workplaces. So we added this introductory chapter to fill this common gap. Even if you *think* you're familiar with spreadsheet basics, we strongly recommend reviewing the

Goal is to help you uncover the stories buried inside your data.


 since these are not regularly taught, and


We added this chapter on spreadsheet


We added this chapter to this introductory book because we saw that many first-time  

While teaching people to create their first data visualizations, we've noticed that many
...
Skills you'll learn in this chapter....
...
TODO: I added the tips above because these are huge yet surmountable obstacles for many people I've worked with, especially older generations and incarcerated people.
