...
(ref:sheets-concat) Use ampersands to concatenate cell values,
...
Get the newest version of Tabula from [the official website](https://tabula.technology/).
...
1. If the preview tables don't contain the data you want, try switching between *Stream* and *Lattice* extraction methods in the left-hand-side bar.
1. If the tables still don't look right, or you with to remove some tables that Tabula auto-detected, hit *Revise selection* button.
