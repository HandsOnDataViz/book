...
if(knitr::is_html_output()) knitr::include_url("https://handsondataviz.github.io/leaflet-maps-with-google-sheets/", height = "500px") else knitr::include_graphics("images/10-leaflet/lmwgs-map.jpg")
```
...
if(knitr::is_html_output()) knitr::include_url("https://docs.google.com/spreadsheets/d/1ZxvU8eGyuN9M8GxTU9acKVJv70iC3px_m3EVFsOHN9g/pubhtml?widget=true&amp;headers=false", height = "500px") else knitr::include_graphics("images/10-leaflet/lmwgs-sheet.jpg")
```
...
- Know how to [Edit and Host Code with GitHub](github.html), as described in Chapter 8.
...
```{r leaflet-map-with-table, fig.cap="(ref:leaflet-map-with-table)"}
knitr::include_graphics("images/10-leaflet/leaflet-map-with-table.png")
```
...
```{r sheets-download-csv, fig.cap="(ref:sheets-download-csv)"}
 knitr::include_graphics("images/10-leaflet/sheets-download-csv.png")
```
