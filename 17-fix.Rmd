...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("images/17-fix/screenshot-mac.gif", height = "360px") else knitr::include_graphics("images/17-fix/screenshot-mac.png")
```
