...
knitr::include_graphics("images/14-transform/mapshaper-edit-annotated.png")
```
...
knitr::include_graphics("images/14-transform/mapshaper-rename-annotated.png")
```
...
knitr::include_graphics("images/14-transform/mapshaper-clip-annotated.png")
```
...
knitr::include_graphics("images/14-transform/mapshaper-join-annotated.png")
```
...
knitr::include_graphics("images/14-transform/kmz-earth-annotated.png")
```
...
knitr::include_graphics("images/14-transform/pivot-address-export-annotated.png")
```
...
knitr::include_graphics("images/14-transform/pivot-address-sheet-annotated.png")
```
