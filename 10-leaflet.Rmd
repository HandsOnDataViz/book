...
In the steps below, you will create and name your Google Cloud project, enable the Google Sheets API to allow a computer to read data from your Google Sheet, copy your new API key, and paste it into the Leaflet code in place of our key.
...
```{r google-api-create, fig.cap="(ref:google-api-create)"}
 knitr::include_graphics("images/10-leaflet/google-api-create.png")
```
...
```{r google-api-name, fig.cap="(ref:google-api-name)"}
 knitr::include_graphics("images/10-leaflet/google-api-name.png")
```
...
(ref:google-api-name) Press the *+ Enable APIs and Services* button.

```{r google-api-enable, fig.cap="(ref:google-api-enable)"}
 knitr::include_graphics("images/10-leaflet/google-api-enable.png")
```
...
```{r google-api-search, fig.cap="(ref:google-api-search)"}
 knitr::include_graphics("images/10-leaflet/google-api-search.png")
```
...
```{r google-api-select, fig.cap="(ref:google-api-select)"}
 knitr::include_graphics("images/10-leaflet/google-api-select.png")
```
...
```{r google-api-credentials, fig.cap="(ref:google-api-credentials)"}
 knitr::include_graphics("images/10-leaflet/google-api-credentials.png")
```
...
```{r google-api-key, fig.cap="(ref:google-api-key)"}
 knitr::include_graphics("images/10-leaflet/google-api-key.png")
```
...
```{r google-api-restrict, fig.cap="(ref:google-api-restrict)"}
 knitr::include_graphics("images/10-leaflet/google-api-restrict.png")
```
