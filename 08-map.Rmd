...
| Symbol point map<br> ![](images/placeholder.jpg) | Best to show specific locations (such as cities), with variable-sized circles to represent data values (such as population growth).<br>Easy tool: [Symbol Map with Datawrapper tutorial](symbolmap-datawrapper.html) |
...
- Decide whether to show Storymap "easy tools" because neither allow you to export data you enter: [Knight Lab's StoryMap](https://storymap.knightlab.com/), [ESRI Story Maps](https://storymaps.arcgis.com/en/) OR mention (but do not recommend) Storymap.js as an easy tool, but cannot easily migrate data out, then Leaflet Storymaps with GS as a power tool; also mention HistoryPin.org as a different type of historical storytelling map?
