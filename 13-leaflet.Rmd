...
| --- | --- |
| Leaflet Maps with Google Sheets<br> ![](images/13-leaflet/tableleaflet-maps-with-google-sheets-OLD.png) | Best to show interactive points, polygons, or polylines, using your choice of colors, styles, and icons, based on data loaded into your linked Google Sheet (or CSV file) and GitHub repository. Includes option to display a table of point map markers next to your map.  <br>Template with tutorial: [Leaflet Maps with Google Sheets](leaflet-maps-with-google-sheets.html) |
| Leaflet Storymaps with Google Sheets<br> ![](images/13-leaflet/tableleaflet-storymaps-with-google-sheets-OLD.png) | Best to show a point-by-point guided tour, with a scrolling narrative to display text, images, audio, video, and scanned map backgrounds loaded into your linked Google Sheet (or CSV file) and GitHub repository.<br>Template with tutorial: [Leaflet Storymaps with Google Sheets](leaflet-storymaps-with-google-sheets.html) |
...
Explore the gallery in Table \@ref(tab:storymaps-gallery) to see what other people created with the Leaflet Storymaps with Google Sheets template.

Table: (\#tab:storymaps-gallery) Gallery of Leaflet Storymaps with Google Sheets

|  |  |
| --- | --- |
| ![](images/13-leaflet/storymaps-gallery-1.png)<br>[Synagogue Map, Past and Present](https://jhsgh.org/synagogue-map/) by the Jewish Historical Society of Greater Hartford | ![](images/13-leaflet/storymaps-gallery-2.png)<br>[Mapping the Upper Missouri](https://www.mappingtheuppermissouri.com/) by Jen Andrella |
