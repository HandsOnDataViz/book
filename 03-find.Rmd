...
Also, the US federal government is subject to the [Freedom of Information Act](https://en.wikipedia.org/wiki/Freedom_of_Information_Act), which enables people to submit a "FOIA" request to obtain certain types of public records to improve government transparency. Many states and their municipalities are subject to related FOIA laws, which are listed by non-profit organizations such as the [National Freedom of Information Coalition](https://www.nfoic.org/). While some government agencies routinely delay or reject FOIA requests, others have learned that fighting against public information can be expensive, and have begun to pro-actively share more information on open data repositories.
