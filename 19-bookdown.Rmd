...
images/06-chart/design-setup-annotated.png
images/06-chart/design-setup-annotated.pdf
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://handsondataviz.github.io/leaflet-maps-with-google-sheets/", height = "600px") else knitr::include_graphics("images/19-bookdown/sample-map.jpg")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("images/19-bookdown/sheets-option-drag.gif", height = "250px") else knitr::include_graphics("images/19-bookdown/sheets-option-drag.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://www.youtube.com/embed/-nGdrzMuUnI") else knitr::include_graphics("images/19-bookdown/video-sample.png")
```
