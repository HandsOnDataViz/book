...
One reason we feature Google Sheets in this book is because it exports data in both formats. Go to *File > Download As* to export in CSV format (for only the current sheet) or ODS format (for a multi-tabbed spreadsheet with most formulas and formatting), or other formats such as Excel, as shown in Figure \@ref(fig:sheets-download). Similarly, the downloadable LibreOffice and its Calc spreadsheet tool also exports data in these formats. Select *File > Save As* to save in its native ODS format, or export in CSV, Excel, and other formats.
...
1. Right-click on this [sample-students Google Sheets file](https://docs.google.com/spreadsheets/d/1FYTiLHfOI2caT2lkI4i8fGbhA-oKT_MSOP1vQWWC9MA) to open in a new tab. We set it to "View only" so that anyone on the internet can see the contents, but not edit the file.
...
One reason we feature the Google Sheets in this book is because this online spreadsheet tool offers good support for data migration, meaning the ability to import and export files in many common formats.


offers good support for data migration, meaning the ability to import and export files in many formats.
...
1. Find an Excel file you can use on your personal computer. If you don't have one, click this [sample Excel data file](https://handsondataviz.org/data/data.xlsx) and save to download to your computer. **TODO:** follow our own advice and give sample data files more meaningful names
