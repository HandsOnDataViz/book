...
| --- | --- |
| Chart.js Bar Chart<br> ![](images/12-chartjs/chartjs-bar.png) | Bar charts (vertical bar charts are often called column charts) can be used to compare categorical data. <br>Template with tutorial: [Bar Chart.js with CSV Data](chartjs-bar-csv.html) |
| Chart.js Line Chart<br> ![](images/12-chartjs/chartjs-line.png) | Line charts are normally used to show trends (temporal data). <br>Template with tutorial: [Line Chart with CSV Data](chartjs-line-csv.html) |
| Chart.js Scatter Chart<br> ![](images/12-chartjs/chartjs-scatter.png) | Scatter charts (also scatterplots) are used to display data of 2 or more dimensions. <br>Template with tutorial: [Scatter Chart with CSV Data](chartjs-scatter-csv.html) |
| Chart.js Bubble Chart<br> ![](images/12-chartjs/chartjs-bubble.png) | Bubble charts are used to display data of 3 or more dimensions. <br>Template with tutorial: [Bubbble Chart with CSV Data](chartjs-bubble-csv.html) |
...
Source and instructions: https://github.com//chartjs-templates/tree/master/bar-chart
...
Source and instructions: https://github.com//chartjs-templates/tree/master/line-chart
