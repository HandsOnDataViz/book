...
*by [Jack Dougherty and Ilya Ilyankou](authors), last updated February 12, 2019*
...
- Install R Project statistical programming language <https://www.r-project.org> to build your book with Bookdown. (Yes, we were surprised to use tools designed for statistical analysis to publish a book, but it works!)
- ![Screenshot: Install R Project for Mac](images/15-bookdown/1-r-download.png)
- Install the free RStudio Desktop to make R easier to use with a visual editor
- ![Screenshot: Install RStudio Desktop](images/15-bookdown/2-download-rstudio.png)
- Inside RStudio, select the Packages tab, and select Install
- ![Screenshot: Install Packages](images/15-bookdown/3-packages-install.png)
- Inside RStudio, install the "bookdown" package to build your book, and select Install Dependencies
- ![Screenshot: Install bookdown package](images/15-bookdown/4-install-bookdown.png)
- This is how a successful installation of Bookdown appears in RStudio
- ![Screenshot: Successful installation of bookdown](images/15-bookdown/5-installed.png)
- Inside RStudio, install the "tinytex" package for Bookdown to create a PDF edition of your book
- ![Screenshot: Install tinytex package](images/15-bookdown/6-install-tinytex.png)
- Don't forget: in RStudio console, type `tinytex::install_tinytex()` and press return to finish the installation
- ![Screenshot: Finish tinytex installation](images/15-bookdown/7-finish-install-tinytex.png)
...
- In RStudio in the upper-right corner, select Project > Open Project to open the `bookdown-minimal` folder on your local computer.
- ![Screenshot: Open project](images/15-bookdown/8-project-open.png)
- In RStudio, open the `index.Rmd` file and make some simple edits to the text of this minimal book. For example, remove the hashtag `#` comment symbol in line 8 to "uncomment" and activate the PDF book option. Save your edits.
- ![Screenshot: Edit the index.Rmd file](images/15-bookdown/9-edit-book.png)
