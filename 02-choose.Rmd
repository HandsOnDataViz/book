...
This category covers several questions.
Does the platform take reasonable precautions to protect my information from malicious hackers and malware?
Also, does it clearly explain whether my data and visualization will remain private or become public? Check terms of service.... Also,
...
Does the tool allow several people to work together on one shared product?   Think about this at the same time as you consider "secure" above

*8. Cross-Platform*

Does this tool work across different computer operating systems? On a related note, are the visualizations responsive to screen size, meaning that they display acceptably on smartphones or tablet devices?

*9. Open-Source*

Is the tool’s software code viewable? Can it be modified and redistributed, so that other software developers can build upon it and add new extensions?

*10. Accessible*
Does this visualization platform create accessible information for visually-impaired users? While X years have passed since the Americans with Disabilities Act (ADA) and similar laws were signed, accessibility still remains relatively new terrain.... Explain why and how this affected our choices in tool selection for this book.
