...
Now that you've [reflected on your data story](choose.html), [found and questioned your data](find.html), and [cleaned up any messy parts](clean.html), this chapter focuses on the key question to ask while analyzing your evidence: "Compared to what?" That's how statistician Edward Tufte defined the "heart of quantitative reasoning."^[@tufteEnvisioningInformation1990, p. 67]. We search for insightful findings in our data by judging their significance against each other, to identify those that truly stand out. Also, sometimes we need to adjust our scales to ensure that we're weighing data fairly, or as the saying goes, comparing apples to apples, not apples to oranges. Before you communicate your findings in any format---text, tables, charts, or maps---make sure that you've made a meaningful comparison. Without this, your work may become meaningless.

This book does not intend to cover statistical data analysis, as many other fine textbooks already address this expansive field of study.[TODO: cite open-access resources]. Instead, this chapter offers common-sense strategies to making meaningful comparisons as you analyze your data, in order to help you make more insightful visualizations. You will learn [to normalize your data](normalize.html), [write precisely about common terms](write-precisely.html) such as averages and percentages, understand when to use [smaller versus larger units](units.html), and watch out for [biased comparisons](biased-comparisons.html).
...
## Write Precisely About Common Terms {- #write-precisely}
...
## Using Smaller versus Larger Units {- #units}
