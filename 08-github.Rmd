...
1) Right-click to open this GitHub code template in a new tab: https://github.com//leaflet-map-simple
...
1) Right-click to open this GitHub code template in a new tab: https://github.com//highcharts-scatter-csv
...
1) Follow these steps if you have already forked a GitHub repository and wish to make a second copy of it. For example, imagine that you have already forked a copy of the Leaflet Maps with Google Sheets repository from <https://github.com//leaflet-maps-with-google-sheets> **TO DO change repo address**
