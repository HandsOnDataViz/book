...
| Chart.js Bubble Chart<br> ![](images/09-chartjs/chartjs-bubble.png) | Bubble charts are used to display data of 3 or more dimensions. <br>Template with tutorial: [Bubble Chart with CSV Data](chartjs-bubble-csv.html) |
