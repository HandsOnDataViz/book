...
3. Open [Datawrapper](https://www.datawrapper.de), click on *Start Creating*, then click the *New Map* button, and select *Choropleth map* as shown in Figure \@ref(fig:datawrapper-map-choose). No login is required to create a map, but you should sign up for a free account in order to save your work and publish your map online.
...
knitr::include_graphics("images/07-map/datawrapper-map-us-states-territories.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-import-dataset.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-import-codes.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-map-match-values.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-map-default.png")
```
...
15. Finally, click *Proceed* or advance to the *Publish & Embed* screen to share your work with others. Follow the prompts, or the more detailed Datawrapper tutorial above, to obtain an embed code to your interactive map, and learn more about your next steps in [Chapter 9: Embed on the Web](embed.html).
...
knitr::include_graphics("images/07-map/tableau-go-to-worksheet.png")
```
