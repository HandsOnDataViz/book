...
3. Download, install, and launch the [free Tableau Public desktop application](https://public.tableau.com/en-us/s/download), available for Mac or Windows. You will need to enter an email address to download the application.

4. When you open the Tableau Public application, the *Connect* screen will display file formats you can upload on the left-side menu. Click on the *Text file* format and upload the military spending CSV data file you downloaded above.
