...
2. Click the Export button and select your preferred format:
  ...
  ![Screencast](images/09-transform/mapshaper-convert-640.gif)
...
![Screencast](images/09-transform/mapshaper-dissolve-simple-640.gif)
...
![Screencast](images/09-transform/mapshaper-clip-640.gif)
