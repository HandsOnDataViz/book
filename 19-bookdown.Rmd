...
View the underlying source code to understand how this page was composed at: https://github.com/HandsOnDataViz/book/blob/master/19-bookdown.Rmd
...
| Co-Authors      | About Us      |
| --------------- | ------------- |
| ![](images/19-bookdown/dougherty-jack.jpg) | About [Jack Dougherty](http://jackdougherty.org) |
| ![](images/19-bookdown/ilyankou-ilya.jpg) | About [Ilya Ilyankou](https://github.com/ilyankou) |   
...
```{r tiger, fig.cap="(ref:tiger)"}
 knitr::include_graphics("images/19-bookdown/tiger.png")
```
...
```{r screenshot-tall, out.width=200, fig.cap="(ref:screenshot-tall)"}
 knitr::include_graphics("images/19-bookdown/screenshot-tall.png")
```
...
if(knitr::is_html_output()) knitr::include_url("https://handsondataviz.github.io/leaflet-maps-with-google-sheets/", height = "600px") else knitr::include_graphics("images/19-bookdown/sample-map.jpg")
```
...
(ref:sheets-option-drag) Caption here, with embedded link to the [animated GIF](https://handsondataviz.org/images/19-bookdown/sheets-option-drag.gif).

```{r sheets-option-drag, fig.cap="(ref:sheets-option-drag)"}
if(knitr::is_html_output()) knitr::include_url("images/19-bookdown/sheets-option-drag.gif", height = "250px") else knitr::include_graphics("images/19-bookdown/sheets-option-drag.png")
```
...
if(knitr::is_html_output()) knitr::include_url("https://www.youtube.com/embed/-nGdrzMuUnI") else knitr::include_graphics("images/19-bookdown/video-sample.png")
```
...
- Manually find and replace any `<iframe...` HTML or GIF elements with their `<img...` PNG substitutes, and new ALT text (unless authors come up with a better way to automate this)
- Manually delete any remaining `<iframe...` elements (unless they are non-executable code snippets)
- Manually mark up "Variable List:" for production team in two places in Chapter 4
