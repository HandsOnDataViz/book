...
See also easy drag-and-drop chart tools in [Chapter 5: Chart Your Data](chart.html).
...
To learn more, see [Chart.js samples](https://www.chartjs.org/samples/latest/) and [Highcharts Demos](https://www.highcharts.com/demo).
...
The y-axis (or x-axis for horizontal bar chart) should always start at 0. Upload data to CSV file...
