...
In this chapter, we'll help you navigate your way through the tool decision-making process. First, we'll guide you in a quick exercise to [start sketching your data story](sketch.html), to help you clarify the types of tools needed to tell it effectively. Second, we'll review [ten factors to consider when choosing digital tools and the tradeoffs involved](tools-tradeoffs.html). Finally, we'll present our [list of recommended data visualization tools](recommended-tools.html). All of them are free to use, but the book introduces them gradually, from easy-to-learn beginner tools to more advanced and powerful ones.
...
Get ready to sketch a combination of words and pictures. No artistic skills are required.
...
2. On the third sheet of paper, *draw pictures and arrows to show how you'll find data* to answer your question above. Are you conducting door-to-door interviews with neighborhood residents, or sending an online survey to customers, or downloading family income and county maps from the US Census? Sketch a picture of your data collection process, to show how you plan to bring together different pieces of information. For example, when writing the first draft of our book, we asked readers to fill out a quick online survey form, and reminded them not to insert any private data, because we shared back their collected responses in a public spreadsheet.

3. On the fourth sheet of paper, *sketch at least one type of visualization you plan to create* after you obtain your data above. Do you envision some type of chart, like a bar, line, or scatter chart? Or do you imagine some type of map, maybe with points or polygons? If your visualizations will be interactive, try to show the concept using buttons and more than one sheet of paper. You can add *imaginary data* at this stage because it's just a preliminary sketch. Have fun!

TODO: decide if and how to add amateur-styled sketches of problem, question, data, and visualization. Either place one image immediately after each step, or conclude with a smaller 4-panel compilation (2x2 landscape oriented page scans) at the end. See also my photos of 2017 workshop teams working on their data stories.

This quick sketching exercise helps you in several ways. First, you'll start framing your data story. Transferring ideas from your brain onto paper is a big step, because it makes your thoughts clearer not only to you, but also more concretely for your co-workers. When ideas are sketched out, you can reflect and listen to feedback, cross-out not-so-good ones, and replace them with better ones on new sheets of paper. If your initial sketches are too confusing or complex, break them down into separate pages. Second, you can spread out all of your sheets on a table, move them around to possibly reorder the sequence, and begin to define the three essential stages of your story: the beginning, middle, and end. Look at your sheets like a storyboard. Start organizing them into your future presentation slides, or paragraphs and pictures for your next report or web page. Don't throw them away, because we'll return to this exercise at the end of the book in [Chapter 15: Telling Your Data Story](story.html).

Also, this sketching exercise helps you to decide which chapters to focus on in the body of the book. If you're unclear about where to start looking for relevant information, check out [Chapter 4: Find and Question Your Data](find.html). If you want to build a chart or map, but are uncertain about what type, look at examples at the beginning of [Chapter 6: Chart Your Data](chart.html) and [Chapter 7: Map Your Data](map.html).
...
Does the tool create visualizations that are accessible for visually-impaired readers? Although disability advocacy laws were passed decades ago, digital technology still lags behind and is slowly catching up, especially in the field of data visualization. But when selecting tools for this book, we highlight those such as [Datawrapper, which includes a built-in check for colorblindness](https://blog.datawrapper.de/colorblind-check/), and [Highcharts, which offers some chart types designed for low-vision people using screen readers](https://www.highcharts.com/demo/accessible-line), as shown in Figure \@ref(fig:colorblind-accessible-combined).

(ref:colorblind-accessible-combined) On the left, the Datawrapper built-in check for colorblindness. On the right, a Highcharts line chart for low-vision accessibility.

```{r colorblind-accessible-combined, fig.cap="(ref:colorblind-accessible-combined)"}
