...
Table: (\#tab:chart-templates) Chart Templates and Tutorials

| Chart Templates | Best use and tutorials in this book |
| --- | --- |
| Chart.js Bar Chart<br> ![](images/10-chartcode/chartjs-bar.png) | Bar charts (vertical bar charts are often called column charts) can be used to compare categorical data. <br>Template with tutorial: [Bar Chart.js with CSV Data](chartjs-bar-csv.html) |
| Chart.js Line Chart<br> ![](images/10-chartcode/chartjs-line.png) | Line charts are normally used to show trends (temporal data). <br>Template with tutorial: [Line Chart with CSV Data](chartjs-line-csv.html) |
| Chart.js Scatter Chart<br> ![](images/10-chartcode/chartjs-scatter.png) | Scatter charts (also scatterplots) are used to display data of 2 or more dimensions. <br>Template with tutorial: [Scatter Chart with CSV Data](chartjs-scatter-csv.html) |
| Chart.js Bubble Chart<br> ![](images/10-chartcode/chartjs-bubble.png) | Bubble charts are used to display data of 3 or more dimensions. <br>Template with tutorial: [Bubble Chart with CSV Data](chartjs-bubble-csv.html) |
...
The y-axis (or x-axis for horizontal bar chart) should always start at 0.

(ref:chartjs-demo-bar) Interactive bar chart with Chart.js. See [detailed instructions on GitHub](https://github.com/handsondataviz/chartjs-templates/tree/master/bar-chart).
...
### Bar Chart.js with CSV Data (with Error Bars) {-}
...
shows median and mean (average) income for select US states. You can notice that error bars
are larger for less populated states, such as Alaska, Vermont, and Wyoming. Data for the two of the most populous
states, California and Texas, have tiny margins of error.
...
Unlike column or bar charts, y-axes of line charts do not necessarily start at 0.
