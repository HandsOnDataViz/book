...
View the source code to better understand how this page was composed at: https://github.com/HandsOnDataViz/book/blob/master/01-bookdown.Rmd
...
if(knitr::is_html_output()) knitr::include_url("https://handsondataviz.github.io/leaflet-maps-with-google-sheets/") else knitr::include_graphics("images/15-bookdown/sample-map.jpg")
```
...
(ref:excel-drag) Caption here, with embedded link to GitHub repo, not GitHub Pages [animated GIF](https://github.com/HandsOnDataViz/book/blob/master/images/15-bookdown/excel-drag.gif).

<!-- set iframe 450px height in custom-scripts.html -->
```{r excel-drag, fig.cap="(ref:excel-drag)"}
if(knitr::is_html_output()) knitr::include_url("images/15-bookdown/excel-drag.gif") else knitr::include_graphics("images/15-bookdown/excel-drag.png")
```
...
This Bookdown `index.Rmd` file includes an R code-chunk setting immediately after the first header, which displays each code-chunk image without a code echo. Read more about this feature and related options in this [Bookdown chapter](https://bookdown.org/yihui/bookdown/figures.html).
