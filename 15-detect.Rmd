...
Even Cairo points out that this significant temperature increase looks "deceptively small" if you follow his aspect ratio recommendation using this scale, so he advises against it.^[@cairoHowChartsLie2019, p. 70.] Furthermore, if you convert the global temperature change from the Celsius scale (a 1°C increase) to the Fahrenheit scale (a 2°F increase), the aspect ratio recommendation would result in a Celsius chart that is half as tall as a Fahrenheit chart. Since dramatic differences in appearance between the Celsius and Fahrenheit charts are not reasonable, we also advise against using Cairo's recommendation here.
