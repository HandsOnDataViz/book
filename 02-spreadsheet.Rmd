...
```{r sheets-drag-calc, out.width=300, fig.cap="(ref:sheets-option-drag)"}
if(knitr::is_html_output()) knitr::include_url("images/02-spreadsheet/sheets-drag-calc.gif", height = "185px") else knitr::include_graphics("images/17-bookdown/sheets-option-drag.png")
```
