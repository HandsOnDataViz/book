...
knitr::include_graphics("images/13-leaflet/icon-combined-annotated.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("images/13-leaflet/storymap-demo.gif", height = "400px") else knitr::include_graphics("images/13-leaflet/storymap-demo.png")
```
