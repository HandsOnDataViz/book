...
Tip: In Mapshaper, when you export a file in GeoJSON format, your downloaded file will appear in the `.json` format. Rename the file and change the extension to `.geojson` format, as shown in Figure \@ref(fig:mapshaper-json-geojson). This will avoid confusion with other visualization tools in this book that only recognize a properly-named GeoJSON file.

(ref:mapshaper-json-geojson) Rename your Mapshaper exports from `.json` to `.geojson`.
