...
-   [Chapter 9: Embed on the Web](embed.html) connects prior chapters by
...
We thank the many individuals and organizations who helped us learn many
...
Now let’s insert Figure <a href="#fig:us-income-chart2">0.2</a>, which
...
<!--chapter:end:0.0-introduction.Rmd-->
...
<img src="images/01-choose/data-story-photo-combined.jpg" alt="The data story sketching exercise can be done solo, but works even better with a team of people. In our data visualization course, college students and community partners collaborate on framing the data story for their projects." width="750" />
<p class="caption">
...
<img src="images/01-choose/colorblind-accessible-combined.png" alt="On the left, the Datawrapper built-in check for colorblindness. On the right, a Highcharts line chart designed for low-vision accessibility." width="750" />
<p class="caption">
...
<img src="images/02-spreadsheet/sheets-drag-calc.png" alt="Click on the blue bottom-right dot in cell E2, then hold-and-drag your crosshair cursor in cell F2, and let go to automatically paste and update the formula."  />
<p class="caption">
...
1.  In your editable copy of the Google Sheet, the *names* tab will be
    ...
    *addresses* sheet, copy the column headers for *street - city -
    ...
    sheet, as shown in Figure <a href="#fig:vlookup-headers">2.36</a>.
...
<p class="caption">
Figure 2.36: Paste the last four column headers from the *addresses*
...
1.  One option is to directly type this formula into cell C2, using
    ...
    shown in Figure <a href="#fig:vlookup-solution">2.37</a>. What’s new
...
<p class="caption">
Figure 2.37: The VLOOKUP formula in cell C2 of the *names* sheet (top)
...
1.  After you enter the full VLOOKUP formula, it will display the exact
    ...
    as shown in Figure <a href="#fig:vlookup-drag">2.38</a>.
...
<p class="caption">
Figure 2.38: Click on cell C2, then hold-and-drag the bottom-right blue
...
1.  Finally, use the same hold-and-drag method to paste and update the
    ...
    <a href="#fig:vlookup-final">2.39</a>.
...
<p class="caption">
Figure 2.39: Click on cell F2, then hold-and-drag the bottom-right blue
...
<a href="#fig:vlookup-final">2.39</a> in the prior section on VLOOKUP.
...
<a href="#fig:vlookup-setup">2.35</a> at the beginning of the VLOOKUP
...
<a href="#fig:airtable-link">2.40</a>. In our editable version, we
...
<p class="caption">
Figure 2.40: In this Airtable sample, we linked the *organization*
...
<a href="#fig:airtable-expand">2.41</a>. In our editable version, if we
...
a topic we’ll cover in [Chapter 9: Embed on the Web](embed.html). See
more about its features in the [Airtable Support
page](https://support.airtable.com).

<img src="images/02-spreadsheet/airtable-expand.png" alt="In this [Airtable demo](https://airtable.com/shrOlb4XT11Xy2LP2), click on a row in one sheet to expand and view its linked data in another sheet." width="600" />
<p class="caption">
Figure 2.41: In this [Airtable
...
6](chart.html) and [interactive maps in Chapter 7](map.html), require a
...
<a href="#fig:census-1940-excerpt">3.1</a>.

<img src="images/03-find/census-1940-excerpt.png" alt="Excerpt of individual-level 1940 US Census data for Jack's father's family." width="350" />
<p class="caption">
Figure 3.1: Excerpt of individual-level 1940 US Census data for Jack’s
father’s family.
</p>
...
<a href="#fig:census-divisions-hartford">3.2</a> to show the
...
<img src="images/03-find/census-divisions-hartford.png" alt="Common US census geographies around Hartford, Connecticut, 2019. Zoom out in the [interactive version](https://handsondataviz.github.io/census-divisions-hartford/) for county and state boundaries."  />
<p class="caption">
Figure 3.2: Common US census geographies around Hartford, Connecticut,
...
[Chapter 4: Clean Up Messy Data](clean.html).
...
pivot tables section in Chapter 2](pivot.html). To [geocode US addresses
...
data](normalize.html) to create more meaningful maps, see [Chapter 13:
...
-   Built-in Visualization Tools: Several repositories offer built-in
    ...
    more about in [Chapter 9: Embed on the Web](embed.html).
-   Application Programming Interface (API): Some repositories provide
    ...
    about in [Chapter 12: Leaflet Map Templates](leaflet.html).
...
in this book, in Chapter 13: Transform Your Map Data.
...
shown in Figure <a href="#fig:sheets-with-tabs">3.3</a>. Add your own
...
<img src="images/03-find/sheets-with-tabs.png" alt="Create separate spreadsheet tabs for data, notes, and backup." width="600" />
<p class="caption">
Figure 3.3: Create separate spreadsheet tabs for data, notes, and
backup.
</p>
...
<a href="#fig:sheets-with-tabs">3.3</a>. Clearly label the new tab as a
...
Chapter 2, or to create a [histogram](histogram-google.html) as you will
learn in Chapter 6. These methods enable you to quickly inspect the
...
<a href="#fig:bad-geocoding">3.4</a>.

<img src="images/03-find/bad-geocoding.png" alt="Beware of bad geocoding that automatically places data in the geographic center of the contiguous United States (in northern Kansas), or on imaginary Null Island in the Atlantic Ocean (the location of coordinates 0,0)." width="600" />
<p class="caption">
Figure 3.4: Beware of bad geocoding that automatically places data in
...
these using methods we describe in [Chapter 4: Clean Up Messy
...
error bars in Chapter 6: Chart Your Data](chart.html).
...
design in Chapter 6](chart-design.html), and sometimes we need to
[acknowledge uncertainty in our data stories, as we’ll discuss in
Chapter 15](sources-uncertainty.html).
...
on this topic in [Chapter 14: Detect Lies and Reduce Bias](detect.html).
...
<a href="#fig:clean-up-messy-data">4.1</a> for inspiration. Don’t be
surprised if you find yourself spending more time cleaning up data than
you do analyzing and visualizing it.

<img src="images/04-clean/clean-up-messy-data.png" alt="More often than not, raw data looks messy." width="500" />
<p class="caption">
...
2.  Go to *Data &gt; Cleanup suggestions* and view items that appear in
    ...
    <a href="#fig:sheets-cleanup-suggestions">4.2</a>.

<img src="images/04-clean/sheets-cleanup-suggestions.png" alt="Go to *Data - Cleanup Suggestions* to review potential errors." width="650" />
<p class="caption">
Figure 4.2: Go to *Data - Cleanup Suggestions* to review potential
errors.
</p>
...
3.  In the *Edit* menu, choose *Find and replace*. You will see the
    ...
    <a href="#fig:sheets-find-replace">4.3</a>.
...
<img src="images/04-clean/sheets-find-replace-annotated.png" alt="Find and Replace window in Google Sheets." width="500" />
<p class="caption">
Figure 4.3: Find and Replace window in Google Sheets.
</p>
...
which you’ll learn in [Chapter 6: Chart Your Data](chart.html), we need
...
3.  Scroll further down the spreadsheet and click on a cell, or open a
    ...
    <a href="#fig:sheets-transpose">4.4</a>.

<img src="images/04-clean/sheets-transpose.png" alt="Go to *Edit - Paste Special - Paste Transposed* to swap rows and columns." width="450" />
<p class="caption">
Figure 4.4: Go to *Edit - Paste Special - Paste Transposed* to swap rows
and columns.
</p>
...
<img src="images/04-clean/sheets-split.png" alt="Select *Data - Split text to columns* to automatically separate data." width="350" />
<p class="caption">
Figure 4.5: Select *Data - Split text to columns* to automatically
separate data.
</p>
...
5.  Finally, select only the third column and perform *Split text to
    ...
    <a href="#fig:sheets-split-complex">4.6</a>, and press Enter. Now
    you have successfully split the full address into four columns.

<img src="images/04-clean/sheets-split-complex.png" alt="To split the last column, select a *Custom* separator and manually type in two dashes." width="550" />
<p class="caption">
Figure 4.6: To split the last column, select a *Custom* separator and
...
we introduced in Chapter 2](geocode.html), which requires all of the
...
3.  In cell E2, type in `=A2 & ", " & B2 & ", " & C2 & " " & D2`. This
    ...
    <a href="#fig:sheets-combine">4.7</a>. Then press *Enter*.

4.  Click cell E2 and drag the bottom-right corner cross-hair downward
    to fill in the rest of the column.

<img src="images/04-clean/sheets-combine.png" alt="Use ampersands to combine items, and insert quoted spaces with commas as separators."  />
<p class="caption">
Figure 4.7: Use ampersands to combine items, and insert quoted spaces
...
we described in Chapter 2](geocode.html) to find the latitude and
...
<a href="#fig:tabula-mac-alert">4.8</a>.

<img src="images/04-clean/tabula-mac-alert.png" alt="Mac users may need to confirm that they wish to open Tabula the first time." width="350" />
<p class="caption">
Figure 4.8: Mac users may need to confirm that they wish to open Tabula
the first time.
</p>
...
<a href="#fig:tabula-welcome">4.9</a>. Tabula runs on your local
...
<p class="caption">
Figure 4.9: Tabula welcome page.
</p>
...
4.  Click the *Autodetect Tables* button to let Tabula look for relevant
    ...
    Figure <a href="#fig:tabula-autodetect">4.10</a>.

<img src="images/04-clean/tabula-autodetect.png" alt="Click *Autodetect Tables*, which Tabula will highlight in red."  />
<p class="caption">
Figure 4.10: Click *Autodetect Tables*, which Tabula will highlight in
red.
</p>
...
as shown in Figure <a href="#fig:openrefine-dataset">4.11</a>. Can you
...
<img src="images/04-clean/openrefine-dataset.png" alt="Can you spot any problems with this sample data?" width="600" />
<p class="caption">
Figure 4.11: Can you spot any problems with this sample data?
</p>
...
in Figure <a href="#fig:openrefine-mac-alert-combined">4.12</a>. If
prompted with another window, click *Open*.

<img src="images/04-clean/openrefine-mac-alert-combined.png" alt="If your Mac displays a warning about launching OpenRefine (on left), go to *System Preferences - Security and Privacy - General tab* and click *Open Anyways* (on right)."  />
<p class="caption">
Figure 4.12: If your Mac displays a warning about launching OpenRefine
...
<a href="#fig:openrefine-welcome">4.13</a>. If your regular browser
...
<img src="images/04-clean/openrefine-welcome.png" alt="The OpenRefine welcome page." width="500" />
<p class="caption">
Figure 4.13: The OpenRefine welcome page.
</p>
...
1.  To transform text into numbers, select the *FundingAmount* column
    ...
    as shown in Figure <a href="#fig:openrefine-edit-common">4.15</a>.

<img src="images/04-clean/openrefine-edit-common.png" alt="In the *FundingAmount* column menu, select *Edit cells - Common transforms - To number*." width="450" />
<p class="caption">
Figure 4.15: In the *FundingAmount* column menu, select *Edit cells -
...
1.  Let’s remove `$` and `,` from the *FundingAmount* column. In the
    ...
    <a href="#fig:openrefine-edit-expression">4.16</a>. When you confirm
    your formula has no syntax errors, click *OK*

<img src="images/04-clean/openrefine-edit-expression.png" alt="Type the expression into the screen, preview the change, and confirm that there are no syntax errors."  />
<p class="caption">
Figure 4.16: Type the expression into the screen, preview the change,
...
3.  To fix the remaining non-numeric black cells, we need to remove
    ...
    *Apply*, as shown in Figure
    <a href="#fig:openrefine-manual-edit">4.17</a>.

<img src="images/04-clean/openrefine-manual-edit-combined.png" alt="Manually edit to remove spaces and extra characters, and change data type to number." width="550" />
<p class="caption">
Figure 4.17: Manually edit to remove spaces and extra characters, and
...
1.  If you agree with a grouping, check the *Merge?* box, and assign the
    *true* value to the *New Cell Value* input box, as shown in the
    first cluster in Figure <a href="#fig:openrefine-cluster">4.18</a>.
...
in chapter 2](calculate.html), we add up the sum and divide by the count
...
same at 3, as shown in Figure <a href="#fig:mean-vs-median">5.1</a>.
...
<img src="images/05-comparisons/mean-vs-median.png" alt="The *median* is a more useful comparative term than *average* or *mean* because it resists the influence of outliers." width="350" />
<p class="caption">
Figure 5.1: The *median* is a more useful comparative term than
...
possible causal relationships](table-design.html) in Chapter 8: Table
Your Data.
...
1.  *Which US states had the lowest number of motor vehicle crash
    ...
    deaths, as shown in Table <a href="#tab:deaths">5.1</a>, even though
    Washington DC is not legally recognized as a state.

<table>
<caption>Table 5.1: US States with lowest number of motor vehicle crash deaths, 2018</caption>
<thead>
<tr class="header">
...
Table 5.1: US States with lowest number of motor vehicle crash deaths,
2018
...
1.  *Which US states had the lowest number of motor vehicle crash deaths
    ...
    *per capita* rate, those very small decimals would be difficult for
    ...
    <a href="#tab:deaths-population">5.2</a>

<table>
<caption>Table 5.2: US States with lowest number of motor vehicle crash deaths per population, 2018</caption>
<thead>
<tr class="header">
<th style="text-align: left;">State</th>
<th style="text-align: right;">Deaths</th>
...
Table 5.2: US States with lowest number of motor vehicle crash deaths
per population, 2018
...
1.  *Which US states had the lowest number of motor vehicle crash deaths
    ...
    *appears* to be the safest state, with only 0.54 motor vehicle crash
    ...
    <a href="#tab:deaths-miles">5.3</a>. Also, note that the District of
    Columbia has fallen further down the list and been replaced by
    Minnesota.

<table>
<caption>Table 5.3: US States with lowest number of motor vehicle crash deaths per miles traveled, 2018</caption>
<colgroup>
<col style="width: 25%" />
<col style="width: 25%" />
<col style="width: 25%" />
...
Table 5.3: US States with lowest number of motor vehicle crash deaths
per miles traveled, 2018
...
data, as described in chapter 3](find.html). When working with
...
Figure <a href="#fig:selection-bias">5.2</a>.

<img src="images/05-comparisons/selection-bias.png" alt="If you randomly measured the height of people who happened to be leaving the gym after basketball practice, your artificially taller results would be due to selection bias." width="500" />
<p class="caption">
Figure 5.2: If you randomly measured the height of people who happened
...
in Figure <a href="#fig:self-selection-bias">5.3</a>. If your job is to
...
learned in [Chapter 3, it’s important to question your
...
<a href="#fig:self-selection-bias">5.3</a>. Since sub-groups C and D
...
<img src="images/05-comparisons/self-selection-bias.png" alt="To evaluate program effectiveness, do not compare program non-participants (A) versus those who apply or volunteer to participate (B). Instead, randomly split all participants into two sub-groups (C and D)." width="700" />
<p class="caption">
Figure 5.3: To evaluate program effectiveness, do not compare program
...
Later in [Chapter 14 you’ll learn how to recognize and reduce other
...
<!--chapter:end:05-comparisons.Rmd-->
...
Table <a href="#tab:chart-types">6.1</a>. Decisions about chart types
...
Chapter 11](chartcode.html). These advanced tools require prior
...
<table>
<caption>Table 6.1: Basic Chart Types, Best Uses, and Tutorials</caption>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
</colgroup>
...
<tbody>
<tr class="odd">
<td>Grouped bar or column chart<br> <img src="images/06-chart/tablechart-grouped-column.png" /></td>
...
<tr class="even">
<td>Split bar or column chart<br> <img src="images/06-chart/tablechart-split-column.png" /></td>
...
<tr class="odd">
<td>Stacked bar or column chart<br> <img src="images/06-chart/tablechart-stacked-column.png" /></td>
...
<tr class="even">
<td>Error bars in bar or column chart<br> <img src="images/06-chart/tablechart-error-column.png" /></td>
...
<tr class="odd">
<td>Histogram<br> <img src="images/06-chart/tablechart-histogram.png" /></td>
...
<tr class="even">
<td>Pie chart<br> <img src="images/06-chart/tablechart-pie.png" /></td>
...
<tr class="odd">
<td>Line chart<br> <img src="images/06-chart/tablechart-line.png" /></td>
...
<tr class="even">
<td>Annotated line chart<br> <img src="images/06-chart/tablechart-annotated.png" /></td>
...
<tr class="odd">
<td>Filtered line chart <br> <img src="images/06-chart/tablechart-filtered-line.png" /></td>
...
<tr class="even">
<td>Stacked area chart<br> <img src="images/06-chart/tablechart-stacked-area.png" /></td>
...
<tr class="odd">
<td>Range chart<br> <img src="images/06-chart/tablechart-range.png" /></td>
...
<tr class="even">
<td>Scatter chart <br> <img src="images/06-chart/tablechart-scatter.png" /></td>
...
<tr class="odd">
<td>Bubble chart <br> <img src="images/06-chart/tablechart-bubble.png" /></td>
...
<tr class="even">
<td>Sparklines<br> <img src="images/06-chart/tablechart-sparklines.png" /></td>
...
Table 6.1: Basic Chart Types, Best Uses, and Tutorials
...
<a href="#fig:design-principles-chart-components">6.1</a>. It shows
basic chart components that are shared among most chart types.

<img src="images/06-chart/design-principles-chart-components.png" alt="Common chart components."  />
<p class="caption">
...
value. Figure <a href="#fig:design-principles-start-at-zero">6.2</a>
...
results, as we describe later in [Chapter 14: Detect Lies and Reduce
Bias](detect.html)

<img src="images/06-chart/design-principles-start-at-zero.png" alt="Start your bar chart at zero."  />
<p class="caption">
...
Figure <a href="#fig:design-principles-baseline-comparison">6.3</a>,
where both are correct.

<img src="images/06-chart/design-principles-baseline-comparison.png" alt="Since line charts do *not* require a zero baseline, both sides are correct."  />
<p class="caption">
Figure 6.3: Since line charts do *not* require a zero baseline, both
sides are correct.
</p>
...
story. In Figure
<a href="#fig:design-principles-baseline-modified">6.4</a>, the left
...
Charts section of Chapter 14](how-to-lie-with-charts.html), people can
mislead us by modifying the vertical axis, and there is no uniform rule
about where it belongs on a line chart.

<img src="images/06-chart/design-principles-baseline-modified.png" alt="While the line chart with the zero baseline is acceptable, the line chart with a modified baseline more clearly tells a data story about change."  />
<p class="caption">
Figure 6.4: While the line chart with the zero baseline is acceptable,
...
junk” as shown in Figure <a href="#fig:design-principles-junk">6.5</a>,
...
<img src="images/06-chart/design-principles-junk.png" alt="Chart junk distracts the viewer, so stay away from shadows, 3D perspectives, unnecessary colors and other fancy elements."  />
<p class="caption">
Figure 6.5: Chart junk distracts the viewer, so stay away from shadows,
...
slice at 12 o’clock. Figure <a href="#fig:design-principles-pie">6.6</a>
illustrates that.

<img src="images/06-chart/design-principles-pie.png" alt="Sort slices in pie charts from largest to smallest, and start at 12 o'clock."  />
<p class="caption">
Figure 6.6: Sort slices in pie charts from largest to smallest, and
start at 12 o’clock.
</p>

If your pie chart has more than five slices, consider showing your data
in a bar chart, either stacked or split, like Figure
<a href="#fig:design-principles-pie-to-bar">6.7</a> shows.

<img src="images/06-chart/design-principles-pie-to-bar.png" alt="Consider using bar charts instead of pies."  />
<p class="caption">
...
<a href="#fig:design-principles-turn-bar">6.8</a> to see how much easier
it is to read horizontally-oriented labels.

<img src="images/06-chart/design-principles-turn-bar.png" alt="For long labels, use horizontal bar charts."  />
<p class="caption">
...
<a href="#fig:design-principles-order-categories">6.9</a>. You might
...
<img src="images/06-chart/design-principles-order-categories.png" alt="For long labels, use horizontal bar charts."  />
<p class="caption">
...
rules](https://en.wikipedia.org/wiki/Harmony_(color)) when choosing your
...
3.  Will the colors be distinguishable in black-and-white? Even if you
    ...
    Figure <a href="#fig:design-principles-color">6.10</a> shows some
    good and bad examples of color use.

<img src="images/06-chart/design-principles-color.png" alt="Don't use colors just for the sake of it."  />
<p class="caption">
...
Rost’s “[Your Friendly Guide to Colors in Data
...
shown in Figure <a href="#fig:design-principles-decluttered">6.11</a>.
...
<img src="images/06-chart/design-principles-decluttered.png" alt="Make sure important things catch the eye first."  />
<p class="caption">
...
2](spreadsheet.html). Google Sheets has many advantages for newcomers to
...
back to Table <a href="#tab:chart-types">6.1</a> for other tools and
...
Figure <a href="#fig:column-grouped-data">6.12</a>. Now you can easily
create a grouped column chart to displays these data series
side-by-side, as shown in Figure <a href="#fig:column-grouped">6.13</a>.

<img src="images/06-chart/column-grouped-data.png" alt="To create a grouped bar or column chart, format each data series vertically in Google Sheets." width="400" />
<p class="caption">
Figure 6.12: To create a grouped bar or column chart, format each data
series vertically in Google Sheets.
</p>

<img src="images/06-chart/column-grouped.png" alt="Grouped Column chart: Explore the [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vSkvNNrgYCpNtsaCRxn7g5o4UR8OJXSxBWvUK531t5vYubt39gecV9yLIfic89DCeJnGNvpRttFfKzn/pubchart?oid=787918829&format=interactive). Data from [NHANES / State of Childhood Obesity, 2017-18](https://stateofchildhoodobesity.org/monitor/)."  />
<p class="caption">
Figure 6.13: Grouped Column chart: Explore the [interactive
...
1.  Open our [Grouped Column chart template in Google
    ...
    <a href="#fig:file-make-copy2">6.14</a>.

<img src="images/06-chart/file-make-copy2.png" alt="Make your own copy of the Google Sheet template." width="250px" />
<p class="caption">
Figure 6.14: Make your own copy of the Google Sheet template.
</p>

1.  To remove the current chart from your copy of the spreadsheet, float
    your cursor to the top-right corner of the chart to make the
    three-dot kebab menu appear, and select *Delete*, as shown in Figure
    <a href="#fig:delete-chart">6.15</a>.

<img src="images/06-chart/delete-chart.png" alt="Float cursor in top-right corner of the chart to make the three-dot kebab menu appear, and select Delete." width="180px" />
<p class="caption">
Figure 6.15: Float cursor in top-right corner of the chart to make the
...
1.  Format your data to make each column a data series (such as male and
    ...
    <a href="#fig:column-grouped-data">6.12</a>, which means it will
...
2.  Use your cursor to select only the data you wish to chart, then go
    ...
    <a href="#fig:column-grouped-insert">6.16</a>.

<img src="images/06-chart/column-grouped-insert.png" alt="Select your data and Insert the Chart." width="250px" />
<p class="caption">
Figure 6.16: Select your data and Insert the Chart.
</p>
...
1.  In the Chart Editor, change the default selection to *Column chart*,
    ...
    <a href="#fig:column-grouped-editor">6.17</a>. Or select *Horizontal
    bar chart* if you have longer labels.

<img src="images/06-chart/column-grouped-editor.png" alt="Change the default to Column chart, with Stacking none." width="250px" />
<p class="caption">
Figure 6.17: Change the default to Column chart, with Stacking none.
</p>

1.  To customize title, labels, and more, in the Chart Editor select
    *Customize*, as shown in Figure
    <a href="#fig:chart-editor-customize">6.18</a>. Also, you can select
    the chart and axis titles to edit them.

<img src="images/06-chart/chart-editor-customize.png" alt="Select Customize to edit title, labels, and more." width="250px" />
<p class="caption">
Figure 6.18: Select Customize to edit title, labels, and more.
</p>
...
1.  To make your data public, go to the upper-right corner of your sheet
    ...
    <a href="#fig:share-button-sheet">6.19</a>. This means your sheet is
    no longer Restricted to only you, but can be viewed by anyone with
    the link. See additional options.

<img src="images/06-chart/share-button-sheet-annotated.png" alt="Click the Share button and then click *Change to anyone with the link* to make your data public." width="350px" />
<p class="caption">
Figure 6.19: Click the Share button and then click *Change to anyone
...
1.  To embed an interactive version of your chart in another web page,
    ...
    <a href="#fig:chart-publish">6.20</a>. In the next screen, select
    Embed and press the Publish button. See [Chapter 9: Embed on the
    Web](embed.html) to learn what to do with the iframe code.

<img src="images/06-chart/chart-publish.png" alt="Select Publish Chart to embed an interactive chart on another web page." width="150" />
<p class="caption">
Figure 6.20: Select Publish Chart to embed an interactive chart on
another web page.
</p>
...
shown in Figure <a href="#fig:chart-error-bar">6.21</a>. This setting
will be applied to all data points in that series.

<img src="images/06-chart/chart-error-bar.png" alt="Google Sheets has limited settings to create error bars." width="300" />
<p class="caption">
Figure 6.21: Google Sheets has limited settings to create error bars.
</p>
...
Sheet, as shown in Figure <a href="#fig:bar-split-data">6.22</a>. Since
...
<a href="#fig:bar-split">6.23</a>. Unlike the grouped column chart
previously shown in Figure <a href="#fig:column-grouped">6.13</a>, here
...
<img src="images/06-chart/bar-split-data.png" alt="To create a split bar (or column) chart, format each data series vertically, and leave cells blank where appropriate." width="550" />
<p class="caption">
Figure 6.22: To create a split bar (or column) chart, format each data
series vertically, and leave cells blank where appropriate.
</p>

<img src="images/06-chart/bar-split.png" alt="Split bar chart: Explore the [full-screen interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vSkvNNrgYCpNtsaCRxn7g5o4UR8OJXSxBWvUK531t5vYubt39gecV9yLIfic89DCeJnGNvpRttFfKzn/pubchart?oid=787918829&format=interactive). Data from [Starbucks and McDonalds](https://docs.google.com/spreadsheets/d/1LGUYaVLoRcOiB8KcXb3Rn7LRj0exnUQYOy58LrkGPAk/edit#gid=956322126)."  />
<p class="caption">
Figure 6.23: Split bar chart: Explore the [full-screen interactive
version](https://docs.google.com/spreadsheets/d/e/2PACX-1vSkvNNrgYCpNtsaCRxn7g5o4UR8OJXSxBWvUK531t5vYubt39gecV9yLIfic89DCeJnGNvpRttFfKzn/pubchart?oid=787918829&format=interactive).
...
<a href="#fig:column-stacked-data">6.24</a>. Now you can easily create a
stacked column (or bar) chart that displays comparisons of weight-level
subcategories across nations, as shown in Figure
<a href="#fig:column-stacked">6.25</a>. Often it’s better to use a
...
<img src="images/06-chart/column-stacked-data.png" alt="To create a stacked column (or bar) chart, format each data series vertically in Google Sheets." width="450" />
<p class="caption">
Figure 6.24: To create a stacked column (or bar) chart, format each data
series vertically in Google Sheets.
</p>

<img src="images/06-chart/column-stacked.png" alt="Stacked column chart: Explore the [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vSZrCP99EDqmpYc3VxFF5-Fpryh7KOU3GZ39Gl33OmDw4ecWKXxjrfzHDeQKfandKiUwvDkyF6kwK6L/pubchart?oid=307057605&format=interactive). Data from [WHO and CDC](https://docs.google.com/spreadsheets/d/1WS11EK33JCmvCRzSDh9UpP6R7Z2sHglF7ve5iJL6eZk/edit#gid=735710691)."  />
<p class="caption">
Figure 6.25: Stacked column chart: Explore the [interactive
...
<a href="#fig:column-stacked-edit-series">6.26</a>.

<img src="images/06-chart/column-stacked-edit-series.png" alt="To edit a column color, select *Edit Chart - Customize - Series*." width="450" />
<p class="caption">
Figure 6.26: To edit a column color, select *Edit Chart - Customize -
Series*.
</p>
...
you’ll learn in Chapter 7](design-choropleth.html). Although histograms
...
2.  To create a quick histogram in Google Sheets, select any column,
    ...
    in Figure <a href="#fig:histogram-quick">6.27</a>. The advantage is
...
<img src="images/06-chart/histogram-quick.png" alt="To create a quick histogram in a Google Sheet, select a column, then go to *Data - Column stats - Distribution*." width="500" />
<p class="caption">
Figure 6.27: To create a quick histogram in a Google Sheet, select a
...
<a href="#fig:histogram-quick">6.27</a> shows that while most nations
...
<a href="#fig:histogram-quick">6.27</a> with the regular histogram
created with *Charts* in Figure <a href="#fig:histogram">6.28</a>.
...
<img src="images/06-chart/histogram.png" alt="Regular histogram chart: Explore the full-screen [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vRyg09UZgGWVHPk3oOKAZ-zlqtDF_RpvOLdAsM-k-ZW5NavcxAyHbErgr-7dt7U_AFSVZONSTZ9sVII/pubchart?oid=480820223&amp;format=interactive)."  />
<p class="caption">
Figure 6.28: Regular histogram chart: Explore the full-screen
[interactive
...
1.  To create a regular histogram in Google Sheets, select a column with
    ...
    <a href="#fig:histogram-chart-type">6.29</a>

<img src="images/06-chart/histogram-chart-type.png" alt="If not shown automatically, go to the Chart Editor sidebar and select *Setup - Chart type - Other - Histogram*." width="300" />
<p class="caption">
Figure 6.29: If not shown automatically, go to the Chart Editor sidebar
...
version, as you’ll learn in [Chapter 9: Embed on the Web](embed.html).
...
needs, refer back to Table <a href="#tab:chart-types">6.1</a> for other
tools and tutorials.
...
Figure <a href="#fig:pie-data">6.30</a>. Values can be expressed as
...
Figure <a href="#fig:pie">6.31</a>. Viewers can see that bananas made up
slightly over half of the fruit sold, followed by apples and oranges.

<img src="images/06-chart/pie-data.png" alt="To create a pie chart, format the data values vertically in Google Sheets." width="300" />
<p class="caption">
Figure 6.30: To create a pie chart, format the data values vertically in
Google Sheets.
</p>

<img src="images/06-chart/pie.png" alt="Pie chart: Explore the [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vQai8YWkqMOHsiwWXpe1jyhBKy5wW6zcMaEIklkF-598h1QaVBrRR0F9JVrsX2Zo5ihXWP-HlnY-KlE/pubchart?oid=760990456&format=interactive). Data is fictitious."  />
<p class="caption">
Figure 6.31: Pie chart: Explore the [interactive
...
shown in Figure <a href="#fig:line-data">6.32</a>. Now you can easily
create a line chart that emphasizes each data series changed over time,
as shown in Figure <a href="#fig:line">6.33</a>. In the US, the amount
of chicken per capita steadily rose and surpassed pork and beef around
2000.

<img src="images/06-chart/line-data.png" alt="To create a line chart, format the time units and each data series in vertical columns." width="300" />
<p class="caption">
Figure 6.32: To create a line chart, format the time units and each data
series in vertical columns.
</p>

<img src="images/06-chart/line.png" alt="Line chart: Explore the [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vS38EC_34L8gKK9NStS8S322BzvBRbnRNpu9KXQ4oHHpaDmVMBAhEu4SXtCC6CD2yv_V6brX8s386Nf/pubchart?oid=2073830845&format=interactive). Data from [US Department of Agriculture](https://docs.google.com/spreadsheets/d/1wkWxxZ2-N5hqkcp7in8bxwdEcT1-XMnt1A8qUXxUSjw/edit?usp=sharing)."  />
<p class="caption">
Figure 6.33: Line chart: Explore the [interactive
...
columns in Chapter 4: Clean Up Messy Data](transpose.html).
...
did for the line chart in Figure <a href="#fig:line-data">6.32</a>. Now
...
in Figure <a href="#fig:stacked-area">6.34</a>. Overall, we can see that
...
chapter 7](map.html) and [tables, in chapter 8](table.html). With
...
described in Chapter 2](spreadsheet.html), [record your detailed source
notes and save raw data files as described in Chapter 3](find.html), and
[clean up your data as described in Chapter 4](clean.html). Although
...
<a href="#tab:chart-types">6.1</a> for other tools and tutorials, or
...
<a href="#fig:datawrapper-annotated">6.35</a>. Since 2000, the
...
<img src="images/06-chart/datawrapper-annotated.png" alt="Line chart with annotation: Explore the [interactive version](https://datawrapper.dwcdn.net/vHuob/). Data from [US Federal Reserve Open Data](https://docs.google.com/spreadsheets/d/1mjUu4OfMjWfFP-miPiObi6vXzJUIMi1TSuoaT61FU6U/edit#gid=821851972)."  />
<p class="caption">
Figure 6.35: Line chart with annotation: Explore the [interactive
...
3.  In the *Upload Data* screen, click *Import Google Spreadsheet* and
    ...
    shown in Figure
    <a href="#fig:datawrapper-annotated-upload">6.36</a>, then click
...
<img src="images/06-chart/datawrapper-annotated-upload.png" alt="To upload data from a shared Google Sheet, click the button and paste the link." width="550" />
<p class="caption">
Figure 6.36: To upload data from a shared Google Sheet, click the button
and paste the link.
</p>
...
3.  Scroll down further in the *Annotate* tab to the *Text annotations*
    ...
    as shown in Figure
    <a href="#fig:datawrapper-annotated-text">6.37</a>. This helps
...
<img src="images/06-chart/datawrapper-annotated-text.png" alt="Add text annotations by drawing a pink rectangle and typing in the text."  />
<p class="caption">
Figure 6.37: Add text annotations by drawing a pink rectangle and typing
in the text.
</p>
...
1.  Scroll down further in the *Annotate* tab to the *Highlight range*
    ...
    Figure <a href="#fig:datawrapper-annotated-range">6.38</a>. This
...
&lt;img src=“images/06-chart/datawrapper-annotated-range.png” alt=“Add a
range highlight by”drawing" a rectangular bar on the chart." width=“600”
/&gt;
<p class="caption">
Figure 6.38: Add a range highlight by “drawing” a rectangular bar on the
chart.
</p>
...
1.  Click *Proceed* or advance to the *Publish & Embed* screen to share
    ...
    chart on your website, as you’ll learn about in [Chapter 9: Embed on
...
Tip: See this [Datawrapper Academy article to create a line chart with
confidence
...
<a href="#fig:datawrapper-range">6.39</a>. We were inspired by the
...
<img src="images/06-chart/datawrapper-range.png" alt="Range chart: Explore the [interactive version](https://datawrapper.dwcdn.net/lVGnz/). Data from [US Census 2019 American Community Survey](https://docs.google.com/spreadsheets/d/1qAfMHBegOz1-ZlN9UurZ_wsesmLGYlu_ch7M3Anwdsg/edit#gid=0)."  />
<p class="caption">
Figure 6.39: Range chart: Explore the [interactive
...
<a href="#fig:datawrapper-range-data">6.40</a>. The first column
...
<img src="images/06-chart/datawrapper-range-data.png" alt="Organize your range chart data into three columns: labels, and values for both subgroups." width="500" />
<p class="caption">
Figure 6.40: Organize your range chart data into three columns: labels,
...
7.  Click the *Refine* tab of the *Visualize* screen to modify the range
    ...
    *Label first range*, which places the word *Men* and *Women* above
    ...
    <a href="#fig:datawrapper-range-labels">6.41</a>.

<img src="images/06-chart/datawrapper-range-labels.png" alt="Modify the labels settings to show values at both ends of each range, and to place your data labels on your first range." width="600" />
<p class="caption">
Figure 6.41: Modify the labels settings to show values at both ends of
...
1.  Still in the *Refine* tab, scroll down to the *Appearance* section
    ...
    <a href="#fig:datawrapper-range-appearance">6.42</a>.

<img src="images/06-chart/datawrapper-range-appearance.png" alt="Modify the appearance settings to improve the color and add a gradient." width="600" />
<p class="caption">
Figure 6.42: Modify the appearance settings to improve the color and add
a gradient.
</p>
...
<a href="#fig:scatter-data">6.43</a>. The first column contains the
...
<a href="#fig:scatter">6.44</a>. One way to summarize the chart is that
...
<img src="images/06-chart/scatter-data.png" alt="To create a scatter chart in Datawrapper, format data in three columns: labels, x-values, and y-values." width="350" />
<p class="caption">
Figure 6.43: To create a scatter chart in Datawrapper, format data in
three columns: labels, x-values, and y-values.
</p>

<img src="images/06-chart/scatter.png" alt="Scatter chart: Explore the [interactive version](https://datawrapper.dwcdn.net/8OQz7/). Data from the [World Bank](https://docs.google.com/spreadsheets/d/1LJCj3RaVgaQsAZriV_JDQhBrIBSvnH_N1LBCkZK1bqs/)."  />
<p class="caption">
Figure 6.44: Scatter chart: Explore the [interactive
...
6.  In the *Visualize* screen, under the *Annotate* tab, scroll down to
    ...
    *return* twice on your keyboard, then type `Fertility:` and click on
    ...
    <a href="#fig:scatter-tooltip-editor">6.45</a>. Press *Save* to
    close the tooltip editor window.

<img src="images/06-chart/scatter-tooltip-editor.png" alt="In the tooltip editor window, type and click column headers to customize the display." width="350" />
<p class="caption">
Figure 6.45: In the tooltip editor window, type and click column headers
...
1.  Back in the *Visualize* screen, when you hover your cursor over a
    ...
    <a href="#fig:scatter-tooltip">6.46</a>.

<img src="images/06-chart/scatter-tooltip.png" alt="Hover over a data point to inspect the edited tooltip display." width="350" />
<p class="caption">
Figure 6.46: Hover over a data point to inspect the edited tooltip
display.
</p>
...
1.  Finish the annotations to add your title and data source, then
    ...
    your next steps in [Chapter 9: Embed on the Web](embed.html).
...
<a href="#fig:bubble-data">6.47</a>. Note that we’re using numeric data
...
<a href="#fig:bubble">6.48</a>.

<img src="images/06-chart/bubble-data.png" alt="To create a bubble chart in Datawrapper, organize the data into five columns: labels, x-axis, y-axis, bubble size, bubble color." width="500" />
<p class="caption">
Figure 6.47: To create a bubble chart in Datawrapper, organize the data
into five columns: labels, x-axis, y-axis, bubble size, bubble color.
</p>

<img src="images/06-chart/bubble.png" alt="Bubble chart: Explore the [interactive version](https://datawrapper.dwcdn.net/ZX9QR/). Data from the [World Bank](https://docs.google.com/spreadsheets/d/1yiZ975_uXOTOd0OCAdrR_s-bQFs7za3dar69IXPo6Xg)."  />
<p class="caption">
Figure 6.48: Bubble chart: Explore the [interactive
...
4.  In the *Visualize* screen, under the *Annotate* tab, scroll down to
    ...
    *Customize tooltip HTML* window, type in the fields and click on the
    ...
    <a href="#fig:bubble-tooltip-editor">6.49</a>. Press *Save* to close
    the tooltip editor window.

<img src="images/06-chart/bubble-tooltip-editor.png" alt="In the tooltip editor window, type and click column headers to customize the display."  />
<p class="caption">
Figure 6.49: In the tooltip editor window, type and click column headers
to customize the display.
</p>
...
1.  Back in the *Visualize* screen, under the *Refine* tab, scroll down
    ...
    *Size*, check the box to change size to *variable*, select column
    ...
    Figure <a href="#fig:bubble-color-size">6.50</a>. Click *Proceed*.

<img src="images/06-chart/bubble-color-size.png" alt="In the *Visualize* screen, modify the bubble colors and set size to variable." width="350" />
<p class="caption">
Figure 6.50: In the *Visualize* screen, modify the bubble colors and set
size to variable.
</p>
...
1.  Test your visualization tooltips. Then finish the annotations to add
    ...
    Datawrapper tutorial above. See your next steps in [Chapter 9: Embed
    on the Web](embed.html).
...
important difference. All data visualizations you publish become public,
as the product name suggests, so do not use Tableau Public for any
sensitive or confidential data that you do not wish to share with
others.
...
skills in Chapter 2](spreadsheet.html), [data cleaning methods in
Chapter 4](clean.html), and tools to [transform map data coming up in
Chapter 13](transform.html). Second, Tableau Public offers a wider array
...
scatter chart tutorial](scatter-bubble-datawrapper.html): the first
column for data labels, the second column for the x-axis, and the third
column for the y-axis. Then you can create an interactive scatter chart
as shown in Figure <a href="#fig:tableau-scatter">6.51</a>, which
illustrates a strong relationship between household income and test
scores (above or below the national average for 6th grade math and
English) in Connecticut public school districts. To learn more about the
data and related visualizations, see Sean Reardon et al. at the
[Stanford Education Data Archive](http://purl.stanford.edu/db586ns4974),
Motoko Rich et al. at [The New York
...
4.  Drag the *data* sheet into *Drag tables here* area, as shown in
    Figure <a href="#fig:tableau-connect">6.52</a>. You will see the
...
<img src="images/06-chart/tableau-connect-annotated.png" alt="Drag *data* sheet into *Drag tables here* area."  />
<p class="caption">
Figure 6.52: Drag *data* sheet into *Drag tables here* area.
</p>
...
1.  In your worksheet, drag the *Grade Levels* field into the *Rows*
    ...
    See Figure <a href="#fig:tableau-scatter-dragging">6.53</a> for this
...
<img src="images/06-chart/tableau-scatter-dragging-annotated.png" alt="Drag data fields to the right locations in Tableau Public."  />
<p class="caption">
Figure 6.53: Drag data fields to the right locations in Tableau Public.
</p>
...
<a href="#fig:tableau-scatter-final">6.54</a>.

<img src="images/06-chart/tableau-scatter-final-annotated.png" alt="This scatter chart is ready to be published."  />
<p class="caption">
Figure 6.54: This scatter chart is ready to be published.
</p>
...
3.  After saving your workbook on the public web, Tableau Public will
    ...
    *Allow others to download or explore and copy this workbook and its
    ...
    <a href="#fig:tableau-toolbar-settings">6.55</a>. If you are
...
<img src="images/06-chart/tableau-toolbar-settings-annotated.png" alt="This scatter chart is ready to be published."  />
<p class="caption">
Figure 6.55: This scatter chart is ready to be published.
</p>
...
See the [Get the Embed Code](embed-code.html) section in Chapter 9 to
insert the interactive version of your chart on a web page that you
control.
...
shown in Figure <a href="#fig:tableau-filtered-data">6.56</a>. The first
...
<a href="#fig:tableau-filtered">6.57</a>.

<img src="images/06-chart/tableau-filtered-data.png" alt="In a filtered line chart, organize the data in three columns, data labels, year, and numeric values." width="350" />
<p class="caption">
Figure 6.56: In a filtered line chart, organize the data in three
columns, data labels, year, and numeric values.
</p>

<img src="images/06-chart/tableau-filtered.png" alt="Filtered Line chart: Explore the [interactive version](https://public.tableau.com/profile/ilya7257#!/vizhome/InternetAccessbyCountry/Sheet1). Data from [World Bank](https://docs.google.com/spreadsheets/d/1nrfd8Cr-wpm5N9WGA2YO6d1XLuwk-VK8kCvDwoTdeWM/edit#gid=600173793)."  />
<p class="caption">
Figure 6.57: Filtered Line chart: Explore the [interactive
...
3.  In order to “break” aggregation, drag-and-drop *Country Name* to the
    *Color* shelf of the *Marks* card, as shown in Figure
    <a href="#fig:tableau-filtered-filters">6.58</a>. Tableau will warn
...
<img src="images/06-chart/tableau-filtered-filters.png" alt="Drag *Country Name* to the *Color* shelf of the *Marks* card to break up the aggregated data." width="220" />
<p class="caption">
Figure 6.58: Drag *Country Name* to the *Color* shelf of the *Marks*
...
2.  In the *Filters* card, click the dropdown arrow of the *Country
    ...
    Figure <a href="#fig:tableau-filtered-show-filter">6.59</a>.
...
<img src="images/06-chart/tableau-filtered-show-filter.png" alt="After you drag *Country Name* to the *Filters* card, make sure the Filter is displayed." width="220" />
<p class="caption">
Figure 6.59: After you drag *Country Name* to the *Filters* card, make
...
4.  Once your filtered line chart looks like the one shown in Figure
    <a href="#fig:tableau-filtered-ready">6.60</a>, you are ready to
...
<img src="images/06-chart/tableau-filtered-ready-annotated.png" alt="This workbook is ready to be published."  />
<p class="caption">
Figure 6.60: This workbook is ready to be published.
</p>

See the [Get the Embed Code](embed-code.html) section of Chapter 9 to
insert the interactive version of your chart on a web page that you
control.
...
advanced chart design with open-source code, see [Chapter 11: Chart.js
...
charts on your website in Chapter 9](embed.html).
...
<a href="#tab:map-types">7.1</a>. For example, point maps work best to
...
in Chapter 12](leaflet.html). These advanced tools require prior
knowledge on how to [edit and host code templates with GitHub in Chapter
10](github.html).

<table>
<caption>Table 7.1: Basic Map Types, Best Uses, and Tutorials</caption>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
</colgroup>
...
<tbody>
<tr class="odd">
<td>Point map with custom icons<br> <img src="images/07-map/tablemap-point.png" /></td>
...
<tr class="even">
<td>Symbol point map<br> <img src="images/07-map/tablemap-symbol.png" /></td>
...
<tr class="odd">
<td>Choropleth (colored polygon) map <br> <img src="images/07-map/tablemap-choropleth.png" /></td>
...
<tr class="even">
<td>Heat point map <br> <img src="images/07-map/tablemap-heat.png" /></td>
...
<tr class="odd">
<td>Story map <br> <img src="images/07-map/tablemap-storymap.png" /></td>
...
<tr class="even">
<td>Polyline map <br> <img src="images/07-map/tablemap-polyline.png" /></td>
...
<tr class="odd">
<td>Customized point-polyline-polygon map <br> <img src="images/07-map/tablemap-point-polyline-polygon.png" /></td>
...
<tr class="even">
<td>Searchable point map<br> <img src="images/07-map/tablemap-searchable.png" /></td>
...
<tr class="odd">
<td>Current map from open-data repository<br> <img src="images/07-map/tablemap-open-data.png" /></td>
...
<a href="#fig:raster-vs-vector-zoom">7.1</a>. You’ll learn more about
these concepts in the [GeoJSON and Geospatial Data](geojson.html)
section of Chapter 13.

<img src="images/07-map/raster-vs-vector-zoom.png" alt="Raster map data from Esri World Imagery (on the left), and vector map data from OpenStreetMap (on the right), both showing Ilya's childhood neighborhood in Mogilev, Belarus. Zooming into raster map data makes it fuzzier, while vector map data retains its sharpness." width="750" />
<p class="caption">
Figure 7.1: Raster map data from Esri World Imagery (on the left), and
vector map data from OpenStreetMap (on the right), both showing Ilya’s
childhood neighborhood in Mogilev, Belarus. Zooming into raster map data
makes it fuzzier, while vector map data retains its sharpness.
</p>

Look at Figure <a href="#fig:map-principles-map">7.2</a> to learn about
...
<img src="images/07-map/map-principles-map.png" alt="Key elements of an interactive map."  />
<p class="caption">
...
polygon maps in previous Table <a href="#tab:map-types">7.1</a>.
...
with [pivot tables, a topic we introduced in Chapter 2](pivot.html). For
...
of Chapter 13: Transform Your Map Data](pivot-point-to-polygon.html)
...
Figure <a href="#fig:map-two-variables">7.3</a>(a). Second, you decide
...
Figure <a href="#fig:map-two-variables">7.3</a>(b). Both of those maps
...
<a href="#fig:map-two-variables">7.3</a>(c). And this is where your map
...
<img src="images/07-map/map-two-variables.png" alt="To compare two variables, such as income and education, avoid placing a symbol point map on top of a choropleth map. Instead, create a scatter chart, and consider pairing it with a choropleth map of one variable." width="450" />
<p class="caption">
Figure 7.3: To compare two variables, such as income and education,
...
<a href="#fig:map-two-variables">7.3</a>(d). Or if geographic patterns
...
<a href="#fig:map-two-variables">7.3</a>(a and d). Overall, remember
...
units. In Figure <a href="#fig:zillow-northeast">7.4</a>, the map on the
left shows home values at the larger state level, while the map on the
right shows home values at the smaller county level.

<img src="images/07-map/zillow-northeast.png" alt="Zillow typical home values in September 2020 shown at the larger state level (left) versus the smaller county level (right)." width="500" />
<p class="caption">
Figure 7.4: Zillow typical home values in September 2020 shown at the
...
in general, see Lisa Charlotte Rost’s “[Your Friendly Guide to Colors in
...
in Figure <a href="#fig:map-colorbrewer">7.5</a>.

<img src="images/07-map/map-colorbrewer-annotated.png" alt="The ColorBrewer design assistant interface: data classes, type of color scheme, and recommended color codes."  />
<p class="caption">
Figure 7.5: The ColorBrewer design assistant interface: data classes,
...
<a href="#fig:map-principles-color-schemes">7.6</a>.

<img src="images/07-map/map-principles-color-schemes.png" alt="Sequential, diverging, and qualitative color palettes from [ColorBrewer](https://colorbrewer2.org/)."  />
<p class="caption">
Figure 7.6: Sequential, diverging, and qualitative color palettes from
...
<a href="#fig:map-principles-classification">7.7</a>. The sequential
...
<img src="images/07-map/map-principles-classification.png" alt="Sequential versus diverging color palettes to illustrate per capita income in US dollars in the contiguous states, from American Community Survey, 2018." width="750" />
<p class="caption">
Figure 7.7: Sequential versus diverging color palettes to illustrate per
...
<a href="#fig:colorbrewer-export">7.8</a>, if your preferred map tool
allows you to import color palettes.

<img src="images/07-map/colorbrewer-export.png" alt="Click open the *Export* tab to display your color palette codes in various formats." width="435" />
<p class="caption">
Figure 7.8: Click open the *Export* tab to display your color palette
...
Figure <a href="#fig:intervals-type-combined">7.9</a>. *Steps* are
...
<img src="images/07-map/intervals-type-combined.png" alt="Steps versus continuous color intervals in Datawrapper (left) and Tableau Public (right)." width="500" />
<p class="caption">
Figure 7.9: Steps versus continuous color intervals in Datawrapper
...
<a href="#fig:colorbrewer-steps">7.10</a>. Make decisions with the best
interests of your readers in mind, to represent your data in honest and
insightful ways.

<img src="images/07-map/colorbrewer-steps.png" alt="If you choose steps, experiment with ColorBrewer data classes and color palettes." width="300" />
<p class="caption">
Figure 7.10: If you choose steps, experiment with ColorBrewer data
...
<a href="#fig:interpolation-datawrapper-combined">7.11</a>.

<img src="images/07-map/interpolation-datawrapper-combined.png" alt="Interpolation options for steps (left) and continuous (right) in Datawrapper." width="650" />
<p class="caption">
Figure 7.11: Interpolation options for steps (left) and continuous
(right) in Datawrapper.
</p>

Before choosing how to interpolate, create a [histogram chart in Google
Sheets described in chapter 6](histogram-google.html) to gain a deeper
...
<a href="#fig:interpolation-histograms">7.12</a>, which may influence
your decision about how to interpolate, as described below.

<img src="images/07-map/interpolation-histograms.png" alt="Histogram of evenly-distributed data (on right) versus skewed data with a longer tail to one side (on left)." width="500" />
<p class="caption">
Figure 7.12: Histogram of evenly-distributed data (on right) versus
...
create misleading maps, as you’ll learn in [Chapter 14: Detect Lies and
...
<a href="#fig:intervals-datawrapper-montage">7.13</a>. In other words,
...
<img src="images/07-map/intervals-datawrapper-montage.png" alt="Use the full color range to show all of the differences in the data. Image by [Datawrapper Academy](https://academy.datawrapper.de/article/134-what-to-consider-when-creating-choropleth-maps), reprinted with permission." width="500" />
<p class="caption">
Figure 7.13: Use the full color range to show all of the differences in
...
We introduced the concept of [normalizing data in Chapter 5: Make
...
<a href="#fig:normalize-map-data">7.14</a>. They both are about Covid-19
cases in the continental US as of June 26, 2020. Figure
<a href="#fig:normalize-map-data">7.14</a>a shows total number of
recorded cases per state, and Figure
<a href="#fig:normalize-map-data">7.14</a>b shows Covid-19 cases
...
<img src="images/07-map/normalize-map-data-annotated.png" alt="Choropleth maps work best with normalized values."  />
<p class="caption">
...
map in Figure <a href="#fig:normalize-map-data">7.14</a>b, we normalized
...
<a href="#fig:normalize-map-data">7.14</a>a)? If you are familiar with
...
<a href="#fig:normalize-map-data">7.14</a>b? You can see that New York
...
that you’ll learn more about in [Chapter 9: Embed on the
Web](embed.html).
...
<a href="#fig:mymaps-final">7.15</a>.

<img src="images/07-map/mymaps-final.png" alt="Point map of parks and museums created with Google My Maps. Explore the [interactive version](https://www.google.com/maps/d/u/1/edit?mid=1W6VujVZzB1Y1D1tktLVhO99ZabyOZABr&usp=sharing)."  />
<p class="caption">
Figure 7.15: Point map of parks and museums created with Google My Maps.
...
2.  Navigate to [Google My Maps](https://www.google.com/mymaps/). In the
    ...
    in Figure <a href="#fig:mymaps-create-new">7.16</a>. This will
    create an empty map with familiar Google Maps style.

<img src="images/07-map/mymaps-create-new.png" alt="Navigate to https://www.google.com/mymaps/ and create a new map." width="300" />
<p class="caption">
Figure 7.16: Navigate to <https://www.google.com/mymaps/> and create a
new map.
</p>
...
1.  Add a relevant title and description by clicking its current title,
    *Untitled map*, and typing in the new information, as shown in
    Figure <a href="#fig:mymaps-edit-title">7.17</a>.

<img src="images/07-map/mymaps-edit-title.png" alt="Add title and description to your map." width="300" />
<p class="caption">
...
1.  To add data to your map, click the *Import* button under the
    *Untitled layer* item, as shown in Figure
    <a href="#fig:mymaps-import">7.18</a>.

<img src="images/07-map/mymaps-import.png" alt="Click the *Import* button to add a data layer to your map." width="300" />
<p class="caption">
...
1.  In the *Choose a file to import* screen, there are several ways to
    ...
    *Museums and Parks* file you saved to your Google Drive, as shown in
    Figure <a href="#fig:mymaps-import-gdrive">7.19</a>. Press *Select*.

<img src="images/07-map/mymaps-import-gdrive.png" alt="After you choose to import your data through *Google Drive*, select the *Recent* button to find the file." width="750" />
<p class="caption">
Figure 7.19: After you choose to import your data through *Google
...
1.  In the *Choose columns to position your placemarks* screen, select
    ...
    in Figure <a href="#fig:mymaps-placemarks">7.20</a>. Press
    *Continue*.

<img src="images/07-map/mymaps-placemarks.png" alt="Select *Address* to place your data on the map." width="350" />
<p class="caption">
Figure 7.20: Select *Address* to place your data on the map.
</p>

Tip: You can select multiple boxes if your address is split across
...
1.  In the *Choose a column to title your markers* window, select the
    *Name* column to title your point markers, as shown in Figure
    <a href="#fig:mymaps-marker-titles">7.21</a>. Then click *Finish*.

<img src="images/07-map/mymaps-marker-titles.png" alt="Select the *Name* column to title your point markers." width="350" />
<p class="caption">
...
1.  Click the three-dot kebab menu next to the *Museums and Parks…*
    ...
    <a href="#fig:mymaps-rename-layer">7.22</a>.

<img src="images/07-map/mymaps-rename-layer.png" alt="Click the three-dot kebab menu next to the layer to shorten its name." width="300" />
<p class="caption">
Figure 7.22: Click the three-dot kebab menu next to the layer to shorten
its name.
</p>
...
1.  Since our map contains two groups—museums and parks—let’s create a
    ...
    in Figure <a href="#fig:mymaps-group-places">7.23</a>. This option
...
<img src="images/07-map/mymaps-group-places.png" alt="Change *Individual styles* to *Group places by: Group*." width="300" />
<p class="caption">
...
1.  Under *Styled by group*, float your cursor over the *Museum* label
    ...
    Figure <a href="#fig:mymaps-customize-marker">7.24</a>.

<img src="images/07-map/mymaps-customize-marker.png" alt="Float your cursor over a label to reveal the bucket styling symbol." width="295" />
<p class="caption">
Figure 7.24: Float your cursor over a label to reveal the bucket styling
symbol.
</p>

1.  Assign a new color for *Museums*, and click *More icons* to find a
    more appropriate point marker symbol, as shown in Figure
    <a href="#fig:mymaps-colors-icons">7.25</a>.

<img src="images/07-map/mymaps-colors-icons.png" alt="Select point marker colors and icons." width="295" />
<p class="caption">
...
1.  In the *Choose an icon* screen, use the upper-right *Filter* to
    ...
    <a href="#fig:mymaps-choose-icon">7.26</a>. Repeat this process for
    *Parks*.

<img src="images/07-map/mymaps-choose-icon.png" alt="Search by filter in the *Choose an icon* screen." width="750" />
<p class="caption">
...
1.  In the *Choose an icon* screen, you can click the lower-left *Custom
    ...
    <a href="#fig:mymaps-custom-icon">7.27</a>. This custom icon was
...
<img src="images/07-map/mymaps-custom-icon.png" alt="Upload a photo to create a custom thumbnail icon image." width="180" />
<p class="caption">
...
1.  Click on any map marker to edit its data, insert a photo to appear
    ...
    Figure <a href="#fig:mymaps-edit-point">7.28</a>. This photo came
...
<img src="images/07-map/mymaps-edit-point.png" alt="Click any map marker to edit its data, add a photo, or directions." width="345" />
<p class="caption">
Figure 7.28: Click any map marker to edit its data, add a photo, or
directions.
</p>
...
1.  You can change the style of the basemap to one of nine different
    ...
    <a href="#fig:mymaps-style-basemap">7.29</a>. Choose high-contrast
    colors for marker icons and basemap backgrounds.

<img src="images/07-map/mymaps-style-basemap.png" alt="Change the style of the Google basemap." width="300" />
<p class="caption">
...
1.  At the top of the map, see buttons to manually add more point
    ...
    in Figure <a href="#fig:mymaps-draw-line">7.30</a>. However, Google
...
<img src="images/07-map/mymaps-draw-line.png" alt="Manually add more point markers, lines, and directions, or measure distance." width="235" />
<p class="caption">
Figure 7.30: Manually add more point markers, lines, and directions, or
measure distance.
</p>
...
1.  Click *Preview* to see how you map will appear to other people. When
    ...
    *Enable link sharing* is activated, as shown in Figure
    <a href="#fig:mymaps-share">7.31</a>, and copy the generated link.
...
<img src="images/07-map/mymaps-share.png" alt="Before sharing your map, make sure anyone with the link can view it." width="400" />
<p class="caption">
Figure 7.31: Before sharing your map, make sure anyone with the link can
view it.
</p>
...
1.  If you wish to embed your map as an iframe on a web page, click the
    ...
    <a href="#fig:mymaps-embed">7.32</a>. This will generate an HTML
    embed code, which we will explain in [Chapter 9: Embed on the
    Web](embed.html).

<img src="images/07-map/mymaps-embed.png" alt="Select *Embed on my site* to copy the HTML iframe code." width="315" />
<p class="caption">
...
1.  If you wish to edit your map in the future, here are two ways to
    ...
    <a href="#fig:mymaps-gdrive">7.33</a>, to help you make edits more
    easily in the future.

<img src="images/07-map/mymaps-gdrive.png" alt="Keep your Google My Maps and Sheets files together in a Google Drive folder." width="500" />
<p class="caption">
Figure 7.33: Keep your Google My Maps and Sheets files together in a
Google Drive folder.
</p>
...
in Chapter 6: Chart Your Data](chart-datawrapper.html). It’s also offers
...
<a href="#fig:datawrapper-symbolmap">7.34</a>, sample symbol map
...
Chapter 9](embed.html).

<img src="images/07-map/datawrapper-symbolmap.png" alt="Symbol point map of US city population growth with Datawrapper. Explore the [interactive version](https://datawrapper.dwcdn.net/V0V9Y)."  />
<p class="caption">
Figure 7.34: Symbol point map of US city population growth with
...
4](clean.html). In our spreadsheet we narrowed the original list down to
...
<img src="images/07-map/datawrapper-symbolmap-start.png" alt="Start to create a symbol map in Datawrapper." width="600" />
<p class="caption">
Figure 7.35: Start to create a symbol map in Datawrapper.
</p>
...
3.  In the *Match your columns* screen, select the *City-State* column
    ...
    <a href="#fig:datawrapper-symbolmap-match">7.36</a>. In the next
    screen click *Go*, then see your geocoded data displayed on a map in
    the following screen.

<img src="images/07-map/datawrapper-symbolmap-match.png" alt="Select the *City-State* column to be matched as the *Address*." width="400" />
<p class="caption">
Figure 7.36: Select the *City-State* column to be matched as the
*Address*.
</p>
...
1.  Click the *Visualize* button to *Refine* your map. Our goal is to
    ...
    <a href="#fig:datawrapper-symbolmap-refine">7.37</a>.

<img src="images/07-map/datawrapper-symbolmap-refine.png" alt="Refine your map by selecting data to display symbol shapes, sizes, and colors."  />
<p class="caption">
Figure 7.37: Refine your map by selecting data to display symbol shapes,
sizes, and colors.
</p>
...
1.  Optionally, to customize the color palette and intervals to match
    ...
    <a href="#fig:datawrapper-symbolmap-colors">7.38</a>.

<img src="images/07-map/datawrapper-symbolmap-colors.png" alt="Create a new color palette by importing five hexadecimal color codes from ColorBrewer." width="600" />
<p class="caption">
Figure 7.38: Create a new color palette by importing five hexadecimal
...
1.  To continue customizing intervals to match our example, set the
    ...
    *Labels* to *custom*, and click each label to edit the text that
    ...
    <a href="#fig:datawrapper-symbolmap-intervals">7.39</a>. Learn more
...
<img src="images/07-map/datawrapper-symbolmap-intervals.png" alt="Customize the interval ranges and edit the legend." width="500" />
<p class="caption">
Figure 7.39: Customize the interval ranges and edit the legend.
</p>
...
2.  Click *Proceed* or advance to the *Publish & Embed* screen to share
    ...
    menu in the top-right corner of the screen. Also, you can click the
    blue *Publish* button to generate the code to embed your interactive
    map on your website, as you’ll learn about in [Chapter 9: Embed on
    the Web](embed.html). In addition, you can *add your chart to River*
    if you wish to share your work more widely by allowing other
...
<a href="#fig:datawrapper-map-final">7.40</a>. The index reflects
...
<img src="images/07-map/datawrapper-map-final.png" alt="Choropleth map of 2020 home values in US states with Datawrapper. Explore the [interactive version](https://datawrapper.dwcdn.net/kSYrw/)."  />
<p class="caption">
Figure 7.40: Choropleth map of 2020 home values in US states with
Datawrapper. Explore the [interactive
...
Good maps often require [cleaning up messy data as described in Chapter
4](clean.html). In our spreadsheet we removed all of the columns except
...
<img src="images/07-map/datawrapper-map-choose-annotated.png" alt="In Datawrapper, click *New Map*, and choose *Choropleth*." width="500" />
<p class="caption">
...
1.  In the *Select your map* screen, choose your geographic boundaries.
    ...
    shown in Figure
    <a href="#fig:datawrapper-map-us-states-territories">7.42</a>, then
    click *Proceed*.

<img src="images/07-map/datawrapper-map-us-states-territories.png" alt="Choose *USA - States and Territories* for your map outline." width="500" />
<p class="caption">
...
1.  In the *Add your data* screen, you can manually enter data for each
    ...
    *Import your dataset* button, as shown in Figure
    <a href="#fig:datawrapper-import-dataset">7.43</a>.

<img src="images/07-map/datawrapper-import-dataset.png" alt="Scroll down below the *add data* table to import your dataset." width="200" />
<p class="caption">
Figure 7.43: Scroll down below the *add data* table to import your
dataset.
</p>
...
-   FIPS-Codes, the Federal Information Processing Standards numeric
    codes for US states and smaller geographies, where California is
    `06`.
...
<a href="#fig:datawrapper-import-codes">7.44</a>. If necessary, you
...
<img src="images/07-map/datawrapper-import-codes.png" alt="To view all codes for your selected map, go back one screen to the *Geo-Code* drop-down menu." width="250" />
<p class="caption">
Figure 7.44: To view all codes for your selected map, go back one screen
...
3.  In the *Match your columns* screen, click the column that matches up
    ...
    <a href="#fig:datawrapper-map-match">7.45</a>. You may need to
    scroll down a bit to click the *Next* button, then *Continue*.

<img src="images/07-map/datawrapper-map-match.png" alt="Select the data column that contains matching ANSI codes." width="500" />
<p class="caption">
...
1.  Proceed to the next screen, select the column of data values that
    ...
    in Figure <a href="#fig:datawrapper-map-match-values">7.46</a>. For
...
<img src="images/07-map/datawrapper-map-match-values.png" alt="Select the data column that contains the values that you wish to map." width="500" />
<p class="caption">
Figure 7.46: Select the data column that contains the values that you
wish to map.
</p>
...
1.  In the *Visualize* screen, under the *Refine* tab, click the *wrench
    ...
    <a href="#fig:datawrapper-map-default">7.47</a>. Do not blindly
    accept the default map, but it’s a good place to start and explore
    how factors shape its appearance.

<img src="images/07-map/datawrapper-map-default.png" alt="Under the *Refine* tab, click the *wrench symbol* to see the default map settings." width="600" />
<p class="caption">
Figure 7.47: Under the *Refine* tab, click the *wrench symbol* to see
...
1.  In the *Refine* tab, experiment with different types of
    ...
    <a href="#fig:datawrapper-map-quartiles">7.48</a>. This map works
...
<img src="images/07-map/datawrapper-map-quartiles.png" alt="Under the *Refine* tab, change the interpolation from *linear* to *quartiles* and see how the map changes." width="400" />
<p class="caption">
Figure 7.48: Under the *Refine* tab, change the interpolation from
...
1.  Experiment with other colors, intervals, and data columns. Change
    ...
    values in Figure
    <a href="#fig:datawrapper-map-percentchange">7.49</a>.

<img src="images/07-map/datawrapper-map-percentchange.png" alt="Experiment with other colors, intervals, and data columns to find true and meaningful stories." width="650" />
<p class="caption">
Figure 7.49: Experiment with other colors, intervals, and data columns
...
1.  Under the *Refine* tab, customize the legend format. For example, to
    ...
    as shown in Figure
    <a href="#fig:datawrapper-map-legend-custom">7.50</a>. Learn more
    about Datawrapper custom formats in their link to the [numeral.js
    documentation](http://numeraljs.com/#format).

<img src="images/07-map/datawrapper-map-legend-custom.png" alt="Change how numbers appear in the legend by entering a custom format." width="350" />
<p class="caption">
Figure 7.50: Change how numbers appear in the legend by entering a
custom format.
</p>
...
1.  Under the *Annotate* tab, add a title, description, and source
    ...
    <a href="#fig:datawrapper-map-tooltip">7.51</a>. Learn more about
...
<img src="images/07-map/datawrapper-map-tooltip.png" alt="To edit tooltips, click the blue column names or use drop-down menus to format the codes." width="600" />
<p class="caption">
Figure 7.51: To edit tooltips, click the blue column names or use
...
1.  Finally, click *Proceed* or advance to the *Publish & Embed* screen
    ...
    interactive map, and learn more about your next steps in [Chapter 9:
...
and [filtered line charts](filtered-line-tableau.html) in Chapter 6. Now
...
section of Chapter 2](geocode.html). Furthermore, if you want to upload
...
shown in Figure <a href="#fig:tableau-polygon-final">7.52</a>. Remember
...
<img src="images/07-map/tableau-polygon-final.png" alt="Choropleth map of healthcare spending with Tableau Public. Explore the [interactive version](https://public.tableau.com/profile/ilya7257#!/vizhome/2017HealthcareSpendingbyCountryasofGDP/Dashboard1). Data from the World Bank."  />
<p class="caption">
Figure 7.52: Choropleth map of healthcare spending with Tableau Public.
Explore the [interactive
...
<a href="#fig:tableau-polygon-final">7.52</a> in detail.
...
Good maps often require [cleaning up messy data as described in Chapter
4](clean.html). In our spreadsheet we removed rows for nations that did
...
1.  In the *Data Source* screen, inspect the dataset, which contains
    ...
    shown in Figure <a href="#fig:tableau-data-geographic">7.53</a>.

<img src="images/07-map/tableau-data-geographic.png" alt="Make sure Tableau Public knows that the Country Name column contains geographic data." width="400" />
<p class="caption">
Figure 7.53: Make sure Tableau Public knows that the Country Name column
...
1.  In the bottom-left corner, click the orange *Sheet 1* button to
    ...
    <a href="#fig:tableau-go-to-worksheet">7.54</a>.

<img src="images/07-map/tableau-go-to-worksheet.png" alt="Click the orange button to go sheet 1 where you can create your map." width="400" />
<p class="caption">
Figure 7.54: Click the orange button to go sheet 1 where you can create
your map.
</p>

1.  In *Sheet 1*, create your choropleth map using a two-step process,
    as shown in Figure <a href="#fig:tableau-drag">7.55</a>. First,
...
<img src="images/07-map/tableau-drag-annotated.png" alt="Drag and drop *Country Name* to the center of the sheet, then *Health Spending As % of GDP* to the *Color* box in the *Marks* card."  />
<p class="caption">
Figure 7.55: Drag and drop *Country Name* to the center of the sheet,
...
2.  You can change the color palette by clicking the Color box of the
    ...
    <a href="#fig:tableau-polygon-color">7.56</a>.

<img src="images/07-map/tableau-polygon-color.png" alt="Change the color scheme to Green with 5 steps." width="400" />
<p class="caption">
...
1.  When you hover over countries, you will notice a tooltip that tells
    ...
    <a href="#fig:tableau-polygon-tooltip">7.57</a>.

<img src="images/07-map/tableau-polygon-tooltip.png" alt="Change tooltip text to make it more user-friendly." width="400" />
<p class="caption">
...
2.  At this point the data is loaded and should be displayed correctly,
    ...
    Figure <a href="#fig:tableau-dashboard-create">7.58</a>. Dashboards
...
<img src="images/07-map/tableau-dashboard-create-annotated.png" alt="Before you publish the map, create a new dashboard to finalize your layout." width="400" />
<p class="caption">
Figure 7.58: Before you publish the map, create a new dashboard to
...
1.  In your Dashboard 1 tab, change the size of the dashboard to
    ...
    <a href="#fig:tableau-dashboard">7.59</a>. This will copy the map,
    the title, and the legend from Sheet 1.

<img src="images/07-map/tableau-dashboard-annotated.png" alt="To create a responsive dashboard, change the Size to Automatic." width="400" />
<p class="caption">
Figure 7.59: To create a responsive dashboard, change the Size to
Automatic.
</p>

1.  Right-click the upper part of the map legend, and select *Floating*,
    as shown in Figure <a href="#fig:tableau-dashboard-legend">7.60</a>.
...
<img src="images/07-map/tableau-dashboard-legend.png" alt="To place the legend on top of the map, make sure it is floating." width="400" />
<p class="caption">
Figure 7.60: To place the legend on top of the map, make sure it is
floating.
</p>
...
as an iframe in Chapter 9](embed-code.html).
...
in chapter 3](opendata.html). The advantage of creating visualizations
...
<a href="#fig:socrata-final">7.61</a>. Our interactive map pulls data
...
<img src="images/07-map/socrata-final.png" alt="Map of fatal crashes in NYC during the past year, continuously updated from a Socrata open data repository. See [interactive version](https://data.cityofnewyork.us/dataset/Fatal-NYC-Crashes/nx4u-jy9t/embed?width=100%25&height=500)."  />
<p class="caption">
Figure 7.61: Map of fatal crashes in NYC during the past year,
...
2.  Navigate to the [Motor Vehicle Collisions -
    ...
    <a href="#fig:socrata-launch-new-viz">7.62</a>. This will open a
    *Configure Visualization* studio where you can create the map.

<img src="images/07-map/socrata-launch-new-viz-annotated.png" alt="Go to Visualize >
Launch New Visualization." width=“300” /&gt;
<p class="caption">
Figure 7.62: Go to Visualize &gt; Launch New Visualization.
</p>
...
1.  In the top menu, select *Map* (the globe icon between a scatter
    ...
    <a href="#fig:socrata-configure">7.63</a>.

<img src="images/07-map/socrata-configure-annotated.png" alt="Your studio should look similar to this once you choose Map as the visualization type." width="500" />
<p class="caption">
Figure 7.63: Your studio should look similar to this once you choose Map
...
1.  We need to limit our map to display only crashes with fatalities. In
    ...
    in Figure <a href="#fig:socrata-filter">7.64</a>. Alternatively you
...
<img src="images/07-map/socrata-filter-annotated.png" alt="Add filters for number of persons killed (>0),
location (latitude &gt; 0), and date (last 365 days)." width=“300” /&gt;
<p class="caption">
Figure 7.64: Add filters for number of persons killed (&gt;0), location
...
1.  Let’s ensure that crash locations appear as individual points and
    ...
    in Figure <a href="#fig:socrata-uncluster">7.65</a>. You should now
    see individual crash locations at all zoom levels.

<img src="images/07-map/socrata-uncluster-annotated.png" alt="To always show individual points instead of clusters, set *Stop Clustering at Zoom Level* to 1." width="300" />
<p class="caption">
Figure 7.65: To always show individual points instead of clusters, set
...
2.  Finally, let’s create meaningful tooltips for points. Return back to
    ...
    *Flyout Title* to *ON STREET NAME*, adding *CRASH DATE*, *CRASH
    ...
    <a href="#fig:socrata-flyout">7.66</a>.

<img src="images/07-map/socrata-flyout.png" alt="To edit tooltip information, use the *Flyout Details* menu item." width="250" />
<p class="caption">
Figure 7.66: To edit tooltip information, use the *Flyout Details* menu
item.
</p>
...
<a href="#fig:socrata-share">7.67</a>), and copy the generated code from
*Embed Code* text area (Figure
<a href="#fig:socrata-share-embed">7.68</a>). We will talk about
embedding visualizations in detail in [Chapter 9: Embed on the
Web](embed.html).

<img src="images/07-map/socrata-share-annotated.png" alt="Click *Share* button to bring up *Share and Embed* window." width="400" />
<p class="caption">
Figure 7.67: Click *Share* button to bring up *Share and Embed* window.
</p>

<img src="images/07-map/socrata-share-embed.png" alt="Copy iframe code to embed this map in another website." width="400" />
<p class="caption">
Figure 7.68: Copy iframe code to embed this map in another website.
</p>
...
tutorial in Chapter 12](leaflet-maps-open-data-apis.html).
...
[Leaflet map code templates in Chapter 12](leaflet.html), and how to
[find and transform geospatial data in Chapter 13](transform.html)
...
[Chapter 6: Chart Your Data](chart.html) and [Chapter 7: Map Your
...
columns of your data table. Later in [Chapter 9: Embed on the
...
learned about [chart design in Chapter 6](chart-design.html) and [map
design in Chapter 7](map-design.html). Jonathan Schwabish, an economist
...
appear in Figure <a href="#fig:table-design">8.1</a>.
...
<img src="images/08-table/table-design.png" alt="A sample table that illustrates selected design principles." width="600" />
<p class="caption">
...
Table <a href="#tab:vaccine-bad">8.1</a> calculates the percentages of
...
<table>
<caption>Table 8.1: <strong>Bad</strong> Because It Calculates Percentages Horizontally</caption>
<thead>
<tr class="header">
<th></th>
...
But Table <a href="#tab:vaccine-better">8.2</a> calculates percentages
...
<table>
<caption>Table 8.2: <strong>Better</strong> Because It Calculates Percentages Vertically</caption>
<thead>
<tr class="header">
<th></th>
<th style="text-align: right;">Vaccine</th>
...
Figure <a href="#fig:datawrapper-table">8.2</a>. Readers can search by
...
<img src="images/08-table/datawrapper-table.png" alt="Table with sparklines. Explore the [interactive version](https://datawrapper.dwcdn.net/0HK4f/)."  />
<p class="caption">
Figure 8.2: Table with sparklines. Explore the [interactive
...
as shown in Chapter 6](filtered-line-tableau.html), it would be
...
[choropleth map as shown in Chapter 7](choropleth-datawrapper.html),
...
open data repositories we listed in [Chapter 3: Find and Question Your
...
the [VLookup spreadsheet method from Chapter 2](vlookup.html), we merged
...
1.  In the *Visualize* screen, under *Customize columns*, select the
    ...
    *Replace country codes with flags*, as shown in Figure
    <a href="#fig:datawrapper-flag">8.3</a>.

<img src="images/08-table/datawrapper-flag.png" alt="Customize the *Nation* column and push slider to replace codes with flags."  />
<p class="caption">
Figure 8.3: Customize the *Nation* column and push slider to replace
codes with flags.
</p>
...
2.  Now let’s color-code the *Continent* column to make it easier for
    ...
    *Continent*, and click on the *Background: customize colors* button.
    ...
    Figure <a href="#fig:datawrapper-colors">8.4</a>.

<img src="images/08-table/datawrapper-colors.png" alt="Customize the *Continent* column and push slider to color cells based on categories." width="600" />
<p class="caption">
Figure 8.4: Customize the *Continent* column and push slider to color
cells based on categories.
</p>

Tip: To choose colors for the six continents, we used the [ColorBrewer
design tool as described in Chapter 7](design-choropleth.html), and
...
1.  Now let’s prepare our data to add sparklines, or tiny line charts,
    ...
    <a href="#fig:datawrapper-edit-column">8.5</a>. Then click *Proceed*
    to return to the *Visualize* window.

<img src="images/08-table/datawrapper-edit-column.png" alt="Go back to *Check & Describe* to change the properties of column E from textual to numerical data."  />
<p class="caption">
Figure 8.5: Go back to *Check & Describe* to change the properties of
...
<img src="images/08-table/datawrapper-tiny-chart.png" alt="Shift-click to select all columns from *Life expectancy 1960--2018* down to *2018*, then click on *Show selected columns as tiny chart*." width="300" />
<p class="caption">
Figure 8.6: Shift-click to select all columns from *Life expectancy
...
1.  Let’s add one more visual element: a bar chart to visually represent
    ...
    <a href="#fig:datawrapper-bar-chart">8.7</a>. Also, select a
    different bar color, such as black, to distinguish it from the
    continent colors.

<img src="images/08-table/datawrapper-bar-chart.png" alt="Select the *Difference* column and *Show as bar chart*."  />
<p class="caption">
...
2.  Click on *Publish & Embed* to share the link to your [interactive
    ...
    in Figure <a href="#fig:datawrapper-table">8.2</a>. If you logged
    ...
    learn about in [Chapter 9: Embed on the Web](embed.html). In
...
[spreadsheet pivot table feature you learned in Chapter 2](pivot.html)
...
9](embed.html), so that whenever you update your Google Sheet, the
current data will automatically appear on the web page.

In Tableau Public, a tool we previously introduced in [Chapter
6](chart-tableau.html) and [Chapter 7](map-tableau.html), you can also
...
<!--chapter:end:08-table.Rmd-->

# 9 Embed On the Web

So far you’ve learned how to create [charts in chapter 6](chart.html),
[maps in chapter 7](map.html), and [tables in chapter 8](table.html).
...
Figure <a href="#fig:iframe-illustration">9.1</a>. When done correctly,
...
<img src="images/09-embed/iframe-illustration.png" alt="You can use an iframe to embed other web pages in your web page" width="600" />
<p class="caption">
Figure 9.1: You can use an iframe to embed other web pages in your web
page
</p>
...
<a href="#fig:iframe-sample">9.2</a>.

`<iframe src='https://datawrapper.dwcdn.net/LtRbj/'></iframe>`

<img src="images/09-embed/iframe-sample.png" alt="Depending on the format of your book, if a static chart appears above, you can also [view the interactive version](https://datawrapper.dwcdn.net/LtRbj/)."  />
<p class="caption">
Figure 9.2: Depending on the format of your book, if a static chart
appears above, you can also [view the interactive
...
page](https://www.w3schools.com/tags/tryit.asp?filename=tryhtml_iframe),
as shown in Figure <a href="#fig:w3schools-tryit-iframe">9.3</a>. It’s a
great way to see what happens if you need to trim parts of the embed
...
<img src="images/09-embed/w3schools-tryit-iframe.png" alt="For each embed code below, paste it in place of the selected text of the W3Schools TryIt iframe page to test how it works." width="750" />
<p class="caption">
Figure 9.3: For each embed code below, paste it in place of the selected
text of the W3Schools TryIt iframe page to test how it works.
</p>

### from Google Sheets

1.  After you create a [Google Sheets chart as you did in Chapter
    6](chart-google.html), click the three-dot kebab menu in the
    upper-right corner of the chart to publish it, as shown in Figure
    <a href="#fig:google-sheets-publish">9.4</a>.

<img src="images/09-embed/google-sheets-publish.png" alt="In your chart, click the three-dot kebab menu to publish it." width="150" />
<p class="caption">
Figure 9.4: In your chart, click the three-dot kebab menu to publish it.
</p>
...
1.  In the next screen, select the *Embed* tab and *Interactive* chart,
    ...
    <a href="#fig:google-sheets-embed-code">9.5</a>.

<img src="images/09-embed/google-sheets-embed-code.png" alt="Click *Embed* and *Interactive* and *Publish*, then select and copy the embed code." width="500" />
<p class="caption">
Figure 9.5: Click *Embed* and *Interactive* and *Publish*, then select
...
1.  To better understand how the embed code works, open the [W3Schools
    ...
    to Figure <a href="#fig:google-sheets-tryit">9.6</a>, but instead
    will display your embed code and interactive visualization.

<img src="images/09-embed/google-sheets-tryit.png" alt="Paste your Google Sheets embed code to place of the current iframe tag in the TryIt page and click *Run*." width="750" />
<p class="caption">
Figure 9.6: Paste your Google Sheets embed code to place of the current
...
1.  After you create a [Datawrapper chart as you did in Chapter
    ...
    7](map.html) or [interactive table as you did Chapter
    8](table.html), proceed to the final screen and click the *Publish*
    button, as shown in Figure
    <a href="#fig:datawrapper-publish">9.7</a>. This publishes the
...
<img src="images/09-embed/datawrapper-publish.png" alt="Proceed to the final screen and click the *Publish* button." width="300" />
<p class="caption">
Figure 9.7: Proceed to the final screen and click the *Publish* button.
</p>

1.  On the next screen, click *copy* to get the Datawrapper embed code,
    as shown in Figure <a href="#fig:datawrapper-embed-code">9.8</a>.
...
<img src="images/09-embed/datawrapper-embed-code.png" alt="Copy the responsive iframe version of the Datawrapper embed code." width="300" />
<p class="caption">
Figure 9.8: Copy the responsive iframe version of the Datawrapper embed
code.
</p>
...
1.  To better understand how the embed code works, open the [W3Schools
    ...
    Select the current iframe tag, paste in your embed code to replace
    it, and press the green *Run* button. The result should be similar
    to Figure <a href="#fig:datawrapper-tryit">9.9</a>, but instead will
    display your unique embed code and interactive visualization.

<img src="images/09-embed/datawrapper-tryit.png" alt="Paste your Datawrapper embed code in place of the current iframe tag in the TryIt page and click *Run*." width="750" />
<p class="caption">
Figure 9.9: Paste your Datawrapper embed code in place of the current
iframe tag in the TryIt page and click *Run*.
</p>
...
<a href="#fig:datawrapper-tryit-simple">9.10</a>. Sometimes a simple
iframe works better on your website than a complex embed code.

<img src="images/09-embed/datawrapper-tryit-simple.png" alt="If a complex embed code does not work in your website, go back and try to edit it down into a simple iframe." width="750" />
<p class="caption">
Figure 9.10: If a complex embed code does not work in your website, go
...
1.  After you create a [Tableau Public chart in Chapter
    6](chart-tableau.html) or [map in Chapter 7](map-tableau.html),
    publish your worksheet, dashboard, or story online by selecting
    *File &gt; Save to Tableau Public* in the desktop application menu,
    as shown in Figure <a href="#fig:tableau-public-publish">9.11</a>.

<img src="images/09-embed/tableau-public-publish.png" alt="In the Tableau Public desktop application, select *File--Save to Tableau Public* to publish to the online server." width="428" />
<p class="caption">
Figure 9.11: In the Tableau Public desktop application, select
...
1.  In your online Tableau Public account profile page, click to *View*
    ...
    Figure <a href="#fig:tableau-public-view">9.12</a>.

<img src="images/09-embed/tableau-public-view.png" alt="In your Tableau Public online profile page, click to *View* the details of a published visualization." width="289" />
<p class="caption">
Figure 9.12: In your Tableau Public online profile page, click to *View*
the details of a published visualization.
</p>
...
1.  When viewing details for a published visualization in your Tableau
    ...
    in Figure <a href="#fig:tableau-public-embed-code">9.13</a>.

<img src="images/09-embed/tableau-public-embed-code-annotated.png" alt="Scroll down in the online published visualization details, click the *Share* button, and copy the embed code." width="469" />
<p class="caption">
Figure 9.13: Scroll down in the online published visualization details,
...
1.  To better understand how the embed code works, open the [W3Schools
    ...
    Select the current iframe tag, paste in your embed code to replace
    it, and press the green *Run* button. The result should be similar
    to Figure <a href="#fig:tableau-public-tryit">9.14</a>, but instead
...
<img src="images/09-embed/tableau-public-tryit.png" alt="Paste your Tableau public embed code in place of the current iframe tag in the TryIt page and click *Run*." width="750" />
<p class="caption">
Figure 9.14: Paste your Tableau public embed code in place of the
...
1.  In your published visualization on your Tableau Public online
    ...
    <a href="#fig:tableau-public-embed-code">9.13</a>. But this time,
...
Tip: Insert `width="90%"`, rather than 100%, to help readers to scroll
more easily down your web page with a margin.

1.  Press *Run* to see how it looks in the W3Schools TryIt iframe page,
    as shown in Figure
    <a href="#fig:tableau-public-tryit-simple">9.15</a>. Sometimes a
    simple iframe works better on your website than a complex embed
    code.

<img src="images/09-embed/tableau-public-tryit-simple.png" alt="If a complex embed code does not work in your website, go back and copy the link to the visualization, and try to convert it into a simple iframe." width="750" />
<p class="caption">
Figure 9.15: If a complex embed code does not work in your website, go
...
1.  In your block editor, select a *custom HTML* block, and directly
    ...
    <a href="#fig:wordpress-custom-html">9.16</a>.

<img src="images/09-embed/wordpress-custom-html.png" alt="Paste an embed code or iframe into a custom HTML block." width="700" />
<p class="caption">
...
1.  First, the site administrator must install and activate the [iframe
    ...
    <a href="#fig:wordpress-iframe-plugin">9.17</a>. This plugin allows
    authors to embed iframe codes in a modified “shortcode” format
    surrounded by square brackets in this general format: `[iframe...]`.

<img src="images/09-embed/wordpress-iframe-plugin.png" alt="Install and activate the *iframe* plugin on a self-hosted WordPress site." width="287" />
<p class="caption">
Figure 9.17: Install and activate the *iframe* plugin on a self-hosted
WordPress site.
</p>
...
2.  Initially, the code you pasted probably included HTML iframe tags at
    ...
    shown in Figure <a href="#fig:wordpress-insert-brackets">9.18</a>.
    Closely compare the two figures to see what these small code edits
    look like.

<img src="images/09-embed/wordpress-insert-brackets.png" alt="Modify the front and back end with square brackets." width="700" />
<p class="caption">
...
9](embed.html). Later you’ll learn how to [create a new GitHub repo and
...
drag-and-drop tools that we previously covered in [Chapter 7: Map Your
...
<a href="#fig:leaflet-simple">10.1</a>.

<img src="images/10-github/leaflet-simple.png" alt="Create your own version of this [simple interactive Leaflet map](https://handsondataviz.github.io/leaflet-map-simple/)."  />
<p class="caption">
Figure 10.1: Create your own version of this [simple interactive Leaflet
...
2.  Click the green *Use this template* button to make your own copy of
    ...
    <a href="#fig:leaflet-simple-template">10.2</a>.

<img src="images/10-github/leaflet-simple-template.png" alt="Click *Use this template* to make your own copy."  />
<p class="caption">
...
1.  On the next screen, your account will appear as the owner. Name your
    ...
    Figure <a href="#fig:leaflet-simple-name">10.3</a>. Click the green
    *Create repository from template* button.

<img src="images/10-github/leaflet-simple-name.png" alt="Name your copied repo `leaflet-map-simple`." width="600" />
<p class="caption">
...
-   `index.html` is the key file in this particular template, because it
    contains the map code.

1.  Click on the `index.html` file to view the code, as shown in Figure
    <a href="#fig:leaflet-simple-index">10.4</a>.

<img src="images/10-github/leaflet-simple-index.png" alt="Click the index.html file to view the code." width="600" />
<p class="caption">
...
1.  To edit the code, click on the the pencil symbol in the upper-right
    ...
    <a href="#fig:leaflet-simple-edit">10.5</a>.

<img src="images/10-github/leaflet-simple-edit.png" alt="Click the pencil button to edit the code."  />
<p class="caption">
...
2.  To save your edit, scroll to the bottom of the page and click the
    ...
    <a href="#fig:leaflet-simple-commit">10.6</a>.

<img src="images/10-github/leaflet-simple-commit.png" alt="Click the green *Commit Changes* button to save your edits." width="450" />
<p class="caption">
...
1.  To access GitHub Pages, scroll to the top of your repo page and
    ...
    <a href="#fig:leaflet-simple-settings">10.7</a>.

<img src="images/10-github/leaflet-simple-settings.png" alt="Click the *Settings* button to access GitHub Pages and publish your work on the web."  />
<p class="caption">
Figure 10.7: Click the *Settings* button to access GitHub Pages and
...
1.  In the Settings screen, scroll way down to the GitHub Pages area. In
    ...
    Figure <a href="#fig:leaflet-github-pages-main">10.8</a>. This step
...
<img src="images/10-github/leaflet-github-pages-main.png" alt="In *Settings*, go to *GitHub Pages*, and switch the source from *None* to *Main*." width="300" />
<p class="caption">
Figure 10.8: In *Settings*, go to *GitHub Pages*, and switch the source
from *None* to *Main*.
</p>
...
1.  Scroll back down to *Settings &gt; GitHub Pages* to see the web
    ...
    <a href="#fig:leaflet-github-pages-link">10.9</a>.

<img src="images/10-github/leaflet-github-pages-link.png" alt="In *Settings* for *GitHub Pages*, right-click your published map link to open in a new tab." width="600" />
<p class="caption">
Figure 10.9: In *Settings* for *GitHub Pages*, right-click your
...
2.  Go back to your first browser tab with your GitHub repo, and click
    ...
    <a href="#fig:leaflet-click-title">10.10</a>.

<img src="images/10-github/leaflet-click-title.png" alt="On your first browser tab, click the repo title." width="450" />
<p class="caption">
...
1.  On your repo page, click to open the `README.md` file, and click the
    ...
    <a href="#fig:leaflet-paste-link">10.11</a>. Paste your live web
    link under the label *(replace with link to your site)* and scroll
    down to commit the change.

<img src="images/10-github/leaflet-paste-link.png" alt="Open and edit the `README` file to paste the link to your live map." width="600" />
<p class="caption">
Figure 10.11: Open and edit the `README` file to paste the link to your
live map.
</p>
...
in the [geocoding section in Chapter 2](geocode.html).
...
paste the code block to create a second marker.
    ...
    L.marker([41.77, -72.69]).addTo(map) // EDIT coordinates to re-position marker
...
Highcharts templates in Chapter 11](chartcode.html) and [Leaflet map
templates in Chapter 12](leaflet.html).

## Convert GitHub Pages Link to iframe

In [Chapter 9: Embed on the Web](embed.html), we discussed the benefits
...
Tip: Either single-quote (`'`) marks (also called an apostrophe) or
...
website](paste-code.html), using methods described in Chapter 9, to
...
Highcharts templates in Chapter 11](chartcode.html) and [Leaflet map
templates in Chapter 12](leaflet.html). Once again, we’ll demonstrate
...
1.  Click on the *Code &gt; Download Zip* drop-down menu button on any
    ...
    <a href="#fig:repo-code-download">10.12</a>. Your browser will
...
<img src="images/10-github/repo-code-download.png" alt="Click *Code* and select *Download Zip* to create a compressed folder of a repo on your computer." width="350" />
<p class="caption">
Figure 10.12: Click *Code* and select *Download Zip* to create a
...
2.  Go back to your GitHub account in your web browser, click on the
    ...
    <a href="#fig:repo-create-new">10.13</a>.

<img src="images/10-github/repo-create-new.png" alt="Click the plus (+) symbol in upper-right corner to create a new repo." width="300" />
<p class="caption">
Figure 10.13: Click the plus (+) symbol in upper-right corner to create
a new repo.
</p>
...
in Figure <a href="#fig:repo-create-options">10.14</a>.

<img src="images/10-github/repo-create-options.png" alt="Name your new repo *practice*, check the box to *Initialize this repo with a README*, and *Add a license* (select *MIT*) to match any code you plan to upload." width="400" />
<p class="caption">
Figure 10.14: Name your new repo *practice*, check the box to
...
1.  On your new repo home page, click the *Add File &gt; Upload Files*
    ...
    Figure <a href="#fig:repo-upload-files">10.15</a>.

<img src="images/10-github/repo-upload-files.png" alt="Click the *Upload Files* button." width="350" />
<p class="caption">
...
1.  Inside the repo folder that you previously downloaded and unzipped
    ...
    Figure <a href="#fig:repo-drag-index">10.16</a>. Do not upload
    `LICENSE` or `README.md` because your new repo already contains
    those two files. Scroll down to click the green *Commit Changes*
    button.

<img src="images/10-github/repo-drag-index-annotated.png" alt="Drag-and-drop the `index.html` file to the upload screen."  />
<p class="caption">
...
1.  Since this was only a `practice` repo, let’s delete it from GitHub.
    ...
    *Delete this repository*, as shown in Figure
    <a href="#fig:repo-delete">10.17</a>. GitHub will ask you to type in
    your username and repo name to ensure that you really want to delete
    the repo, to prove you are not a drunken brownie chef.

<img src="images/10-github/repo-delete.png" alt="After clicking the Delete Repository button, GitHub will ask you to type your username and repo name to confirm." width="600" />
<p class="caption">
Figure 10.17: After clicking the Delete Repository button, GitHub will
...
1.  Go to the GitHub web repo you wish to copy to your local computer.
    ...
    Figure <a href="#fig:desktop-open">10.18</a>. The next screen will
    show a link to the GitHub Desktop web page, and you should download
    and install the application.

<img src="images/10-github/desktop-open.png" alt="In your GitHub repo on the web, click *Code* to *Open with GitHub Desktop* to download and install GitHub Desktop." width="350" />
<p class="caption">
Figure 10.18: In your GitHub repo on the web, click *Code* to *Open with
...
1.  When you open GitHub Desktop for the first time, you’ll need to
    ...
    <a href="#fig:desktop-signin">10.19</a>, and login with your GitHub
...
<img src="images/10-github/desktop-signin.png" alt="Click the blue *Sign in to GitHub.com* button to link GitHub Desktop to your GitHub account." width="500" />
<p class="caption">
Figure 10.19: Click the blue *Sign in to GitHub.com* button to link
...
1.  In the next setup screen, GitHub Desktop asks you to configure Git,
    ...
    <a href="#fig:desktop-configure">10.20</a>.

<img src="images/10-github/desktop-configure.png" alt="Click the *Continue* button to authorize GitHub Desktop to send commits to your GitHub account." width="500" />
<p class="caption">
Figure 10.20: Click the *Continue* button to authorize GitHub Desktop to
...
1.  On the “Let’s Get Started” with GitHub Desktop screen, click on
    ...
    *Clone* it to your local computer, as shown in Figure
    <a href="#fig:desktop-start">10.21</a>.

<img src="images/10-github/desktop-start-annotated.png" alt="Select your *leaflet-map-simple* repo and click the *Clone* button to copy it to your local computer."  />
<p class="caption">
Figure 10.21: Select your *leaflet-map-simple* repo and click the
...
1.  When you clone a repo, GitHub Desktop asks you to select the Local
    ...
    <a href="#fig:desktop-clone-path">10.22</a>. Before you click the
    *Clone* button, remember the path to this location, since you’ll
    need to find it later.

<img src="images/10-github/desktop-clone-path.png" alt="Select the Local Path where your repo will be stored on your computer, then click *Clone*." width="500" />
<p class="caption">
Figure 10.22: Select the Local Path where your repo will be stored on
...
1.  On the next screen, GitHub Desktop may ask, “How are you planning to
    ...
    <a href="#fig:desktop-fork">10.23</a>.

<img src="images/10-github/desktop-fork.png" alt="If asked how you plan to use this fork, select the default *To contribute to the parent project* and click *Continue*." width="500" />
<p class="caption">
Figure 10.23: If asked how you plan to use this fork, select the default
...
1.  Now you have copies of your GitHub repo in two places—in your GitHub
    ...
    <a href="#fig:desktop-finder">10.24</a>. Your screen may look
    different, depending on whether you use Windows or Mac, and the
    Local Path you selected to store your files.

<img src="images/10-github/desktop-finder.png" alt="Now you have two copies of your repo: in your GitHub online account (on the left) and on your local computer (on the right, as shown in the Mac Finder). Windows screens will look different." width="500" />
<p class="caption">
Figure 10.24: Now you have two copies of your repo: in your GitHub
...
1.  Before we can edit the code in your local computer, [download and
    ...
    in Figure <a href="#fig:desktop-atom">10.25</a>.

<img src="images/10-github/desktop-atom-annotated.png" alt="In GitHub Desktop, confirm the Current Repo and click the *Open in Atom* button to edit the code."  />
<p class="caption">
Figure 10.25: In GitHub Desktop, confirm the Current Repo and click the
...
1.  Since Atom Editor is integrated with GitHub Desktop, it opens up
    ...
    Figure <a href="#fig:atom-project">10.26</a>. Open your `index.html`
    file and edit the title of your map, around line 22, then save your
    work.

<img src="images/10-github/atom-project-annotated.png" alt="Atom Editor opens your repo as a *project*, where you can click files to view code. Edit your map title."  />
<p class="caption">
Figure 10.26: Atom Editor opens your repo as a *project*, where you can
...
1.  After saving your code edit, it’s a good habit to clean up your Atom
    ...
    *Remove Project Folder* in the menu, as shown in Figure
    <a href="#fig:atom-remove-project">10.27</a>. Next time you open up
...
<img src="images/10-github/atom-remove-project-annotated.png" alt="To clean up your Atom Editor workspace, right-click to *Remove Project Folder*."  />
<p class="caption">
Figure 10.27: To clean up your Atom Editor workspace, right-click to
...
1.  Now that you’ve edited the code for your map on your local computer,
    ...
    <a href="#fig:finder-open-with">10.28</a>.

<img src="images/10-github/finder-open-with.png" alt="Right-click the index.html file on your local computer and open with a browser to check your edits."  />
<p class="caption">
Figure 10.28: Right-click the index.html file on your local computer and
...
11](chartcode.html) or [Leaflet templates in Chapter 12](leaflet.html),
...
shown in Figure <a href="#fig:disable-cors-safari">10.29</a>. After you
...
shown in Figure <a href="#fig:disable-cors-chrome">10.30</a>, or this
...
<img src="images/10-github/disable-cors-safari.png" alt="To view more complex code templates on your local computer with Safari browser, temporarily *Disable Cross-Origin Restrictions*." width="500" />
<p class="caption">
Figure 10.29: To view more complex code templates on your local computer
with Safari browser, temporarily *Disable Cross-Origin Restrictions*.
</p>

<img src="images/10-github/disable-cors-chrome-annotated.png" alt="To view more complex code templates on your local computer with Chrome browser, use the *Terminal* application command-line (bottom window) to run a version without same-origin safety restrictions." width="500" />
<p class="caption">
Figure 10.30: To view more complex code templates on your local computer
...
1.  Go to GitHub Desktop, confirm that your Current Repo is
    ...
    <a href="#fig:desktop-commit-push">10.31</a>.

<img src="images/10-github/desktop-commit-push-annotated.png" alt="In this two-step process, click *Commit*, then click *Push origin* to save and copy your edits from your local computer to your GitHub web account, as shown in this [animated GIF](https://handsondataviz.org/images/10-github/desktop-commit-push.gif)."  />
<p class="caption">
Figure 10.31: In this two-step process, click *Commit*, then click *Push
origin* to save and copy your edits from your local computer to your
GitHub web account, as shown in this [animated
GIF](https://handsondataviz.org/images/10-github/desktop-commit-push.gif).
</p>
...
<a href="#fig:compare-commits">10.32</a>.

<img src="images/10-github/compare-commits.png" alt="View commits made by co-workers on a shared GitHub repo." width="750" />
<p class="caption">
...
11](chartcode.html) and the [Leaflet map code templates in Chapter
12](leaflet.html). Let’s build on your brand-new coding skills to create
...
In [Chapter 6: Chart Your Data](chart.html), we looked at powerful
drag-and-drop tools, such as [Google Sheets](chart-google.html),
[Datawrapper](chart-datawrapper.html) and [Tableau
Public](chart-tableau.html) to build interactive charts.
...
Table <a href="#tab:chart-templates">11.1</a> lists all types of charts
...
<table>
<caption>Table 11.1: Chart Code Templates, Best Uses, and Tutorials</caption>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
</colgroup>
...
<tbody>
<tr class="odd">
<td>Bar or Column Chart<br> <img src="images/11-chartcode/tablechartjs-column.png" /></td>
...
<tr class="even">
<td>Error Bars in a Bar/Column Chart<br> <img src="images/11-chartcode/tablechartjs-error-bars.png" /></td>
...
<tr class="odd">
<td>Line Chart<br> <img src="images/11-chartcode/tablechartjs-line.png" /></td>
...
<tr class="even">
<td>Annotated Line Chart<br> <img src="images/11-chartcode/tablechartjs-highcharts-annotated-line.png" /></td>
...
<tr class="odd">
<td>Scatter Chart<br> <img src="images/11-chartcode/tablechartjs-scatter.png" /></td>
...
<tr class="even">
<td>Bubble Chart<br> <img src="images/11-chartcode/tablechartjs-bubble.png" /></td>
...
<a href="#fig:chartjs-demo-bar">11.1</a>. This column chart shows how
many students in five school districts in Connecticut were
English-language learners in 2018-2019 academic year.

<img src="images/11-chartcode/chartjs-demo-bar.png" alt="Bar chart with Chart.js: explore the [interactive version](https://handsondataviz.github.io/chartjs-bar/index.html)."  />
<p class="caption">
Figure 11.1: Bar chart with Chart.js: explore the [interactive
...
1.  Go to [our GitHub
    ...
    <a href="#fig:chartjs-demo-bar">11.1</a>, log into your GitHub
...
[Chapter 10: Edit and Host Code with GitHub](github.html).
...
template shown in Figure <a href="#fig:chartjs-demo-error-bars">11.2</a>
...
<img src="images/11-chartcode/chartjs-demo-error-bars.png" alt="Interactive bar chart with error bars in Chart.js. Explore the [interactive version](https://handsondataviz.github.io/chartjs-error-bars/index.html)."  />
<p class="caption">
Figure 11.2: Interactive bar chart with error bars in Chart.js. Explore
the [interactive
...
1.  Go to [our GitHub repo for this Chart.js
    ...
    <a href="#fig:chartjs-demo-error-bars">11.2</a>, log into your
...
chart in Figure <a href="#fig:chartjs-demo-line">11.3</a> shows the
...
<img src="images/11-chartcode/chartjs-demo-line.png" alt="Interactive line chart with Chart.js. Explore the [interactive version](https://handsondataviz.github.io/chartjs-line/)."  />
<p class="caption">
Figure 11.3: Interactive line chart with Chart.js. Explore the
...
1.  Go to [our GitHub repo for the Chart.js
    ...
    <a href="#fig:chartjs-demo-line">11.3</a>, log into your GitHub
    account, and click *Use this template* to create a copy that you can
    edit.
...
Attention to Meaning section of Chapter 15](draw-attention.html).
...
Note: To change a Chart.js line chart into a stacked area chart, see the
[Chart.js Stacked Area
documentation](https://www.chartjs.org/docs/latest/charts/line.html?h=stacked).
Make sure each `dataset` comes with a `fill: true` property, and also
make sure that `yAxes` has its `stacked` property set to `true`.
...
<a href="#fig:highcharts-demo-annotated-line">11.4</a> shows change in
...
<img src="images/11-chartcode/highcharts-demo-annotated-line.png" alt="Interactive annotated chart with Highcharts. Explore the [interactive version](https://handsondataviz.github.io/highcharts-line-annotated/)."  />
<p class="caption">
Figure 11.4: Interactive annotated chart with Highcharts. Explore the
[interactive
...
1.  Go to [our GitHub
    ...
    <a href="#fig:highcharts-demo-annotated-line">11.4</a>, log into
...
dimensions. Figure <a href="#fig:chartjs-demo-scatter">11.5</a> shows
...
<img src="images/11-chartcode/chartjs-demo-scatter.png" alt="Interactive scatter chart with Chart.js. Explore the [interactive version](https://handsondataviz.github.io/chartjs-scatter/)."  />
<p class="caption">
Figure 11.5: Interactive scatter chart with Chart.js. Explore the
[interactive
...
1.  Go to [our GitHub
    ...
    <a href="#fig:chartjs-demo-scatter">11.5</a>, log into your GitHub
    account, and click *Use this template* to create a copy that you can
    edit.
...
Bubble charts are similar to [scatter plots](chartjs-scatter.html), but
it adds one more variable (also known as dimension): the size of each
point (marker) also represents a value.

The bubble chart in Figure <a href="#fig:chartjs-demo-bubble">11.6</a>
...
<img src="images/11-chartcode/chartjs-demo-bubble.png" alt="Interactive bubble chart with Chart.js. Explore the [interactive version](https://handsondataviz.github.io/chartjs-bubble/)."  />
<p class="caption">
Figure 11.6: Interactive bubble chart with Chart.js. Explore the
...
(fully transparent) to 1.0 (fully opaque). For example,
...
<!--chapter:end:11-chartcode.Rmd-->

# 12 Leaflet Map Templates

In [Chapter 7: Map Your Data](map.html), we described several
...
GitHub in Chapter 10](github.html).

All of the Leaflet map templates in this chapter are summarized in Table
<a href="#tab:map-templates">12.1</a>. The first two templates are good
for beginners, because they pull your map data from a linked Google
Sheets table, and do not require any coding skills, but you need to
follow some detailed GitHub instructions. The first template, [Leaflet
Maps with Google Sheets](leaflet-maps-with-google-sheets.html) is best
for showing any combination of points, polylines, or polygons, with your
choice of custom icons and colors, and the option to display a summary
table of point data below your map. The second template, [Leaflet
Storymaps with Google
Sheets](leaflet-storymaps-with-google-sheets.html), is best for guiding
viewers through a point-by-point tour, with a scrolling narrative to
display text, images, audio, video, or scanned map backgrounds. We
specifically created both code templates for readers of this book, to
...
introduced in Chapter 3](opendata.html) and [raised again in Chapter
7](map-socrata.html).
...
`map.geojson` file, which you’ll learn how create in [Chapter 13:
Transform Your Map Data](transform.html).
...
<table>
<caption>Table 12.1: Map Code Templates, Best Uses, and Tutorials</caption>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
</colgroup>
...
<tbody>
<tr class="odd">
<td>Leaflet Maps with Google Sheets<br> <img src="images/12-leaflet/tableleaflet-maps-with-google-sheets.png" /></td>
...
<tr class="even">
<td>Leaflet Storymaps with Google Sheets<br> <img src="images/12-leaflet/tableleaflet-storymaps-with-google-sheets.png" /></td>
...
<tr class="odd">
<td>Leaflet Point Map with CSV Data<br> <img src="images/12-leaflet/tableleaflet-maps-with-csv.png" /></td>
...
<tr class="even">
<td>Leaflet Heatmap Points with CSV Data <br> <img src="images/12-leaflet/tableleaflet-heatmap.png" /></td>
...
<tr class="odd">
<td>Leaflet Searchable Point Map with CSV Data<br> <img src="images/12-leaflet/tableleaflet-searchable-map.png" /></td>
...
<tr class="even">
<td>Leaflet Maps with Open Data APIs<br> <img src="images/12-leaflet/tableleaflet-open-data.png" /></td>
...
layers, as shown in Figure <a href="#fig:lmwgs-map">12.1</a>. If you’ve
...
linked Google Sheet, as shown in Figure
<a href="#fig:lmwgs-sheet">12.2</a>, and upload images or geographic
...
[how to choose tools section in Chapter 1](choose.html). Furthermore,
...
<img src="images/12-leaflet/lmwgs-sheet.png" alt="View the [online Google Sheet template](https://docs.google.com/spreadsheets/d/1ZxvU8eGyuN9M8GxTU9acKVJv70iC3px_m3EVFsOHN9g) that feeds data into the Leaflet Maps demo above."  />
<p class="caption">
Figure 12.2: View the [online Google Sheet
...
Sheets as described in Chapter 2](copy.html). Also, you must have a
[GitHub account](http://github.com) and know how to [Edit and Host Code
with GitHub as described in Chapter 10](github.html). We omitted some
...
1.  In your new copy of the code repo, click the upper-right *Settings*
    ...
    <a href="#fig:leaflet-github-pages-main2">12.3</a>. This step tells
...
<p class="caption">
Figure 12.3: In *Settings*, go to *GitHub Pages*, switch the source from
...
3.  Delete the link to the *our* live site, as shown in Figure
    <a href="#fig:leaflet-readme-link-top">12.4</a>, and paste in the
    link to *your* published site. Scroll down to *Commit* your changes.

<img src="images/12-leaflet/leaflet-readme-link-top.png" alt="Edit your README file to replace the link to *our* site with the link to *your* site."  />
<p class="caption">
Figure 12.4: Edit your README file to replace the link to *our* site
...
5.  At the top of your browser, copy your Google Sheet address or URL
    ...
    <a href="#fig:sheets-publish">12.5</a>. Do *NOT* copy the *Published
...
<p class="caption">
Figure 12.5: Copy the Google Sheet address at the top of the browser,
...
2.  Paste *your* Google Sheet address or URL (which usually ends in
    ...
    Figure <a href="#fig:google-doc-url">12.6</a>. Be careful *NOT* to
...
<p class="caption">
Figure 12.6: Paste in *your* Google Sheet URL to replace *our* URL.
</p>
...
1.  Also, let’s paste your Google Sheet URL in second place to help you
    ...
    <a href="#fig:leaflet-readme-link-bottom">12.7</a>. Scroll down to
    *Commit* your changes.

<img src="images/12-leaflet/leaflet-readme-link-bottom.png" alt="Edit your README file to replace the link to *our* site with the link to *your* site."  />
<p class="caption">
Figure 12.7: Edit your README file to replace the link to *our* site
with the link to *your* site.
</p>
...
-   Marker Icon: Insert a [Font Awesome free and solid icon
    ...
    <a href="#fig:icon-combined">12.8</a>. Or leave blank for no icon
...
<img src="images/12-leaflet/icon-combined-annotated.png" alt="For a *Marker Icon*, insert a Font Awesome free and solid icon name such as `fa-ambulance` (on the right), or any Material Icon name such as `accessible` (on the left)." width="400" />
<p class="caption">
Figure 12.8: For a *Marker Icon*, insert a Font Awesome free and solid
...
-   Image: You have two options to display images. You can insert an
    ...
    <a href="#fig:leaflet-media-upload">12.9</a>, and enter the pathname
    in the Google Sheet in this format: `media/image.jpg` or `...png`.

<img src="images/12-leaflet/leaflet-media-upload.png" alt="In GitHub, click to open the `media` folder and *Add file - Upload files*." width="400" />
<p class="caption">
Figure 12.9: In GitHub, click to open the `media` folder and *Add file -
Upload files*.
</p>
...
-   Location, Latitude, Longitude: These place your markers at points on
    ...
    2](geocode.html) and select *Add-ons &gt; Geocoding by
    ...
    *Longitude*, and *Address found*, as shown in Figure
    <a href="#fig:geocode-details2">12.10</a>. Paste in your own address
...
<p class="caption">
Figure 12.10: Select *Add-ons–Geocoding by SmartMonkey–Geocode Details*
to display sample data with results for three new columns: *Latitude*,
*Longitude*, and *Address found*.
</p>
...
<a href="#fig:leaflet-map-with-table">12.11</a>. In the *Options* tab,
...
<img src="images/12-leaflet/leaflet-map-with-table.png" alt="Optional: display interactive table of viewable markers at the bottom of your map." width="500" />
<p class="caption">
Figure 12.11: Optional: display interactive table of viewable markers at
...
<a href="#fig:leaflet-map-custom-marker">12.12</a>, use any image
...
<img src="images/12-leaflet/leaflet-map-custom-marker.png" alt="Optional: create and upload custom thumbnail map markers." width="600" />
<p class="caption">
Figure 12.12: Optional: create and upload custom thumbnail map markers.
</p>
...
tutorial](mapshaper.html) as described in Chapter 13.
...
-   Edit the *Polygon Data* and *Color Settings* sections to modify the
    ...
    Design section of Chapter 7](map-design.html), or manually insert
...
1.  In your Google Sheets, go to each tab and select *File &gt;
    ...
    <a href="#fig:sheets-download-csv">12.13</a>, to create a separate
    file for each tab.

<img src="images/12-leaflet/sheets-download-csv.png" alt="Download each Google Sheets tab as a separate CSV file." width="350" />
<p class="caption">
Figure 12.13: Download each Google Sheets tab as a separate CSV file.
</p>
...
1.  In your GitHub repo, click the `csv` subfolder to open it, select
    *Add file &gt; Upload files*, and upload all of the CSV files above
    ...
    <a href="#fig:leaflet-upload-csv">12.14</a>. The Leaflet template
...
<img src="images/12-leaflet/leaflet-upload-csv.png" alt="Upload your map data files into the *csv* subfolder in GitHub." width="400" />
<p class="caption">
Figure 12.14: Upload your map data files into the *csv* subfolder in
GitHub.
</p>
...
<a href="#fig:storymap-demo">12.15</a>. You enter all of your map data
into a linked Google Sheet (or CSV file) or upload it into a GitHub
repository, as shown in Figure <a href="#fig:storymap-sheet">12.16</a>.
...
13: Transform Your Map Data](transform.html). Furthermore, the storymap
...
<img src="images/12-leaflet/storymap-sheet.png" alt="View the [online Google Sheet template](https://docs.google.com/spreadsheets/d/1AO6XHL_0JafWZF4KEejkdDNqfuZWUk3SlNlQ6MjlRFM/) that feeds data into the Leaflet Storymaps demo above."  />
<p class="caption">
Figure 12.16: View the [online Google Sheet
...
wisely in Chapter 1](choose.html). By contrast, all of the data you
...
<a href="#tab:storymaps-gallery">12.2</a> to see what other people
created with this template.

<table>
<caption>Table 12.2: Gallery of Leaflet Storymaps with Google Sheets</caption>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
</colgroup>
...
1.  In your new copy of the code repo, click the upper-right *Settings*
    ...
    drop-down menu, change *Source* from *None* to *Main*, keep the
    default */(root)* setting, and press *Save* as shown in Figure
    <a href="#fig:leaflet-github-pages-main3">12.17</a>. This step tells
    GitHub to publish a live version of your map on the public web,
    where anyone can access it in their browser, if they have the web
    address.
...
<img src="images/12-leaflet/leaflet-github-pages-main.png" alt="In *Settings*, go to *GitHub Pages*, switch the source from *None* to *Main*, and *Save*." width="300" />
<p class="caption">
Figure 12.17: In *Settings*, go to *GitHub Pages*, switch the source
...
3.  Delete the link to the *our* live site, as shown in Figure
    <a href="#fig:storymap-readme-link-top">12.18</a>, and paste in the
    link to *your* published site. Scroll down to *Commit* your changes.
...
<p class="caption">
Figure 12.18: Edit your README file to replace the link to *our* site
with the link to *your* site.
</p>
...
5.  At the top of your browser, copy your Google Sheet address or URL
    (which usually ends in `...XYZ/edit#gid=0`), as shown in Figure
    <a href="#fig:sheets-publish2">12.19</a>. Do *NOT* copy the
...
<img src="images/12-leaflet/sheets-publish-annotated.png" alt="Copy the Google Sheet address at the top of the browser, NOT the *Publish to the web* address." width="500" />
<p class="caption">
Figure 12.19: Copy the Google Sheet address at the top of the browser,
NOT the *Publish to the web* address.
</p>
...
2.  Paste *your* Google Sheet address or URL (which usually ends in
    `...XYZ/edit#gid=0`) to replace *our* existing URL, as shown in
    Figure <a href="#fig:google-doc-url2">12.20</a>. Be careful *NOT* to
    erase the single quotation marks or the semicolon at the end. Scroll
    down to *Commit* your changes. See separate instructions about the
    Google API key further below.
...
<img src="images/12-leaflet/google-doc-url.png" alt="Paste in *your* Google Sheet URL to replace *our* URL."  />
<p class="caption">
Figure 12.20: Paste in *your* Google Sheet URL to replace *our* URL.
</p>
...
1.  Also, let’s paste your Google Sheet URL in second place to help you
    ...
    open it, click the pencil symbol to edit it, and paste *your* Google
    Sheet URL to replace *our* existing URL, as shown in Figure
    <a href="#fig:storymap-readme-link-bottom">12.21</a>. Scroll down to
    *Commit* your changes.
...
<p class="caption">
Figure 12.21: Edit your README file to replace the link to *our* site
with the link to *your* site.
</p>
...
-   Media Link: You have several options to display either an image,
    ...
    Figure <a href="#fig:storymap-media-upload">12.22</a>, and enter the
...
<p class="caption">
Figure 12.22: In GitHub, click to open the `media` folder and *Add file
- Upload files*.
</p>
...
-   Location, Latitude, Longitude: These place your markers at points on
    ...
    data and display results for three new columns: *Latitude*,
    *Longitude*, and *Address found*, as shown in Figure
    <a href="#fig:geocode-details3">12.23</a>. Paste in your own address
    data and repeat the step above to geocode it, then copy and paste
    the results into your *Points* sheet.

<img src="images/12-leaflet/geocode-details.png" alt="Select *Add-ons--Geocoding by SmartMonkey--Geocode Details* to display sample data with results for three new columns: *Latitude*, *Longitude*, and *Address found*."  />
<p class="caption">
Figure 12.23: Select *Add-ons–Geocoding by SmartMonkey–Geocode Details*
to display sample data with results for three new columns: *Latitude*,
*Longitude*, and *Address found*.
</p>
...
ahead to [Chapter 13: Transform Your Map Data](transform.html), but here
...
map, use the [Map Warper tool](mapwarper.html) as described in Chapter
13 to align several known points with those on a present-day interactive
map. Map Warper transforms the static map image into interactive map
...
maps) on platforms such as [Map Warper](https://mapwarper.net) and the
...
<a href="#fig:storymap-overlay">12.24</a>.
...
<p class="caption">
Figure 12.24: Enter map tile link and transparency level into the Google
...
in Chapter 13, where you can also learn [how to find existing GeoJSON
...
<a href="#fig:storymap-geojson">12.25</a>.
...
<p class="caption">
Figure 12.25: Enter the pathname in the *GeoJSON Overlay* column (on
...
1.  In your Google Sheets, go to each tab and select *File &gt;
    Download* into CSV format, as shown in Figure
    <a href="#fig:storymap-download-csv">12.26</a>, to create a separate
    file for each tab.
...
1.  In your GitHub repo, click the `csv` subfolder to open it, select
    *Add file &gt; Upload files*, and upload all of the CSV files above
    into this subfolder, as shown in Figure
    <a href="#fig:storymap-upload-csv">12.27</a>. The Leaflet template
    code checks here first for data, and if it finds CSV files with the
    names above, it will pull the map data directly from them, instead
    of your Google Sheets. *Remember* that from this point forward, any
    edits in your Google Sheet will *no longer appear automatically* in
...
<p class="caption">
Figure 12.27: Upload your map data files into the *csv* subfolder in
GitHub.
</p>
...
1.  Go to the Google Developers Console at
    <https://console.developers.google.com/> and log in to your Google
    account. Google may ask you to identify your country and agree to
    its terms of service.

2.  Click on *Create a Project* on the opening screen, as shown in
    Figure <a href="#fig:google-api-create">12.28</a>. Or alternatively,
    go to the upper-left drop-down menu to *Select a project &gt; New
    project*.

<img src="images/12-leaflet/google-api-create.png" alt="Select *Create a Project* or use the menu to select a new project." width="600" />
<p class="caption">
Figure 12.28: Select *Create a Project* or use the menu to select a new
project.
</p>
...
1.  In the next screen, give your new project a meaningful short name to
    ...
    shown in Figure <a href="#fig:google-api-name">12.29</a>.

<img src="images/12-leaflet/google-api-name.png" alt="Give your project a meaningful short name." width="450" />
<p class="caption">
...
1.  In the next screen, press the *+ Enable APIs and Services* at the
    ...
    <a href="#fig:google-api-enable">12.30</a>. Make sure that your new
    project name appears near the top.

<img src="images/12-leaflet/google-api-enable.png" alt="Press the *+ Enable APIs and Services* button." width="500" />
<p class="caption">
...
1.  In the next screen, enter *Google Sheets* into the search bar, and
    ...
    <a href="#fig:google-api-search">12.31</a>.

<img src="images/12-leaflet/google-api-search.png" alt="Search for *Google Sheets* and select this result." width="500" />
<p class="caption">
...
1.  In the next screen, select the *Enable* button to turn on the Google
    ...
    <a href="#fig:google-api-select">12.32</a>.

<img src="images/12-leaflet/google-api-select.png" alt="Select the *Enable* button for Google Sheets API." width="350" />
<p class="caption">
...
1.  In the left sidebar menu, click *Credentials*, then click *+ Create
    ...
    <a href="#fig:google-api-credentials">12.33</a>.

<img src="images/12-leaflet/google-api-credentials.png" alt="Select *Credentials - Create Credentials - API key*."  />
<p class="caption">
...
1.  In the next screen, the console will generate your API key. Copy it,
    ...
    <a href="#fig:google-api-key">12.34</a>.

<img src="images/12-leaflet/google-api-key-annotated.png" alt="Copy your API key and press *Restrict key*." width="500" />
<p class="caption">
...
1.  In the new window, under *API restrictions*, choose the *Restrict
    ...
    <a href="#fig:google-api-restrict">12.35</a>.

<img src="images/12-leaflet/google-api-restrict.png" alt="Choose *API restrictions - Restrict key - Google Sheets API*" width="600" />
<p class="caption">
Figure 12.35: Choose *API restrictions - Restrict key - Google Sheets
API*
</p>
...
1.  In your Leaflet map code on your GitHub repo, open the
    ...
    in Figure <a href="#fig:google-api-paste">12.36</a>. Be careful not
    to erase the single-quote marks or the semicolon. Scroll down to
    *Commit* your changes.

<img src="images/12-leaflet/google-api-paste-annotated.png" alt="Paste in *your* Google Sheets API key to replace *our* key."  />
<p class="caption">
Figure 12.36: Paste in *your* Google Sheets API key to replace *our*
key.
</p>
...
Chapter 7](mymaps.html), you’ll more about how the Leaflet code library
works by doing it yourself.

Figure <a href="#fig:leaflet-map-csv">12.37</a> shows a simple point map
...
<img src="images/12-leaflet/leaflet-map-csv.png" alt="Explore the [interactive Leaflet point map with CSV data](https://handsondataviz.github.io/leaflet-map-csv/)."  />
<p class="caption">
Figure 12.37: Explore the [interactive Leaflet point map with CSV
...
<a href="#fig:leaflet-heatmap">12.38</a> shows an interactive heatmap of
...
<img src="images/12-leaflet/leaflet-heatmap.png" alt="Explore the [interactive Leaflet Heatmap](https://handsondataviz.github.io/leaflet-heatmap/)."  />
<p class="caption">
Figure 12.38: Explore the [interactive Leaflet
...
<a href="#fig:searchable-map">12.39</a> shows a powerful Leaflet
...
<img src="images/12-leaflet/searchable-map.png" alt="Explore the [interactive Searchable Map template](https://searchable-map-template-csv.netlify.app/)."  />
<p class="caption">
Figure 12.39: Explore the [interactive Searchable Map
...
[GeoJSON](geojson.html) formats. If you have an Excel file, save it in
CSV format with any spreadsheet tool. The CSV file must have a latitude
column and longitude column and all rows must be geocoded. If you only
have street-address or location data, learn how to
[geocode](geocode.html) it in chapter 2.
...
2.  Upload this map and all the supporting files and folders to your
    ...
    such as [GitHub Pages as described in Chapter 10](github.html), or
...
map you learned about in Chapter 7](map-socrata.html). Leaflet maps can
pull and display data from various open data repositories using APIs.
Figure <a href="#fig:leaflet-open-data">12.40</a> shows an interactive
...
<img src="images/12-leaflet/leaflet-open-data.png" alt="Explore the [interactive Leaflet Map with Open Data](https://handsondataviz.github.io/leaflet-maps-open-data-apis/index.html)."  />
<p class="caption">
Figure 12.40: Explore the [interactive Leaflet Map with Open
...
1.  Visit the [GitHub
    ...
    <a href="#fig:leaflet-open-data">12.40</a>, and press the *Use this
...
<!--chapter:end:12-leaflet.Rmd-->

# 13 Transform Your Map Data

In [Chapter 7: Map Your Data](map.html), we introduced basic concepts
...
tiles using the [the Map Warper tool](mapwarper.html). All of these
free, web-based geodata tools are easy to learn, and in many cases they
...
7](map-design.html). In digital maps, raster data often appears as
...
<a href="#fig:geospatial-raster-vector">13.1</a>.
...
<img src="images/13-transform/geospatial-raster-vector.png" alt="Geospatial data can be a raster grid of cells (on the left) or a vector collection of points, polylines, and polygons (on the right)." width="750" />
<p class="caption">
Figure 13.1: Geospatial data can be a raster grid of cells (on the left)
...
in Figure <a href="#fig:geojson-github">13.2</a>.

<img src="images/13-transform/geojson-github.png" alt="GitHub repositories automatically show a map preview for GeoJSON files." width="600" />
<p class="caption">
Figure 13.2: GitHub repositories automatically show a map preview for
GeoJSON files.
</p>
...
Tip: Sometimes `.kml` files are distributed in a compressed `.kmz`
...
described in Chapter 7](choropleth-datawrapper.html) and the [Leaflet
...
listed in Chapter 3](opendata.html).
...
boundaries, as shown in Figure <a href="#fig:gimme-geodata">13.3</a>.
...
<img src="images/13-transform/gimme-geodata.png" alt="Use the Gimme Geodata tool to select a point and download surrounding geographic boundaries from Open Street Map."  />
<p class="caption">
Figure 13.3: Use the Gimme Geodata tool to select a point and download
...
<a href="#fig:geojson-io-import">13.4</a> shows us that 140 features
...
<img src="images/13-transform/geojson-io-import.png" alt="GeoJson.io successfully imported the Toronto neighborhoods sample KML file." width="600" />
<p class="caption">
Figure 13.4: GeoJson.io successfully imported the Toronto neighborhoods
sample KML file.
</p>
...
<a href="#fig:geojson-io-csv-data">13.5</a>.

<img src="images/13-transform/geojson-io-csv-data.png" alt="A CSV spreadsheet with lat/lon columns can be transformed into a GeoJSON with point features."  />
<p class="caption">
Figure 13.5: A CSV spreadsheet with lat/lon columns can be transformed
...
2.  Click the *Table* tab to the right of the map to view all of the
    ...
    Figure <a href="#fig:geojson-io-points">13.6</a>. You can edit and
...
<img src="images/13-transform/geojson-io-points.png" alt="Upload CSV data into GeoJson.io to easily edit it in the Map or Table view."  />
<p class="caption">
Figure 13.6: Upload CSV data into GeoJson.io to easily edit it in the
Map or Table view.
</p>
...
3.  In the upper-right corner of the map, use the Search tool to find an
    ...
    <a href="#fig:geojson-io-draw">13.7</a>.

<img src="images/13-transform/geojson-io-draw.png" alt="Use drawing tools to create points, lines, and polygons in GeoJson.io." width="450" />
<p class="caption">
Figure 13.7: Use drawing tools to create points, lines, and polygons in
GeoJson.io.
</p>
...
2.  To export, go to *Export* in the upper-right corner, and select a
    ...
    <a href="#fig:mapshaper-export">13.8</a>. Currently, available
...
<p class="caption">
Figure 13.8: You can use Mapshaper to quickly convert between geospatial
file formats.
</p>
...
<a href="#fig:mapshaper-edit">13.9</a>.
...
<p class="caption">
Figure 13.9: Use *edit attributes* tool (under Cursor tool) to edit
...
<a href="#fig:mapshaper-rename">13.10</a>. In this example, to change
...
<p class="caption">
Figure 13.10: Select the *Inspect Features* arrow to view field names,
...
<a href="#fig:mapshaper-simplify-demo">13.11</a>. The map in Figure
<a href="#fig:mapshaper-simplify-demo">13.11</a>a is more detailed and
is about 230 kilobytes, but the map in Figure
<a href="#fig:mapshaper-simplify-demo">13.11</a>b is only 37 kilobytes,
...
<p class="caption">
Figure 13.11: Consider simplifying geometries with Mapshaper to make
...
3.  You will see a slider with `100%` appear on top (Figure
    <a href="#fig:mapshaper-simplify">13.12</a>), replacing the layer
...
Tip: Tip: When you upload a geographic file to Mapshaper, you may need
to change its projection to align with your visualization tools or
related geodata. Click to open the *Console* and type
`-proj webmercator` (or `-proj EPSG:3857`) to change the projection to
Web Mercator, the format commonly used by Google Maps and other web
mapping tools.
...
as shown in Figure <a href="#fig:mapshaper-dissolve">13.13</a>.

<img src="images/13-transform/mapshaper-dissolve.png" alt="Mapshaper lets you dissolve boundaries to create an outline shape."  />
<p class="caption">
Figure 13.13: Mapshaper lets you dissolve boundaries to create an
outline shape.
</p>
...
1.  Your Mapshaper state should look like the one pictured in Figure
    <a href="#fig:mapshaper-clip">13.14</a>. You can now save the file
...
<p class="caption">
Figure 13.14: When clipping, make sure your active layer is the one
...
2.  Use the *Cursor &gt; inspect attributes* tool to make sure you see
    ...
    <a href="#fig:mapshaper-join">13.15</a>.
...
<p class="caption">
Figure 13.15: In Mapshaper, join spatial and CSV files using common
...
1.  Use the *Cursor &gt; inspect attributes* tool to make sure polygons
    ...
    Figure <a href="#fig:mapshaper-count-points">13.16</a>.
...
<p class="caption">
Figure 13.16: Mapshaper’s *-join* command can count points in polygons.
</p>
...
5.  Pick a few towns, such as *West Hartford* and *Bloomfield*, and
    ...
    in Figure <a href="#fig:mapshaper-merge-csv">13.17</a>. You can stop
...
<p class="caption">
Figure 13.17: Create a two-column crosswalk of town names and their
...
<a href="#fig:mapshaper-merge">13.18</a> shows the final result.
...
3.  Right-click (or control-click) on the KMZ layer under the *Places*
    ...
    <a href="#fig:kmz-earth">13.19</a>.

<img src="images/13-transform/kmz-earth-annotated.png" alt="In Google Earth Pro, right-click the KMZ layer and choose *Save Place As*." width="400px" />
<p class="caption">
Figure 13.19: In Google Earth Pro, right-click the KMZ layer and choose
*Save Place As*.
</p>

1.  In the dropdown menu of *Save file…* window, choose *KML* format, as
    shown in Figure <a href="#fig:kmz-save-as">13.20</a>.

<img src="images/13-transform/kmz-save-as.png" alt="Save as KML, not KMZ." width="350px" />
<p class="caption">
Figure 13.20: Save as KML, not KMZ.
</p>
...
[Map Warper](http://mapwarper.net), an open-source tool created and
...
12](leaflet-storymaps-with-google-sheets.html). Anyone can create a free
account to upload and georeference a map on the developer’s public Map
Warper site. See also how the tool is used by organizations such as the
[New York Public Library’s digital maps
collection](http://maps.nypl.org).

Warning: While Map Warper is a wonderful open-source platform, service
...
1.  Create a free account on [Map Warper](http://mapwarper.net).
...
3.  After you upload the image, click on the *Rectify* tab in the Map
    Warper interface, and practice moving around the map.
...
4.  Click to add a control point in the historic map window, then click
    ...
    <a href="#fig:mapwarper">13.21</a>. Good control points are stable
...
<img src="images/13-transform/mapwarper.png" alt="Add control points to align stable locations or landmarks between the historical map (on the right) and the modern map (on the left)." width="750" />
<p class="caption">
Figure 13.21: Add control points to align stable locations or landmarks
...
1.  Add at least 4 or 5 control points to match the two maps and spread
    ...
    the bottom of the page. Map Warper transforms the static map image
...
1.  You can copy and paste this special Tiles URL into the [Leaflet
    ...
    12](leaflet-storymaps-with-google-sheets.html), or other web map
...
align maps, on platforms such as [Map warper](https://mapwarper.net),
the [New York Public Library Map Warper](http://maps.nypl.org/warper/).

## Bulk Geocode with US Census

In Chapter 2: Strengthen Your Spreadsheet Skills, you learned [how to
...
4: Clean Up Messy Data](split-data.html). But if your street addresses
...
(as in Figure <a href="#fig:pivot-address">13.22</a>a ), you want darker
shades of blue to represent states with more hospitals (as in Figure
<a href="#fig:pivot-address">13.22</a>b).

or choropleth, maps instead of point maps.

<img src="images/13-transform/pivot-address-annotated.png" alt="You can count addresses by state (or other area) to produce polygon,"  />
<p class="caption">
Figure 13.22: You can count addresses by state (or other area) to
produce polygon,
</p>

First, save the database to your local machine by going to *Export &gt;
Download &gt; CSV* of Socrata interface. Figure
<a href="#fig:pivot-address-export">13.23</a> shows where you can find
the Export button.

<img src="images/13-transform/pivot-address-export-annotated.png" alt="In Socrata, you can export the entire dataset as a CSV."  />
<p class="caption">
Figure 13.23: In Socrata, you can export the entire dataset as a CSV.
</p>
...
<img src="images/13-transform/pivot-address-sheet-annotated.png" alt="Use pivot tables in any spreadsheet software to count addresses per area (such as state, county, of zip code)."  />
<p class="caption">
Figure 13.24: Use pivot tables in any spreadsheet software to count
...
<a href="#fig:us-income-chart1">0.1</a> and Figure
<a href="#fig:us-income-chart2">0.2</a>, and maps in Figure
<a href="#fig:world-income-map1">0.3</a> and Figure
<a href="#fig:world-income-map2">0.4</a>, to demonstrate how the same
...
introduced in [Chapter 6 on chart design](chart-design.html) and
[Chapter 7 on map design](map-design.html). Rather than a binary world,
...
3.  Create a Google Sheets column chart in the same sheet using the
    *default* settings, although we never blindly accept them as the
    ...
    6](chart-google.html). The tool should recognize your data and
    automatically produce a column chart, as shown in the left side of
    Figure <a href="#fig:gdp-baseline-merged">14.1</a>. In this default
...
4.  *Truncate the vertical axis to exaggerate differences.* Instead of a
    ...
    <a href="#fig:gdp-baseline-merged">14.1</a>. Although the data
...
<img src="images/14-detect/gdp-baseline-merged-annotated.png" alt="The Zero baseline GDP line chart (left), and the Truncated baseline line chart, with the Chart editor (right)." width="750" />
<p class="caption">
Figure 14.1: The Zero baseline GDP line chart (left), and the Truncated
...
6](chart-design.html). Column (and bar) charts *must* start at the zero
...
3.  Create a Google Sheets line chart by selecting the two columns in
    ...
    <a href="#fig:temperature-default">14.2</a>.

<img src="images/14-detect/temperature-default.png" alt="Default line chart of global temperature change. Explore the [interactive version](https://docs.google.com/spreadsheets/d/e/2PACX-1vRBJy0vWBN1z49hE8c7vxF_ZiTNKF5RjQ2vpJ-aVfsdNpNYgcMu1cH2zAh90v713vcMmrs6kVlSgQkV/pubchart?oid=557710802&format=interactive)."  />
<p class="caption">
Figure 14.2: Default line chart of global temperature change. Explore
the [interactive
...
<a href="#fig:temperature-axis-annotated">14.3</a>. By increasing the
...
<img src="images/14-detect/temperature-axis-annotated.png" alt="Misleading chart with a lengthened vertical axis."  />
<p class="caption">
Figure 14.3: Misleading chart with a lengthened vertical axis.
</p>
...
Chapter 6](chart-design.html). But you may be surprised to learn that
...
<a href="#fig:temperature-aspect-annotated">14.4</a>. Image measurements
...
<img src="images/14-detect/temperature-aspect-annotated.png" alt="Misleading chart with a stretched aspect ratio."  />
<p class="caption">
Figure 14.4: Misleading chart with a stretched aspect ratio.
</p>
...
<a href="#fig:temperature-aspect-cairo">14.5</a>. While this very tall
...
&lt;img src=“images/14-detect/temperature-aspect-cairo-annotated.png”
alt=“Following Cairo’s”recommendation" for a 300% increase results in a
1:3 aspect ratio that exaggerates change." /&gt;
<p class="caption">
Figure 14.5: Following Cairo’s “recommendation” for a 300% increase
...
<a href="#fig:temperature2-aspect-cairo">14.6</a>. Cairo warns that this
...
&lt;img src=“images/14-detect/temperature2-aspect-cairo-annotated.png”
alt=“Following Cairo’s”recommendation" for an 8% increase results in a
12:1 aspect ratio that diminishes change." /&gt;
<p class="caption">
Figure 14.6: Following Cairo’s “recommendation” for an 8% increase
...
2.  In the *Chart editor*, select *Customize* and scroll down to
    ...
    *US GDP*. Just below that in the *Format* area, change the *Axis*
    ...
    <a href="#fig:temperature-gdp-axis-setup">14.7</a>.

<img src="images/14-detect/temperature-gdp-axis-setup.png" alt="Add another vertical axis to the right side of the chart."  />
<p class="caption">
Figure 14.7: Add another vertical axis to the right side of the chart.
</p>
...
1.  In the *Chart editor &gt; Customize* tab, scroll down and you will
    ...
    <a href="#fig:temperature-right-axis">14.8</a>.

<img src="images/14-detect/temperature-right-axis.png" alt="Brand-new menu for the right axis." width="250" />
<p class="caption">
Figure 14.8: Brand-new menu for the right axis.
</p>
...
1.  Finish your chart by adjusting *Vertical Axis* for temperature
    ...
    <a href="#fig:temperature-gdp-final-annotated">14.9</a>.

<img src="images/14-detect/temperature-gdp-final-annotated.png" alt="Misleading dual-axis chart of US GDP and global temperature change."  />
<p class="caption">
Figure 14.9: Misleading dual-axis chart of US GDP and global temperature
change.
</p>
...
<a href="#fig:temperature-gdp-final-annotated">14.9</a>, the left-side
...
dollars, a topic we warned about in [Chapter 5: Make Meaningful
...
chapter 6](scatter-bubble-datawrapper.html). We can make a more
...
as shown in Figure
<a href="#fig:real-gdp-temperature-scatter">14.10</a>. Overall, the
...
<img src="images/14-detect/real-gdp-temperature-scatter.png" alt="Connected scatter chart of relationship between US real GDP and global temperature change from 1929 to 2019. Explore the [interactive version](https://datawrapper.dwcdn.net/Zleaq/)."  />
<p class="caption">
Figure 14.10: Connected scatter chart of relationship between US real
...
7](map-design.html) to avoid common mistakes when designing choropleth
...
Datawrapper in Chapter 7](choropleth-datawrapper.html).
...
<a href="#fig:world-income-map1">0.3</a> colored the US in medium blue
which suggested its level of inequality was similar to other nations,
while Figure <a href="#fig:world-income-map2">0.4</a> made the US stand
...
3.  In the *Visualize* screen, in the *Colors* section of the *Refine*
    ...
    settings, as shown in Figure
    <a href="#fig:map-color-settings">14.11</a>. Let’s skip past the
    light-green-to-blue color palette, which you can modify later, and
    let’s focus on settings for color ranges.

<img src="images/14-detect/map-color-settings.png" alt="Click the *wrench symbol* to open the color settings." width="350" />
<p class="caption">
Figure 14.11: Click the *wrench symbol* to open the color settings.
</p>
...
<a href="#fig:map-continuous-linear">14.12</a>. Notice that the US
(20.5%) blends in with a medium blue color, just above the midpoint in
this range.

<img src="images/14-detect/map-continuous-linear.png" alt="Income inequality map with continuous range and linear interpolation. Explore the [interactive version](https://datawrapper.dwcdn.net/aetEM/)."  />
<p class="caption">
Figure 14.12: Income inequality map with continuous range and linear
...
<a href="#fig:map-3steps-naturalbreaks">14.13</a>. This means that the
...
<img src="images/14-detect/map-3steps-naturalbreaks.png" alt="Income inequality map with 3 steps and natural breaks interpolation. Explore the [interactive version](https://datawrapper.dwcdn.net/VSfdZ/)."  />
<p class="caption">
Figure 14.13: Income inequality map with 3 steps and natural breaks
interpolation. Explore the [interactive
...
<a href="#fig:map-data-histogram">14.14</a>. While most nations are
...
<img src="images/14-detect/map-data-histogram-annotated.png" alt="Histogram of income inequality map data."  />
<p class="caption">
Figure 14.14: Histogram of income inequality map data.
</p>
...
5](biased-comparisons.html). One type to avoid is *selection bias*,
...
described in chapter 3](question.html), before you attempt to make
...
[chapter 5](comparisons.html) to learn about appropriate tests to
...
ones, as shown in Figure <a href="#fig:schwabish-feng1">14.15</a>.
...
<a href="#fig:schwabish-feng2">14.16</a>.

<img src="images/14-detect/schwabish-feng1.png" alt="To avoid a deficit-based perspective, Schwabish and Feng argue against combining racial and ethnic data on the same chart. Image by [Urban Institute](https://medium.com/@urban_institute/applying-racial-equity-awareness-in-data-visualization-bd359bf7a7ff), reprinted with permission." width="500" />
<p class="caption">
Figure 14.15: To avoid a deficit-based perspective, Schwabish and Feng
...
<img src="images/14-detect/schwabish-feng2.png" alt="Instead, Schwabish and Feng recommend placing racial and ethnic data in separate charts, with state or national averages as a comparison point. Image by [Urban Institute](https://medium.com/@urban_institute/applying-racial-equity-awareness-in-data-visualization-bd359bf7a7ff), reprinted with permission." width="500" />
<p class="caption">
Figure 14.16: Instead, Schwabish and Feng recommend placing racial and
...
in Figure <a href="#fig:conventional-cartogram-combined">14.17</a>.
...
as shown in Figure
<a href="#fig:conventional-cartogram-combined">14.17</a>. But one
...
<img src="images/14-detect/conventional-cartogram-combined.png" alt="The US 2020 Presidential electoral vote displayed in a conventional US map (left) versus a cartogram (right), both created with Datawrapper." width="750" />
<p class="caption">
Figure 14.17: The US 2020 Presidential electoral vote displayed in a
conventional US map (left) versus a cartogram (right), both created with
Datawrapper.
</p>

Note: To recreate the cartogram map in Figure
<a href="#fig:conventional-cartogram-combined">14.17</a> in Datawrapper,
...
2.  Go to the *Select your map* screen, and type “squares” to see all of
    ...
    <a href="#fig:map-world-pop-square">14.18</a>.

<img src="images/14-detect/map-world-pop-square.png" alt="World population square map with income inequality data. Explore the [interactive version](https://datawrapper.dwcdn.net/YfNDe/)."  />
<p class="caption">
Figure 14.18: World population square map with income inequality data.
...
<a href="#fig:usa-states-territories">14.19</a>. For other regions that
...
13](geojson.html). Or, if your tool forces you to omit part of your data
...
<img src="images/14-detect/usa-states-territories-combined.png" alt="Datawrapper recently improved how it displays D.C. and non-contiguous places in its *USA - States and Territories* option for both symbol and choropleth maps." width="750" />
<p class="caption">
Figure 14.19: Datawrapper recently improved how it displays D.C. and
...
1](sketch.html). We encouraged you to scribble words and sketch pictures
...
<a href="#fig:data-story-panel2">15.1</a>. Imagine them as preliminary
...
<img src="images/01-choose/data-story-panel.png" alt="Sketch out your story idea on four pages: problem, question, find data, visualize." width="750" />
<p class="caption">
Figure 15.1: Sketch out your story idea on four pages: problem,
...
as we discussed in [chapter 2](spreadsheet.html). We [cleaned up the
data as described in chapter 4](clean.html) because some responses were
...
chapter 5](comparisons.html) and visualized our most interesting results
in two ways. We created a [scatter chart as described in chapter
6](chart.html) and also a [point map as described in chapter
7](map.html). For this chapter, we followed our own advice above by
...
left side of Figure <a href="#fig:survey-combined-annotated">15.2</a>.
...
<a href="#fig:survey-combined-annotated">15.2</a>. In our earlier draft
...
<img src="images/15-story/survey-combined-annotated.png" alt="Verbalize meaningful insights at the top of each visualization, and tell why it matters at the bottom, then insert them into your storyboard." width="750" />
<p class="caption">
Figure 15.2: Verbalize meaningful insights at the top of each
...
as shown in Figure <a href="#fig:plastic-line-chart">15.3</a>, which
...
<img src="images/15-story/plastic-line-chart.png" alt="The default line chart for historical plastic production in Datawrapper."  />
<p class="caption">
Figure 15.3: The default line chart for historical plastic production in
Datawrapper.
</p>

But Figure <a href="#fig:plastic-line-chart">15.3</a> does not yet focus
on the bigger story: the total amount of plastics manufactured in global
history. More than 60 percent of all of the plastics ever manufactured
in the world have been made since 2000, or the last 15 years of this
chart, according to our analysis of the data. Let’s highlight this
broader point by editing the chart and building on skills you learned in
prior chapters. First, divide the data into two columns, *before 2000*
and *since 2000*, which allows you to apply different colors to each
data series. Insert the same data for year 2000 in both columns to make
the new chart look continuous. Second, change the chart type from the
...
<a href="#fig:plastic-refine">15.4</a>.
...
<img src="images/15-story/plastic-refine.png" alt="After dividing the data into two columns and switching to an area chart, uncheck the *stacked areas* box in the *Refine* tab."  />
<p class="caption">
Figure 15.4: After dividing the data into two columns and switching to
...
6](annotated-datawrapper.html). Place annotations inside the area chart,
using colored text, to emphasize the new interpretation and place it
where readers will look, as shown in Figure
<a href="#fig:plastic-area-chart">15.5</a>. Overall, redesigning your
...
<img src="images/15-story/plastic-area-chart.png" alt="Explore the [interactive version of the new area chart](https://datawrapper.dwcdn.net/1TyyZ/), which uses color and annotations to draw attention to post-2000 global plastic production."  />
<p class="caption">
Figure 15.5: Explore the [interactive version of the new area
...
audience, as we discussed in [Chapter 14 on detecting lies and reducing
...
described in [Chapter 3: Find and Question Your Data](find.html). Some
...
spreadsheet tabs, as shown in Chapter 2](spreadsheet.html). For more
...
10](github.html). If someone questions your work—or if you need to
...
recommended [chart tools in chapter 6](chart.html) and [chart code
templates in chapter 11](chartcode.html) allow you to insert error bars
...
Figure <a href="#fig:observed-vs-projected">15.6</a>.

<img src="images/15-story/observed-vs-projected.png" alt="Split one data column into two columns to contrast observed data (solid line) versus projected data (dashed line)."  />
<p class="caption">
Figure 15.6: Split one data column into two columns to contrast observed
...
Reach out to ask others for advice on solving problems, and make it
easier for them to help you. Clearly describe your issue, mention your
computer operating system and/or browser version, and consider including
a [screenshot](https://en.wikipedia.org/wiki/Screenshot) using these
built-in commands, as shown in Figure
<a href="#fig:screenshot-mac">16.1</a>:
...
<img src="images/16-fix/screenshot-mac.png" alt="How to create a screenshot on a Mac."  />
<p class="caption">
Figure 16.1: How to create a screenshot on a Mac.
</p>

Review these sections below to help you diagnose what type of problem
you may be facing, and see our recommended solutions for the most common
issues we’ve seen. Remember that some of the thorniest problems may be
caused by two or more separate issues.
...
## 16.1 Tool or platform problems
...
-   [Map Warper georectifier help](https://mapwarper.net/help) and [see
...
## 16.3 Diagnose with developer tools

We recommend learning how to use your browser to diagnose other types of
issues discussed later in this appendix, such as [common iframe
errors](fix-iframe.html) or [code template issues](fix-code.html). Most
...
<a href="#fig:firefox-dev-tools">16.2</a>, the console will display
...
&lt;img src=“images/16-fix/firefox-dev-tools-annotated.png” alt=“When
...
<p class="caption">
Figure 16.2: When you open a browser’s developer tools, the console
...
## 16.4 Mac or Chromebook problems
...
<a href="#fig:mac-file-extensions2">16.3</a>.

<img src="images/16-fix/mac-file-extensions.png" alt="On a Mac, go to *Finder - Preferences - Advanced* and check the box to *Show all filename extensions*." width="400" />
<p class="caption">
Figure 16.3: On a Mac, go to *Finder - Preferences - Advanced* and check
...
4](clean.html). In addition, avoid common mistakes that will introduce
errors into your data files, especially when working with [Chart.js and
Highcharts code templates in Chapter 11](chartcode.html) and [Leaflet
map code templates in Chapter 12](leaflet.html).

First, avoid typing blank spaces into spreadsheet entries—especially
column headers—as shown in Figure <a href="#fig:header-blank">16.4</a>.
...
<img src="images/16-fix/header-blank.png" alt="Avoid typing blank spaces into spreadsheets, especially column headers." width="300" />
<p class="caption">
Figure 16.4: Avoid typing blank spaces into spreadsheets, especially
column headers.
</p>
...
<a href="#fig:blank-row">16.5</a>.

<img src="images/16-fix/blank-row.png" alt="Avoid leaving blank rows in Google Sheets data files for Leaflet code templates." width="500" />
<p class="caption">
Figure 16.5: Avoid leaving blank rows in Google Sheets data files for
...
tool in Chapter 13](geojsonio.html) to closely inspect your geodata for
null fields.

## 16.6 Common iframe errors

If you followed steps in [Chapter 9: Embed on the Web](embed.html) and
...
<a href="#fig:iframe-incorrect">16.6</a> shows three common problems in
...
<a href="#fig:iframe-correct">16.7</a>, which causes the iframe to
appear as expected.

<img src="images/16-fix/iframe-incorrect.png" alt="Can you spot three common problems in this incorrect iframe code?"  />
<p class="caption">
Figure 16.6: Can you spot three common problems in this incorrect iframe
code?
</p>

<img src="images/16-fix/iframe-correct.png" alt="All three problems are corrected here, which causes the iframe to appear as expected."  />
<p class="caption">
Figure 16.7: All three problems are corrected here, which causes the
iframe to appear as expected.
</p>

## 16.7 Fix your code on GitHub

As we discussed in [Chapter 10: Edit and Host Code with
...
11](chartcode.html) and [Leaflet map code templates in Chapter
12](leaflet.html), be cautious about making edits, especially to the
...
as shown in Figure <a href="#fig:header-name">16.8</a>, unless you know
what you are doing, because the code template looks for these exact
names in order to process your data.

<img src="images/16-fix/header-name-annotated.png" alt="Do not change header names in code templates, unless you know what you are doing." width="600" />
<p class="caption">
Figure 16.8: Do not change header names in code templates, unless you
...
Chapter 10](github-desktop-atom.html). To fully view more complex
...
<a href="#fig:disable-cors-safari">10.29</a> and Figure
<a href="#fig:disable-cors-chrome">10.30</a>.
...
such as [GitHub Desktop in Chapter 10](github-desktop-atom.html).
...
Benefit-Cost Analysis* 11, no. 2 (2020/ed): 151–78.
...
[7] , “Drilling into the DEA’s Pain Pill Database” (Washington Post,
July 16, 2019),
<https://www.washingtonpost.com/graphics/2019/investigations/dea-pain-pill-database/>.
...
[14] Cairo, *How Charts Lie*, pp. 99-102
...
Charting in Excel & Google Sheets” (Datawrapper Blog, October 23, 2019),
<https://blog.datawrapper.de/prepare-and-clean-up-data-for-data-visualization/index.html>.
...
Analysis* 11, no. 2 (2020/ed): 151–78,
...
in data visualization: Cairo, *The Truthful Art*; Cairo, *How Charts
Lie*; Darrell Huff, *How to Lie with Statistics* (W. W. Norton &
Company, 1954), <http://books.google.com/books?isbn=0393070875>; Mark
Monmonier, *How to Lie with Maps, Third Edition* (University of Chicago
Press, 2018),
<https://www.google.com/books/edition/How_to_Lie_with_Maps_Third_Edition/MwdRDwAAQBAJ>;
...
climate change deniers. NASA JPL, “Educator Guide”; Cairo, *How Charts
Lie*, pp. 65-67, 135-141.

[40] Cairo, *How Charts Lie*, p. 61.
...
<https://www.google.com/books/edition/Storytelling_with_Data/aGatDwAAQBAJ>;
Cairo, *The Truthful Art*; Cairo, *How Charts Lie*.

[52] This example was inspired by the Datawrapper Academy article on pro
tips:
<https://academy.datawrapper.de/article/256-a-collection-of-datawrapper-pro-tips>.
