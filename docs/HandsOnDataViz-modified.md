...
as [Chart.js code templates](chartjs.html) in chapter 9, which give you
ever more control over how your design and display your data, but also
require learning how to [edit and host code templates with
...
| XY Scatter chart <br> ![](images/05-chart/chart-scatter.png) | Best to show the relationship between two sets of data. <br>Easy tool: [Google Sheets scatter chart tutorial](scatter-bubble-google.html) or [Tableau Public scatter chart tutorial](scatter-chart-tableau.html)<br>Power tool: [Chart.js templates](chartjs.html) |
| Bubble chart <br> ![](images/05-chart/chart-bubble.png) | Best to show the relationship between three or four sets of data, using bubble size and color.<br>Easy tool: [Google Sheets bubble chart tutorial](scatter-bubble-google.html)<br>Power tool: [Chart.js templates](chartjs.html) |
...
<img src="images/05-chart/line-data.png" alt="Data for the line chart shown in Figure 60." width="250px" />
<p class="caption">
...
<a href="#fig:menu-hamburger-kebab">66</a>.
...
next section) in Figure <a href="#fig:bubble-3">67</a> shows the same
...
The bubble chart in Figure <a href="#fig:bubble-5">68</a> shows
...
Figure <a href="#fig:tableau-xy-demo">70</a> illustrates a strong
...
<a href="#fig:tableau-xy-demo">70</a>, you can [download the sample
...
2.  Drag `data` sheet into *Drag tables here* area, like is shown in
    Figure <a href="#fig:tableau-connect">71</a>. You will see the
...
<p class="caption">
Figure 71: Drag `data` sheet into *Drag tables here* area.
</p>
...
2.  Drag the *Grade Levels* measure into the **Rows** field above the
    ...
    Figure <a href="#fig:tableau-xy-dragging">72</a> for this and two
...
<a href="#fig:tableau-xy-final">73</a>.
...
3.  Once the dashboard is saved, Tableau Public will open up a window in
    ...
    <a href="#fig:tableau-toolbar-settings">74</a>), and enable/disable
...
<a href="#fig:tableau-filtered-demo">75</a>. The filter will be a
...
<a href="#fig:tableau-filtered-ready">77</a>, you are ready to publish.
...
<a href="#fig:leaflet-simple">78</a>.

<iframe src="https://handsondataviz.github.io/leaflet-map-simple/" width="100%" height="400px">
</iframe>
<p class="caption">
Figure 78: Create your own version of this [simple interactive Leaflet
...
1.  On the next screen, your account will appear as the owner. Name your
    ...
    Figure <a href="#fig:leaflet-simple-name">80</a>. Click the green
...
1.  Click on the `index.html` file to view the code, as shown in Figure
    <a href="#fig:leaflet-simple-index">81</a>.
...
1.  To edit the code, click on the the pencil symbol in the upper-right
    ...
    <a href="#fig:leaflet-simple-edit">82</a>.
...
2.  To save your edit, scroll to the bottom of the page and click the
    ...
    <a href="#fig:leaflet-simple-commit">83</a>.
...
<p class="caption">
Figure 83: Click the green *Commit Changes* button to save your edits.
</p>
...
1.  To access GitHub Pages, scroll to the top of your repo page and
    ...
    <a href="#fig:leaflet-simple-settings">84</a>.
...
<p class="caption">
Figure 84: Click the *Settings* button to access GitHub Pages and
...
1.  In the Settings screen, scroll way down to the GitHub Pages area,
    ...
    <a href="#fig:leaflet-github-pages">85</a>. There is no *commit* or
...
/&gt;
<p class="caption">
Figure 85: In *Settings &gt; GitHub Pages*, switch the source from
*None* to *Master*.
</p>
...
1.  Scroll back down to *Settings &gt; GitHub Pages* to see the web
    ...
    <a href="#fig:leaflet-github-pages-link">86</a>.
...
tab." width=“600” /&gt;
<p class="caption">
Figure 86: In *Settings &gt; GitHub Pages*, right-click your published
...
2.  Go back to your first browser tab with your GitHub repo, and click
    ...
    <a href="#fig:leaflet-click-title">87</a>.
...
1.  On your repo page, click to open the `README.md` file, and click the
    ...
    <a href="#fig:leaflet-paste-link">88</a>. Paste your live web link
...
1.  Click on the *Code &gt; Download Zip* drop-down menu button on any
    repo, as shown in Figure <a href="#fig:repo-code-download">89</a>.
...
computer." width=“350” /&gt;
<p class="caption">
Figure 89: Click *Code &gt; Download Zip* to create a compressed folder
...
2.  Go back to your GitHub account in your web browser, click on the
    ...
    <a href="#fig:repo-create-new">90</a>.
...
in Figure <a href="#fig:repo-create-options">91</a>.
...
upload.” width=“400” /&gt;
<p class="caption">
Figure 91: Name your new repo “practice”, check the box to *Initialize
...
1.  Drag-and-drop the `index.html` file that you previously downloaded
    ...
    <a href="#fig:repo-drag-index">93</a>. Do not upload `LICENSE` or
...
1.  Since this was only a `practice` repo, let’s delete it from GitHub.
    ...
    *Delete this repository*, as shown in Figure
    <a href="#fig:repo-delete">94</a>. GitHub will ask you to type in
...
1.  Go to the GitHub web repo you wish to copy to your local computer.
    ...
    Figure <a href="#fig:desktop-open">95</a>. The next screen will show
...
width=“350” /&gt;
<p class="caption">
Figure 95: In your GitHub repo on the web, click *Add file &gt; Open
...
1.  When you open GitHub Desktop for the first time, you’ll need to
    ...
    <a href="#fig:desktop-signin">96</a>, and login with your GitHub
...
<p class="caption">
Figure 96: Click the blue *Sign in to GitHub.com* button to link GitHub
...
1.  In the next setup screen, GitHub Desktop asks you to configure Git,
    ...
    <a href="#fig:desktop-configure">97</a>.
...
<p class="caption">
Figure 97: Click the *Continue* button to authorize GitHub Desktop to
...
your local computer." /&gt;
<p class="caption">
Figure 98: Select your “leaflet-map-simple” repo and click the *Clone*
...
1.  When you clone a repo, GitHub Desktop asks you to select the Local
    ...
    <a href="#fig:desktop-clone-path">99</a>. Before you click the
...
1.  Now you have copies of your GitHub repo in two places—in your GitHub
    ...
    <a href="#fig:desktop-finder">101</a>. Your screen may look
...
1.  Before we can edit the code in your local computer, [download and
    ...
    in Figure <a href="#fig:desktop-atom">102</a>.
...
1.  Since Atom Editor is integrated with GitHub Desktop, it opens up
    ...
    Figure <a href="#fig:atom-project">103</a>. Open your `index.html`
...
1.  After saving your code edit, it’s a good habit to clean up your Atom
    ...
    *Remove Project Folder* in the menu, as shown in Figure
    <a href="#fig:atom-remove-project">104</a>. Next time you open up
...
1.  Now that you’ve edited the code for your map on your local computer,
    ...
    <a href="#fig:finder-open-with">105</a>.
...
1.  Go to GitHub Desktop, confirm that your Current Repo is
    ...
    <a href="#fig:desktop-commit-push">106</a>.

<iframe src="images/08-github/desktop-commit-push.gif" width="100%" height="500px">
</iframe>
<p class="caption">
Figure 106: In this two-step process, click *Commit to Master*, then
...
<a href="#fig:compare-commits">107</a>.
...
(see Figure <a href="#fig:transform-data">111</a> for inspiration). We
...
<a href="#fig:gmaps-whats-here">112</a>. You can copy and paste the
...
Figure <a href="#fig:sheets-geocoder">113</a>.
...
<a href="#fig:sheets-geocoder-censusgeo">114</a>.
...
hospitals. See Figure <a href="#fig:pivot-address">115</a> to see what
...
<a href="#fig:pivot-address-export">116</a> shows where you can find the
Export button.
...
<a href="#fig:normalize-map-data">118</a>. They both are about Covid-19
...
in Figure <a href="#fig:geospatial-raster-vector">119</a>. Raster data
...
<a href="#fig:geojson-github">120</a>.
...
polygons) were imported. Figure <a href="#fig:geojson-io-import">121</a>
...
<a href="#fig:geojson-io-csv-data">122</a>. You can [download
...
2.  In the upper-right corner of the map, use the Search tool to find
    ...
    <a href="#fig:geojson-io-draw">124</a>.
...
2.  To export, go to *Export* in the upper-right corner, and select a
    ...
    <a href="#fig:mapshaper-export">125</a>. As of July 2020, these are
...
lines) in Mapshaper. Figure <a href="#fig:mapshaper-edit">126</a> shows
you how.
...
<p class="caption">
Figure 126: Use *edit attributes* tool (under Cursor tool) to edit
...
shown in Figure <a href="#fig:mapshaper-simplify-demo">127</a>. The map
...
3.  You will see a slider with `100%` appear on top (Figure
    <a href="#fig:mapshaper-simplify">128</a>), replacing the layer
...
Figure <a href="#fig:mapshaper-dissolve">129</a>.
...
1.  Your Mapshaper state should look like pictured in Figure
    <a href="#fig:mapshaper-clip">130</a>. You can now save the file on
...
2.  Use the *Cursor &gt; inspect attributes* tool to make sure you see
    ...
    <a href="#fig:mapshaper-join">131</a>.
...
1.  Use the *Cursor &gt; inspect attributes* tool to make sure polygons
    ...
    shown in Figure <a href="#fig:mapshaper-count-points">132</a>.
...
5.  Pick a few towns, for example *West Hartford* and *Bloomfield*, and
    ...
    shown in Figure <a href="#fig:mapshaper-merge-csv">133</a>. You may
...
polygons remain the same. Figure <a href="#fig:mapshaper-merge">134</a>
...
<p class="caption">
Figure 135: In Google Earth Pro, right-click KMZ layer and choose *Save
Place As*.
</p>

1.  In the dropdown menu of *Save file…* window, choose KML format, like
    is shown in Figure <a href="#fig:kmz-save-as">136</a>.
...
<a href="#fig:mac-file-extensions2">137</a>.

<img src="images/02-spreadsheet/mac-file-extensions.png" alt="On a Mac, go to Finder >
Preferences &gt; Advanced and check the box to *Show all filename
extensions*." /&gt;
<p class="caption">
Figure 137: On a Mac, go to Finder &gt; Preferences &gt; Advanced and
check the box to *Show all filename extensions*.
</p>
...
-   See Figure <a href="#fig:tiger">138</a>.
...
<a href="#fig:screenshot-tall">139</a>.
...
…as shown in Figure <a href="#fig:sample-map">140</a>.
...
this here …as shown in Figure <a href="#fig:sheets-option-drag">141</a>.

<iframe src="images/17-bookdown/sheets-option-drag.gif" width="100%" height="250px">
</iframe>
<p class="caption">
Figure 141: Caption here, with embedded link to the [animated
...
…as shown in the video <a href="#fig:video-sample">142</a>.

<iframe src="https://www.youtube.com/embed/-nGdrzMuUnI" width="100%" height="400px">
</iframe>
<p class="caption">
Figure 142: Caption here, with embedded link to the [YouTube
