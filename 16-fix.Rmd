...
![Screenshot: Curly quotes versus straight quotes](images/16-fix/curly-vs-straight-quotes.png)
...
![Screenshot: Extra files in GitHub repo will block iframe in your README](images/16-fix/extra-files-block-readme-iframe.png)
...
![Screenshot: User accidentally renamed column headers in the Points tab](images/16-fix/lmwgs-fix-column-headers.png)

- Do NOT rename row labels (in column A) of any sheet, due to the same reason above.

![Screenshot: Do not rename or delete](images/16-fix/lmwgs-do-not-rename-labels.png)
