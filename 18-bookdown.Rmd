...
View the underlying source code to understand how this page was composed at: https://github.com/HandsOnDataViz/book/blob/master/18-bookdown.Rmd
...
| Co-Authors      | About Us      |
| --------------- | ------------- |
| ![](images/18-bookdown/dougherty-jack.jpg) | About [Jack Dougherty](http://jackdougherty.org) |
| ![](images/18-bookdown/ilyankou-ilya.jpg) | About [Ilya Ilyankou](https://github.com/ilyankou) |   
...
(ref:sheets-option-drag) Caption here, with embedded link to the [animated GIF](https://handsondataviz.org/images/18-bookdown/sheets-option-drag.gif).
...
- Manually remove any `&emsp;` or four-whitespace characters that are appended to level 3 subheads in chap 5
- Check if HTML and CSS coding for indented variable list in chap 5 appears correctly in PDF and full-length Markdown; if not, manually mark it as "Variable List:" for production team
