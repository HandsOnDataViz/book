...
- *Linear* places your data values in a straight line, from lowest to highest. This method works best when the data are evenly distributed, or if you wish to draw attention to the low and high extremes in your data, which will stand out in light and dark colors.
...
TODO update broken map, working on this...
...
using [General Hospital Information](https://data.medicare.gov/Hospital-Compare/Hospital-General-Information/xubh-q36u/data) dataset by Medicare, which you can see in Figure \@ref(fig:socrata-final).

(ref:socrata-final) Point map of hospitals in Texas drawn from current open-data stream in Socrata. View the interactive version TODO.
