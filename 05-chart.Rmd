...
Before you begin, you will need to create a free [Google Drive account](https://www.google.com/drive/). If you already use Google Mail (Gmail), you can use the same username for your Google Drive account.
...
of global health. You can watch one of his famous [TED talks](https://www.ted.com/talks/hans_rosling_the_best_stats_you_ve_ever_seen)
...
drag *District* dimension into the lower portion of the Marks area. You will now see
