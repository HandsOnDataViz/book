...
- [Problem with tool or service](fix-tool.html)
- [Try a different browser](fix-browser.html)
- [Diagnose with developer tools](fix-developer-tools.html)
- [Mac or Chromebook issues](fix-computer.html)
- [Beware of bad data](fix-data.html)
- [Faulty iframe](fix-embed.html)
- [Code or GitHub issue](fix-code.html)
- [Where to ask questions](fix-questions.html)

## Problem with tool or service {#fix-tool}
...
Of course, if you encounter a problem when using an online tool or web service, always check your internet connection. But on rare occasions, an online tool or web service may be off-line for all users. To clarify if an online platform is down for everyone, and not just you, check for outage reports on sites such as:
...
## Mac or Chromebook issues {#fix-computer}
