...
Quite often we have to compromise between a tool that excels in some areas but not others. For example, two of the tools most frequently mentioned in our book are the [Google Sheets spreadsheet and chart tool](https://www.google.com/sheets/about/), and the [Datawrapper chart and map tool](https://datawrapper.de).
