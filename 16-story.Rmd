...
Now let's enrich your storyboard by adding more content about what you actually discovered after searching, cleaning, analyzing, and visualizing your data. Select only your most meaningful tables, charts, or maps. Print them out on separate sheets of paper, or download [static images or capture screenshots](static.html) to place them in your draft slides or document. Leave room for you to write text at the top and bottom of each table, chart, or map in order to tell your data story. Here are the next two steps:
...
TODO: Update text and data above, and images below, using https://github.com/HandsOnDataViz/survey-results
