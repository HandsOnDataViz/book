...
How many people have read our our book? We can offer a partial answer from data for different editions: our open-access web edition (which we host on our GitHub website with our custom domain https://handsondataviz.org), and three editions sold by O'Reilly: subscriber-only online access to their entire library (which retails at $49/month), the print book edition, the eBook edition, and foreign rights.
...
| Time Period                   | Users  | Pageviews | Avg Session Duration |
|-------------------------------|-------:|----------:|---------------------:|
| 2019 (before contract)        | 41,443 | 117,750   | 1:55 minutes         |
| 2020 (revising manuscript)    | 60,709 | 185,391   | 2:09 minutes         |
| 2021 (book released) thru Oct | 90,521 | 234,328   | 1:51 minutes         |

Also, here's a summary of O'Reilly's book sales for their editions thru August 2021:

| O'Reilly Sales | Units | Earnings | Pct to Author | Author Royalties |
|----------------|------:|---------:|--------------:|-----------------:|
| Online Access  |       | $5,963   | 25%           | $1,490           |
| Print Books    | 671   | $15,431  | 10%           | $1,543           |
| eBooks         | 78    | $2,045   | 25%           | $511             |
| Foreign Rights |       | $5,000   | 25%           | $1,250           |
| Other/Returns  |       |          |               | -$329            |
| Total          | 749   | $28,111  |               | $4,466           |

Since O'Reilly does not provide us with data on the number of readers or pageviews of our book through their subscriber-only online access, we do not know our total number of online readers.

While our open-access book audience seems to be growing, a comparison with current data on O'Reilly total earnings and author royalties from book sales seem modest. That's perfectly fine with us, because our goal was to maximize the quality and readership of our open-access edition, while collaborating with a publisher that sells print and digital access to our book with full awareness of our open-access priorities. In other words, we never measured our success by the amount of money we could squeeze out of for-profit book sales and author royalties.
