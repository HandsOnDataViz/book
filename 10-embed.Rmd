...
### from Google Sheets {-}
1. After you create a [Google Sheets chart as you did in Chapter 7](chart-google.html), click the three-dot kebab menu in the upper-right corner of the chart to publish it, as shown in Figure \@ref(fig:google-sheets-publish).
