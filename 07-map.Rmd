...
- Consider replacing Google My Maps point map with Datawrapper map, if achieves same result and easier
...
Note: See [Normalize Data to Create Meaningful Choropleth Maps](normalize.html) section to learn why you should avoid displaying absolute values or counts in choropleth maps.
