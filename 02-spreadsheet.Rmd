...
if(knitr::is_html_output()) knitr::include_url("images/02-spreadsheet/sheets-drag-calc.gif", height = "85px") else knitr::include_graphics("images/17-bookdown/sheets-option-drag.png")
```
