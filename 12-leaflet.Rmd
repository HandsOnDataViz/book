...
2. Shorten each file name as shown. The names must be exact, such as upper-case for the first letter in *Options.csv*. Only the first file below (Options.csv) is required, and others are optional, depending on your data.
...
2. Shorten each file name as shown. The names must be exact, such as upper-case for the first letter in *Chapters.csv*. The first two files below are required, and others are optional.
