...
TODO below: Improve and standardize map images; Rethink wording of "point map with custom icons"? and description?
...
```{r map-two-variables, out.width=750, fig.cap="(ref:map-two-variables)"}
...
TODO: Rewrite this step to show data in Google Sheets, not CSV.... See if images can be uploaded... Review file contents... Redo step numbering and make File > Download (CSV format) part of this first step, and review continuity with step 3 below -- Open this [data template in Google Sheets](https://docs.google.com/spreadsheets/d/1IA0J4Z9C0_zsvgcunD2kHtR__sdQqUPzNHNjqCLYBRQ/edit#gid=312385679), log into your Google account, and go to *File > Make a Copy* to create a version you can edit in your Google Drive.
