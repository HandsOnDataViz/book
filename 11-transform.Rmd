...
Finally, you'll also learn how to georectify a digitized historical map to display as an interactive map overlay using [the MapWarper tool](mapwarper.html).
