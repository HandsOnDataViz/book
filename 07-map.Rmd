...
| --- | --- |
| Point map        <br> ![](images/07-map/map-point.png) | Best to show specific locations, such as addresses with geocoded coordinates, with colors for different categories. <br>Easy tool: [Google My Maps tutorial](mymaps.html)<br>Power tool: [Leaflet Maps with Google Sheets](leaflet-maps-with-google-sheets.html) and other [Leaflet templates](leaflet.html) |
| Polygon map      <br> ![](images/07-map/map-polygon.png) | Best to show regions (such as nations or neighborhoods), with colors or shading to represent data values. Also known as choropleth map. <br>Easy tool: n/a <br>Power tools: [Tableau Public](map-tableau.html) or [Leaflet Maps with Google Sheets](leaflet-maps-with-google-sheets.html) and other [Leaflet templates](leaflet.html) |
| Polyline map     <br> ![](images/07-map/map-polyline.png) | Best to show routes (such as trails or transit), with colors for different categories. <br>Easy tool: n/a <br>Power tool: [Leaflet Maps with Google Sheets](leaflet-maps-with-google-sheets.html) and other [Leaflet templates](leaflet.html)|
| Heat map     <br> ![](images/07-map/map-heat.png) | Used to show hotspots or clusters of events, such as high-crime areas. <br>Easy tool: n/a <br>Power tool: [Leaflet Heatmap template](leaflet-heatmap.html) |
| Combination map   <br> ![](images/07-map/map-point-polygon-polyline.png) | Best to show any combination of points, polygons, or polylines. <br>Easy tool: n/a <br>Power tool: [Leaflet Maps with Google Sheets](leaflet-maps-with-google-sheets.html) and other [Leaflet templates](leaflet.html)  |
| Storymap <br> ![](images/07-map/map-storymap.png) | Best for guided point-by-point journey through a historical narrative, with optional photos, audio, or video on an interactive map. <br> Power tool: [Leaflet Storymaps with Google Sheets](leaflet-storymaps-with-google-sheets.html) |

TODO ABOVE:

- UPDATE table to match chapter contents, and reorganize to feature easier tools at top.
- Keep Google My Maps point map tool; perhaps mention BatchGeo again? Datawrapper symbol map?
- Confirm removing Storymap "easy tools" because neither allow you to export data you enter: [Knight Lab's StoryMap](https://storymap.knightlab.com/), [ESRI Story Maps](https://storymaps.arcgis.com/en/)
...
## Normalize Your Map Data {- #normalize-map-data}

TODO: cross-ref back to Normalize data section in Compare chapter, then build on it here

Choropleth maps are best when they represent relative values (such as percentages or per capita rates), not absolute values (such as the raw number of people).
...
knitr::include_graphics("images/13-transform/normalize-map-data-annotated.png")
```
...
Note: See [Normalize Data to Create Meaningful Choropleth Maps](normalize.html) section to see an example of sequential palette use, and learn why representing normalized instead of absolute values may be a better idea.
...
knitr::include_graphics("images/07-map/map-principles-colorbrewer-annotated.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://www.google.com/maps/d/u/0/embed?mid=1v1ZNrpfBtq_p4wTRyj2hIKBtTnkmhnMF", height="500px") else knitr::include_graphics("images/07-map/mymaps-final.png")
```
...
knitr::include_graphics("images/07-map/mymaps-lat-lon-annotated.png")
```
...
knitr::include_graphics("images/07-map/mymaps-column-title-annotated.png")
```
...
knitr::include_graphics("images/07-map/mymaps-color-annotated.png")
```
...
knitr::include_graphics("images/07-map/mymaps-embed-annotated.png")
```
...
## Choropleth Map with Datawrapper {- #map-datawrapper}
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://datawrapper.dwcdn.net/uX2Yx/2/", height="513px") else knitr::include_graphics("images/07-map/datawrapper-map-final.png")
```
...
as a TopoJSON or GeoJSON file, and you will learn more about that in the [Convert to GeoJSON section of Chapter 13](convert-geojson.html).
...
knitr::include_graphics("images/07-map/datawrapper-map-us-states-annotated.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-map-match.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-map-color.png")
```
...
knitr::include_graphics("images/07-map/datawrapper-map-tooltip-annotated.png")
```
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://data.medicare.gov/dataset/Texas-Hospitals/cvhn-bsmn/embed?width=100%25&height=500", height="500px") else knitr::include_graphics("images/07-map/socrata-final.png")
```
...
knitr::include_graphics("images/07-map/socrata-style-annotated.png")
```
...
Learn more in [Chapter 9: Embed on Your Web](embed.html).
...
## Polygon Map with Tableau Public {- #map-tableau}

TODO: revise to make polygon/choropleth map vocab more consistent in this chapter; also emphasize how Tableau is not ideal for point maps because you cannot geocode addresses
...
if(knitr::is_html_output(excludes="markdown")) knitr::include_url("https://public.tableau.com/views/MilitarySpending_15965362101320/Sheet1?:showVizHome=no&:embed=true", height="500px") else knitr::include_graphics("images/07-map/tableau-polygon-final.png")
```
...
knitr::include_graphics("images/07-map/tableau-polygon-connect-annotated.png")
```
...
knitr::include_graphics("images/07-map/tableau-polygon-drag-annotated.png")
```
...
knitr::include_graphics("images/07-map/tableau-polygon-filter-annotated.png")
```
...
In [Chapter 13](transform.html), we will talk more about geospatial data,
